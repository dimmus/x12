...
#define RADEON_VERSION_MAJOR ATI_PACKAGE_VERSION_MAJOR
#define RADEON_VERSION_MINOR ATI_PACKAGE_VERSION_MINOR
#define RADEON_VERSION_PATCH ATI_PACKAGE_VERSION_PATCHLEVEL
...
#define RADEON_VERSION_CURRENT                                     \
    ((RADEON_VERSION_MAJOR << 20) | (RADEON_VERSION_MINOR << 10) | \
...
#define RADEON_VERSION_NAME                                                      \
    ...
    "." RADEON_VERSION_STRINGIFY(                                                \
        RADEON_VERSION_MINOR) "." RADEON_VERSION_STRINGIFY(RADEON_VERSION_PATCH) \
        RADEON_VERSION_EXTRA
