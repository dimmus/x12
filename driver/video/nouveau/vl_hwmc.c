...
static int subpicture_index_list[] = { FOURCC_RGB, FOURCC_IA44, FOURCC_AI44 };

static XF86MCImageIDList subpicture_list = { 3, subpicture_index_list };
...
static XF86ImagePtr subpictures[] = { (XF86ImagePtr)&rgb_subpicture,
...
XF86MCAdaptorPtr
vlCreateAdaptorXvMC(ScreenPtr pScreen, char *xv_adaptor_name)
{
...
void
vlDestroyAdaptorXvMC(XF86MCAdaptorPtr adaptor)
{
    assert(adaptor);
