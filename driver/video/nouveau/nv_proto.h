...
Bool drmmode_page_flip(DrawablePtr  draw,
                       PixmapPtr    back,
                       void        *priv,
...
void *drmmode_event_queue(ScrnInfoPtr,
                          uint64_t name,
                          unsigned size,
...
Bool      nouveau_allocate_surface(ScrnInfoPtr         scrn,
                                   int                 width,
                                   int                 height,
                                   int                 bpp,
                                   int                 usage_hint,
...
/* in nouveau_wfb.c */
void
nouveau_wfb_setup_wrap(ReadMemoryProcPtr *, WriteMemoryProcPtr *, DrawablePtr);
...
void NV04PutOverlayImage(ScrnInfoPtr,
                         struct nouveau_bo *,
                         int,
                         int,
                         int,
...
Bool NVPutBlitImage(ScrnInfoPtr,
                    struct nouveau_bo *,
                    int,
                    int,
                    int,
...
Bool NV04EXAUploadIFC(ScrnInfoPtr,
                      const char *src,
                      int         src_pitch,
                      PixmapPtr   pdPix,
                      int         x,
                      ...
                      int         h,
                      int         cpp);
Bool NV04EXARectM2MF(NVPtr pNv,
                     int,
                     int,
                     int,
                     struct nouveau_bo *,
...
Bool NV10EXAPrepareComposite(int,
                             PicturePtr,
                             PicturePtr,
                             PicturePtr,
                             PixmapPtr,
...
void NV10PutOverlayImage(ScrnInfoPtr,
                         struct nouveau_bo *,
                         int,
                         int,
                         int,
...
Bool NV30EXAPrepareComposite(int,
                             PicturePtr,
                             PicturePtr,
                             PicturePtr,
                             PixmapPtr,
...
int  NV30PutTextureImage(ScrnInfoPtr,
                         struct nouveau_bo *,
                         int,
                         int,
                         int,
...
Bool NV40EXAPrepareComposite(int,
                             PicturePtr,
                             PicturePtr,
                             PicturePtr,
                             PixmapPtr,
...
int  NV40PutTextureImage(ScrnInfoPtr,
                         struct nouveau_bo *,
                         int,
                         int,
                         int,
...
Bool NV50EXAPrepareComposite(int,
                             PicturePtr,
                             PicturePtr,
                             PicturePtr,
                             PixmapPtr,
...
Bool NV50EXAUploadSIFC(const char *src,
                       int         src_pitch,
                       PixmapPtr   pdPix,
                       int         x,
                       int         y,
                       ...
                       int         h,
                       int         cpp);
Bool NV50EXARectM2MF(NVPtr pNv,
                     int,
                     int,
                     int,
                     struct nouveau_bo *,
...
/* in nvc0_exa.c */
Bool NVC0AccelUploadM2MF(PixmapPtr   pdpix,
                         int         x,
                         int         y,
                         int         w,
                         int         h,
                         const char *src,
                         int         src_pitch);
Bool NVC0AccelDownloadM2MF(PixmapPtr pspix,
                           int       x,
                           int       y,
                           int       w,
                           int       h,
...
Bool NVC0EXAPrepareComposite(int,
                             PicturePtr,
                             PicturePtr,
                             PicturePtr,
                             PixmapPtr,
...
Bool NVC0EXAUploadSIFC(const char *src,
                       int         src_pitch,
                       PixmapPtr   pdPix,
                       int         x,
                       int         y,
                       ...
                       int         h,
                       int         cpp);
Bool NVC0EXARectM2MF(NVPtr pNv,
                     int,
                     int,
                     int,
                     struct nouveau_bo *,
...
Bool NVE0EXARectCopy(NVPtr pNv,
                     int,
                     int,
                     int,
                     struct nouveau_bo *,
...
/* nv50_xv.c */
int  nv50_xv_image_put(ScrnInfoPtr,
                       struct nouveau_bo *,
                       int,
                       int,
                       int,
...
/* nvc0_xv.c */
int  nvc0_xv_image_put(ScrnInfoPtr,
                       struct nouveau_bo *,
                       int,
                       int,
                       int,
