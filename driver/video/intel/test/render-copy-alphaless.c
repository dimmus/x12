          ...
          uint8_t              blue)
{
    ...
    tmp = XCreatePixmap(t->dpy, DefaultRootWindow(t->dpy), w, h, format->depth);
...
pixel_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, tt.picture, x, y, 1, 1, red, green, blue);
...
area_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, tt.picture, x, y, w, h, red, green, blue);
           ...
           int          use_window)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, out.picture, x, y, w, h, red, green, blue);
            fill_rect(&t->ref, ref.picture, x, y, w, h, red, green, blue);
        }
