...
static void
draw_rect(struct test_display *t,
          Drawable             d,
          uint8_t              alu,
          int                  x,
          int                  y,
...
static void
zrect_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            draw_rect(&t->out, out.draw, alu, x, y, 0, 0, fg, lw);
            draw_rect(&t->ref, ref.draw, alu, x, y, 0, 0, fg, lw);
        }
...
static void
hrect_tests(struct test *t, int reps, int sets, enum target target)
{
    struct test_target out, ref;
    int                r, s;
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            draw_rect(&t->out, out.draw, alu, x, y, w, 0, fg, lw);
            draw_rect(&t->ref, ref.draw, alu, x, y, w, 0, fg, lw);
        }
...
static void
vrect_tests(struct test *t, int reps, int sets, enum target target)
{
    struct test_target out, ref;
    int                r, s;
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            draw_rect(&t->out, out.draw, alu, x, y, 0, h, fg, lw);
            draw_rect(&t->ref, ref.draw, alu, x, y, 0, h, fg, lw);
        }
...
static void
rect_tests(struct test *t, int reps, int sets, enum target target)
{
    struct test_target out, ref;
    int                r, s;
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            draw_rect(&t->out, out.draw, alu, x, y, w, h, fg, lw);
            draw_rect(&t->ref, ref.draw, alu, x, y, w, h, fg, lw);
        }
