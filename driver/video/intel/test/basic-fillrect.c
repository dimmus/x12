...
pixel_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, tt.draw, GXcopy, x, y, 1, 1, fg);
...
area_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, tt.draw, GXcopy, x, y, w, h, fg);
...
rect_tests(struct test *t, int reps, int sets, enum target target)
{
    ...
    for (s = 0; s < sets; s++)
    {
        for (r = 0; r < reps; r++)
        {
            ...
            fill_rect(&t->out, out.draw, alu, x, y, w, h, fg);
            fill_rect(&t->ref, ref.draw, alu, x, y, w, h, fg);
        }
