...
static void
pixel_tests(struct test *t, int reps, int sets, enum target target, int use_shm)
{
...
static void
area_tests(struct test *t, int reps, int sets, enum target target, int use_shm)
{
    struct test_target tt;
    XImage             image;
...
static void
rect_tests(struct test *t, int reps, int sets, enum target target, int use_shm)
{
