...
static void
BRESSOLID(DrawablePtr drawable,
          GCPtr       gc,
          int         dashOffset,
          int         sdx,
          int         sdy,
...
static void
BRESSOLIDR(DrawablePtr drawable,
           GCPtr       gc,
           int         dashOffset,
           int         sdx,
           int         sdy,
         ...
         int         len)
{
    ...
    if (dashlen >= len) dashlen = len;
    if (doOdd)
    {
        if (!even) goto doubleOdd;
        for (;;)
        {
            len -= dashlen;
            while (dashlen--)
