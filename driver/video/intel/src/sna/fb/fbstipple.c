...
#define LaneCases1(c, a)      \
    case c:                   \
        ...
        break
#define LaneCases2(c, a) \
    LaneCases1(c, a);    \
    LaneCases1(c + 1, a)
#define LaneCases4(c, a) \
    LaneCases2(c, a);    \
    LaneCases2(c + 2, a)
#define LaneCases8(c, a) \
    LaneCases4(c, a);    \
    LaneCases4(c + 4, a)
#define LaneCases16(c, a) \
    LaneCases8(c, a);     \
    LaneCases8(c + 8, a)
              ...
              int      yRot)
{
    ...
    while (height--)
    {
        ...
        if (transparent)
        {
            ...
            dst += nmiddle;
            if (endmask) fbTransparentSpan(dst, mask & endmask, fgxor, 1);
        }
        else
        {
            /*
