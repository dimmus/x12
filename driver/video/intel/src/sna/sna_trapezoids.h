...
bool composite_aligned_boxes(struct sna       *sna,
                             CARD8             op,
                             PicturePtr        src,
                             PicturePtr        dst,
...
bool composite_unaligned_boxes(struct sna       *sna,
                               CARD8             op,
                               PicturePtr        src,
                               PicturePtr        dst,
                               PictFormatPtr     maskFormat,
...
bool mono_trapezoids_span_converter(struct sna *sna,
                                    CARD8       op,
                                    PicturePtr  src,
                                    PicturePtr  dst,
                                    INT16       src_x,
...
bool mono_trapezoid_span_inplace(struct sna *sna,
                                 CARD8       op,
                                 PicturePtr  src,
                                 PicturePtr  dst,
                                 INT16       src_x,
...
bool mono_triangles_span_converter(struct sna *sna,
                                   CARD8       op,
                                   PicturePtr  src,
                                   PicturePtr  dst,
                                   INT16       src_x,
...
bool imprecise_trapezoid_span_inplace(struct sna   *sna,
                                      CARD8         op,
                                      PicturePtr    src,
                                      PicturePtr    dst,
                                      PictFormatPtr maskFormat,
...
bool imprecise_trapezoid_span_converter(struct sna   *sna,
                                        CARD8         op,
                                        PicturePtr    src,
                                        PicturePtr    dst,
                                        PictFormatPtr maskFormat,
...
bool imprecise_trapezoid_mask_converter(CARD8         op,
                                        PicturePtr    src,
                                        PicturePtr    dst,
                                        PictFormatPtr maskFormat,
                                        unsigned      flags,
...
bool imprecise_trapezoid_span_fallback(CARD8         op,
                                       PicturePtr    src,
                                       PicturePtr    dst,
                                       PictFormatPtr maskFormat,
                                       unsigned      flags,
...
bool precise_trapezoid_span_inplace(struct sna   *sna,
                                    CARD8         op,
                                    PicturePtr    src,
                                    PicturePtr    dst,
                                    PictFormatPtr maskFormat,
...
bool precise_trapezoid_span_converter(struct sna   *sna,
                                      CARD8         op,
                                      PicturePtr    src,
                                      PicturePtr    dst,
                                      PictFormatPtr maskFormat,
...
bool precise_trapezoid_mask_converter(CARD8         op,
                                      PicturePtr    src,
                                      PicturePtr    dst,
                                      PictFormatPtr maskFormat,
                                      unsigned      flags,
...
bool precise_trapezoid_span_fallback(CARD8         op,
                                     PicturePtr    src,
                                     PicturePtr    dst,
                                     PictFormatPtr maskFormat,
                                     unsigned      flags,
...
static inline bool
is_precise(PicturePtr dst, PictFormatPtr mask)
{
                       ...
                       bool          fallback)
{
    ...
    if (is_mono(dst, maskFormat))
        return mono_trapezoid_span_inplace(sna,
                                           op,
                                           src,
                                           dst,
                                           src_x,
        ...
        return precise_trapezoid_span_inplace(sna,
                                              op,
                                              src,
                                              dst,
                                              maskFormat,
                         ...
                         xTrapezoid   *traps)
{
    ...
    if (is_mono(dst, maskFormat))
        return mono_trapezoids_span_converter(sna,
                                              op,
                                              src,
                                              dst,
                                              src_x,
        ...
        return precise_trapezoid_span_converter(sna,
                                                op,
                                                src,
                                                dst,
                                                maskFormat,
        ...
        return imprecise_trapezoid_span_converter(sna,
                                                  op,
                                                  src,
                                                  dst,
                                                  maskFormat,
...
static inline bool
trapezoid_mask_converter(CARD8         op,
                         PicturePtr    src,
                         PicturePtr    dst,
                         PictFormatPtr maskFormat,
                         unsigned      flags,
                         ...
                         xTrapezoid   *traps)
{
    ...
    if (is_precise(dst, maskFormat))
        return precise_trapezoid_mask_converter(op,
                                                src,
                                                dst,
                                                maskFormat,
                                                flags,
        ...
        return imprecise_trapezoid_mask_converter(op,
                                                  src,
                                                  dst,
                                                  maskFormat,
                                                  flags,
...
static inline bool
trapezoid_span_fallback(CARD8         op,
                        PicturePtr    src,
                        PicturePtr    dst,
                        PictFormatPtr maskFormat,
                        unsigned      flags,
                        ...
                        xTrapezoid   *traps)
{
    ...
    if (is_precise(dst, maskFormat))
        return precise_trapezoid_span_fallback(op,
                                               src,
                                               dst,
                                               maskFormat,
                                               flags,
        ...
        return imprecise_trapezoid_span_fallback(op,
                                                 src,
                                                 dst,
                                                 maskFormat,
                                                 flags,
...
bool mono_trap_span_converter(struct sna *sna,
                              PicturePtr  dst,
                              INT16       x,
                              INT16       y,
                              int         ntrap,
...
bool precise_trap_span_converter(struct sna *sna,
                                 PicturePtr  dst,
                                 INT16       src_x,
                                 INT16       src_y,
                                 int         ntrap,
...
bool imprecise_trap_span_converter(struct sna *sna,
                                   PicturePtr  dst,
                                   INT16       src_x,
                                   INT16       src_y,
                                   int         ntrap,
                    ...
                    xTrap      *trap)
{
    ...
    if (dst->polyEdge == PolyEdgeSharp || dst->pDrawable->depth < 8)
        ...
        return imprecise_trap_span_converter(sna,
                                             dst,
                                             src_x,
                                             src_y,
                                             ntrap,
...
bool trap_mask_converter(struct sna *sna,
                         PicturePtr  picture,
                         INT16       x,
                         INT16       y,
                         int         ntrap,
...
bool triangles_span_converter(struct sna   *sna,
                              CARD8         op,
                              PicturePtr    src,
                              PicturePtr    dst,
                              PictFormatPtr maskFormat,
...
bool triangles_mask_converter(CARD8         op,
                              PicturePtr    src,
                              PicturePtr    dst,
                              PictFormatPtr maskFormat,
                              INT16         src_x,
...
bool mono_tristrip_span_converter(struct sna  *sna,
                                  CARD8        op,
                                  PicturePtr   src,
                                  PicturePtr   dst,
                                  INT16        src_x,
                                  ...
                                  int          count,
                                  xPointFixed *points);
bool imprecise_tristrip_span_converter(struct sna   *sna,
                                       CARD8         op,
                                       PicturePtr    src,
                                       PicturePtr    dst,
                                       PictFormatPtr maskFormat,
                                       ...
                                       int           count,
                                       xPointFixed  *points);
bool precise_tristrip_span_converter(struct sna   *sna,
                                     CARD8         op,
                                     PicturePtr    src,
                                     PicturePtr    dst,
                                     PictFormatPtr maskFormat,
                        ...
                        xPointFixed  *points)
{
    ...
    if (is_mono(dst, maskFormat))
        return mono_tristrip_span_converter(sna,
                                            op,
                                            src,
                                            dst,
                                            src_x,
        ...
        return precise_tristrip_span_converter(sna,
                                               op,
                                               src,
                                               dst,
                                               maskFormat,
        ...
        return imprecise_tristrip_span_converter(sna,
                                                 op,
                                                 src,
                                                 dst,
                                                 maskFormat,
...
static inline void
trapezoid_origin(const xLineFixed *l, int16_t *x, int16_t *y)
{
    if (l->p1.y < l->p2.y)
    {
...
multa(uint32_t s, uint8_t a, int shift)
{
    return mul_8_8((s >> shift) & 0xff, a) << shift;
}

static inline uint32_t
mul_4x8_8(uint32_t color, uint8_t alpha)
{
    uint32_t v;
...
static inline int
pixman_fixed_to_fast(pixman_fixed_t v)
{
    return (v + (1 << (16 - FAST_SAMPLES_shift - 1))) >>
           (16 - FAST_SAMPLES_shift);
}
