...
void uxa_check_fill_spans(DrawablePtr pDrawable,
                          GCPtr       pGC,
                          int         nspans,
                          DDXPointPtr ppt,
                          int        *pwidth,
...
void uxa_check_set_spans(DrawablePtr pDrawable,
                         GCPtr       pGC,
                         char       *psrc,
                         DDXPointPtr ppt,
                         int        *pwidth,
...
void uxa_check_put_image(DrawablePtr pDrawable,
                         GCPtr       pGC,
                         int         depth,
                         int         x,
                         int         y,
...
RegionPtr uxa_check_copy_area(DrawablePtr pSrc,
                              DrawablePtr pDst,
                              GCPtr       pGC,
                              int         srcx,
                              int         srcy,
...
RegionPtr uxa_check_copy_plane(DrawablePtr   pSrc,
                               DrawablePtr   pDst,
                               GCPtr         pGC,
                               int           srcx,
                               int           srcy,
...
void uxa_check_poly_point(DrawablePtr pDrawable,
                          GCPtr       pGC,
                          int         mode,
                          int         npt,
                          DDXPointPtr pptInit);

void uxa_check_poly_lines(DrawablePtr pDrawable,
                          GCPtr       pGC,
                          int         mode,
                          int         npt,
                          DDXPointPtr ppt);

void uxa_check_poly_segment(DrawablePtr pDrawable,
                            GCPtr       pGC,
                            int         nsegInit,
                            xSegment   *pSegInit);
...
void uxa_check_poly_fill_rect(DrawablePtr pDrawable,
                              GCPtr       pGC,
                              int         nrect,
                              xRectangle *prect);

void uxa_check_image_glyph_blt(DrawablePtr  pDrawable,
                               GCPtr        pGC,
                               int          x,
                               int          y,
                               unsigned int nglyph,
...
void uxa_check_poly_glyph_blt(DrawablePtr  pDrawable,
                              GCPtr        pGC,
                              int          x,
                              int          y,
                              unsigned int nglyph,
...
void uxa_check_push_pixels(GCPtr       pGC,
                           PixmapPtr   pBitmap,
...
void uxa_check_get_spans(DrawablePtr pDrawable,
                         int         wMax,
                         DDXPointPtr ppt,
                         int        *pwidth,
                         int         nspans,
...
void uxa_check_add_traps(PicturePtr pPicture,
                         INT16      x_off,
                         INT16      y_off,
                         int        ntrap,
                         xTrap     *traps);
...
uxa_gc_reads_destination(DrawablePtr   pDrawable,
...
Bool uxa_fill_region_tiled(DrawablePtr pDrawable,
                           RegionPtr   pRegion,
                           PixmapPtr   pTile,
                           DDXPointPtr pPatOrg,
                           CARD32      planemask,
...
void uxa_get_image(DrawablePtr   pDrawable,
                   int           x,
                   int           y,
                   int           w,
                   int           h,
...
void uxa_get_spans(DrawablePtr pDrawable,
                   int         wMax,
                   DDXPointPtr ppt,
                   int        *pwidth,
                   int         nspans,
...
void uxa_add_traps(PicturePtr pPicture,
                   INT16      x_off,
                   INT16      y_off,
                   int        ntrap,
                   xTrap     *traps);
...
void uxa_check_composite(CARD8      op,
                         PicturePtr pSrc,
                         PicturePtr pMask,
                         PicturePtr pDst,
                         INT16      xSrc,
...
void uxa_get_drawable_deltas(DrawablePtr pDrawable,
                             PixmapPtr   pPixmap,
                             int        *xp,
                             int        *yp);
...
RegionPtr uxa_copy_area(DrawablePtr pSrcDrawable,
...
void uxa_copy_n_to_n(DrawablePtr pSrcDrawable,
                     DrawablePtr pDstDrawable,
                     GCPtr       pGC,
                     BoxPtr      pbox,
                     int         nbox,
...
void uxa_composite_rects(CARD8                 op,
                         PicturePtr            pSrc,
                         PicturePtr            pDst,
                         int                   nrect,
                         uxa_composite_rect_t *rects);

void uxa_solid_rects(CARD8         op,
                     PicturePtr    dst,
                     xRenderColor *color,
                     int           num_rects,
                     xRectangle   *rects);

void uxa_trapezoids(CARD8         op,
                    PicturePtr    pSrc,
                    PicturePtr    pDst,
...
PicturePtr uxa_acquire_solid(ScreenPtr screen, SourcePict *source);

PicturePtr uxa_acquire_drawable(ScreenPtr  pScreen,
                                PicturePtr pSrc,
                                INT16      x,
                                INT16      y,
                                CARD16     width,
...
PicturePtr uxa_acquire_pattern(ScreenPtr            pScreen,
                               PicturePtr           pSrc,
...
Bool uxa_get_rgba_from_pixel(CARD32  pixel,
                             CARD16 *red,
                             CARD16 *green,
                             CARD16 *blue,
                             CARD16 *alpha,
...
void uxa_glyph_unrealize(ScreenPtr pScreen, GlyphPtr pGlyph);
