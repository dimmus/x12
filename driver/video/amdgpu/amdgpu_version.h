...
#define AMDGPU_VERSION_MAJOR AMDGPU_PACKAGE_VERSION_MAJOR
#define AMDGPU_VERSION_MINOR AMDGPU_PACKAGE_VERSION_MINOR
#define AMDGPU_VERSION_PATCH AMDGPU_PACKAGE_VERSION_PATCHLEVEL
...
#define AMDGPU_VERSION_CURRENT                                     \
    ((AMDGPU_VERSION_MAJOR << 20) | (AMDGPU_VERSION_MINOR << 10) | \
...
#define AMDGPU_VERSION_NAME                                                      \
    ...
    "." AMDGPU_VERSION_STRINGIFY(                                                \
        AMDGPU_VERSION_MINOR) "." AMDGPU_VERSION_STRINGIFY(AMDGPU_VERSION_PATCH) \
        AMDGPU_VERSION_EXTRA
