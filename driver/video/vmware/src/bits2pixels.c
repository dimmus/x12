 ...
 * **********************************************************/
#ifdef VMX86_DEVEL
char rcsId_bits2pixels[] =
    "Id: bits2pixels.c,v 1.6 2001/01/26 23:32:15 yoel Exp $";
#else
...
static void RasterBitsToPixels8(uint8 *bits,
...
static void RasterBitsToPixels16(uint8 *bits,
                                 uint32 bits_increment,
                                 uint8 *pix,
                                 uint32 pix_increment,
                                 uint32 width,
...
static void RasterBitsToPixels24(uint8 *bits,
                                 uint32 bits_increment,
                                 uint8 *pix,
                                 uint32 pix_increment,
                                 uint32 width,
...
static void RasterBitsToPixels32(uint8 *bits,
                                 uint32 bits_increment,
                                 uint8 *pix,
                                 uint32 pix_increment,
                                 uint32 width,
...
void
vmwareRaster_BitsToPixels(uint8 *bits,
                          uint32 bits_increment,
                          uint8 *pix,
                          uint32 pix_increment,
                          int    bytes_per_pixel,
...
void
RasterBitsToPixels8(uint8 *bits,
                    uint32 bits_increment,
                    uint8 *pix,
                    uint32 pix_increment,
                    uint32 width,
...
void
RasterBitsToPixels16(uint8 *bits,
                     uint32 bits_increment,
                     uint8 *pix,
                     uint32 pix_increment,
                     uint32 width,
...
void
RasterBitsToPixels24(uint8 *bits,
                     uint32 bits_increment,
                     uint8 *pix,
                     uint32 pix_increment,
                     uint32 width,
...
void
RasterBitsToPixels32(uint8 *bits,
                     uint32 bits_increment,
                     uint8 *pix,
                     uint32 pix_increment,
                     uint32 width,
