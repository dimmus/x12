...
#define SAA_INVALID_ADDRESS ((void *)((unsigned long)0xFFFFFFFF - 1024 * 1024))
...
extern void      saa_check_fill_spans(DrawablePtr pDrawable,
                                      GCPtr       pGC,
                                      int         nspans,
                                      DDXPointPtr ppt,
                                      int        *pwidth,
                                      int         fSorted);
extern void      saa_check_poly_fill_rect(DrawablePtr pDrawable,
                                          GCPtr       pGC,
                                          int         nrect,
                                          xRectangle *prect);
extern RegionPtr saa_check_copy_area(DrawablePtr pSrc,
                                     DrawablePtr pDst,
                                     GCPtr       pGC,
                                     int         srcx,
                                     int         srcy,
                                     ...
                                     int         dstx,
                                     int         dsty);
extern void      saa_check_copy_nton(DrawablePtr pSrc,
                                     DrawablePtr pDst,
                                     GCPtr       pGC,
                                     BoxPtr      pbox,
                                     int         nbox,
...
extern void saa_unaccel_setup(ScreenPtr pScreen);

extern void saa_unaccel_takedown(ScreenPtr pScreen);

extern RegionPtr saa_copy_area(DrawablePtr pSrcDrawable,
...
extern Bool saa_hw_copy_nton(DrawablePtr pSrcDrawable,
                             DrawablePtr pDstDrawable,
                             GCPtr       pGC,
                             BoxPtr      pbox,
                             int         nbox,
...
#ifdef RENDER
extern void saa_render_setup(ScreenPtr pScreen);

extern void saa_render_takedown(ScreenPtr pScreen);

extern void saa_check_composite(CARD8      op,
                                PicturePtr pSrc,
                                PicturePtr pMask,
                                PicturePtr pDst,
                                INT16      xSrc,
...
extern Bool saa_modify_pixmap_header(PixmapPtr pPixmap,
                                     int       width,
                                     int       height,
                                     int       depth,
                                     int       bitsPerPixel,
...
extern PixmapPtr saa_create_pixmap(ScreenPtr pScreen,
                                   int       w,
                                   int       h,
                                   int       depth,
                                   unsigned  usage_hint);

extern Bool saa_destroy_pixmap(PixmapPtr pPixmap);
...
Bool saa_compute_composite_regions(ScreenPtr  pScreen,
                                   PicturePtr pSrc,
                                   PicturePtr pMask,
                                   PicturePtr pDst,
                                   INT16      xSrc,
