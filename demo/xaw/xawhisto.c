...
static void update(XtPointer client_data _X_UNUSED, XtIntervalId * id _X_UNUSED)
{
    char buf[28];
    static int i = 1;
...
static void cmd_cb(Widget w, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
