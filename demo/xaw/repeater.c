...
static void
start_cb(Widget w _X_UNUSED, XtPointer ptr _X_UNUSED, XtPointer arg _X_UNUSED)
{
#ifdef DEBUG
    puts("Start");
#endif
...
static void
do_cb(Widget w _X_UNUSED, XtPointer ptr _X_UNUSED, XtPointer arg _X_UNUSED)
{
    char buf[10];
...
static void
stop_cb(Widget w _X_UNUSED, XtPointer ptr _X_UNUSED, XtPointer arg _X_UNUSED)
{
    counter=0;
#ifdef DEBUG
    puts("reset counter");
