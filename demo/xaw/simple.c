...
static void ac_set ( Widget w, XEvent *event _X_UNUSED, String *params _X_UNUSED, Cardinal *num_params  _X_UNUSED)
{
    GC gc1, gc2;
    XGCValues  values;
    Dimension wi, hi;
...
static void
quit_cb(Widget w, XtPointer data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
...
int main(int argc, char **argv)
{
    ...
    XtAppContext app;
    static char  translation[] = "<Expose>:set()\n";
