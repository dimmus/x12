...
static void
getdata_cb(Widget w _X_UNUSED, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
...
static void
unset_cb(Widget w _X_UNUSED, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
...
static void
reset_cb(Widget w _X_UNUSED, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
    XawToggleSetCurrent(radio_group, (XtPointer) "3397");
}
