...
static void
getnumsub_cb(Widget w, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
    Widget p = XtParent(w);
    char 	buf[80];
    int min, max;
...
static void
refigure_cb(Widget w, XtPointer client_data _X_UNUSED, XtPointer call_data _X_UNUSED)
{
    Widget p = XtParent(w);
