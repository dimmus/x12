...
# CFLAGS='-g -O2'
# AM_CFLAGS='-DHAVE_XORG_CONFIG_H -fvisibility=hidden  -I/usr/include/libdrm'
# CPP='gcc -E'
# AWK='gawk'
# ./sdksyms.sh '../..' '-g' '-O2' '-DHAVE_XORG_CONFIG_H -fvisibility=hidden  -I/usr/include/libdrm' -include 'sdksyms.dep'
