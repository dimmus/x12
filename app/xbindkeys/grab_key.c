...
static void
my_grab_key(Display *dpy, KeyCode keycode, unsigned int modifier, Window win);
...
my_grab_key(Display *dpy, KeyCode keycode, unsigned int modifier, Window win)
{
    ...
    if (modifier == AnyModifier) return;
            ...
            for (screen = 0; screen < ScreenCount(dpy); screen++)
            {
                ...
                else
                {
                    ...
                    fprintf(stderr,
                            ...
                            "mapped\n"
                            "  on your keyboard.\n"
                            "  xbindkeys will keep running, but will ignore "
                            "this symbol.\n",
