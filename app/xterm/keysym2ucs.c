...
static struct codepair
{
    ...
    { 0x01a1,
     0x0104          }, /*                     Aogonek Ą LATIN CAPITAL LETTER A WITH OGONEK */
    ...
    { 0x06ad,
     0x0491          }, /*   Ukrainian_ghe_with_upturn ґ CYRILLIC SMALL LETTER GHE WITH UPTURN */
    { 0x06ae,
    ...
    { 0x06bd,
     0x0490          }, /*   Ukrainian_GHE_WITH_UPTURN Ґ CYRILLIC CAPITAL LETTER GHE WITH UPTURN */
    { 0x06be,
    ...
    { 0x08a1,
     0x23b7          }, /*                 leftradical ⎷ RADICAL SYMBOL BOTTOM */
    { 0x08a2,
    ...
    { 0x08a7,
     0x23a1          }, /*            topleftsqbracket ⎡ LEFT SQUARE BRACKET UPPER CORNER */
    { 0x08a8,
     0x23a3          }, /*            botleftsqbracket ⎣ LEFT SQUARE BRACKET LOWER CORNER */
    { 0x08a9,
     0x23a4          }, /*           toprightsqbracket ⎤ RIGHT SQUARE BRACKET UPPER CORNER */
    { 0x08aa,
     0x23a6          }, /*           botrightsqbracket ⎦ RIGHT SQUARE BRACKET LOWER CORNER */
    { 0x08ab,
     0x239b          }, /*               topleftparens ⎛ LEFT PARENTHESIS UPPER HOOK */
    { 0x08ac,
     0x239d          }, /*               botleftparens ⎝ LEFT PARENTHESIS LOWER HOOK */
    { 0x08ad,
     0x239e          }, /*              toprightparens ⎞ RIGHT PARENTHESIS UPPER HOOK */
    { 0x08ae,
     0x23a0          }, /*              botrightparens ⎠ RIGHT PARENTHESIS LOWER HOOK */
    { 0x08af,
     0x23a8          }, /*        leftmiddlecurlybrace ⎨ LEFT CURLY BRACKET MIDDLE PIECE */
    { 0x08b0,
     0x23ac          }, /*       rightmiddlecurlybrace ⎬ RIGHT CURLY BRACKET MIDDLE PIECE */
    ...
    { 0x09f0,
     0x23bb          }, /*              horizlinescan3 ⎻ HORIZONTAL SCAN LINE-3 */
    { 0x09f1,
     0x2500          }, /*              horizlinescan5 ─ BOX DRAWINGS LIGHT HORIZONTAL */
    { 0x09f2,
     0x23bc          }, /*              horizlinescan7 ⎼ HORIZONTAL SCAN LINE-7 */
    { 0x09f3,
     0x23bd          }, /*              horizlinescan9 ⎽ HORIZONTAL SCAN LINE-9 */
    { 0x09f4,
...
keysym2ucs(KeySym keysym)
{
    ...
    if ((keysym & 0xff000000) == 0x01000000) return (long)(keysym & 0x00ffffff);

    /* binary search in table */
    while (max >= min)
    {
        int mid = (min + max) / 2;
        if (keysymtab[mid].keysym < keysym) min = mid + 1;
        else if (keysymtab[mid].keysym > keysym) max = mid - 1;
        else
        {
            /* found it */
