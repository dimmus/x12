...
typedef void (*DifsWakeupFunc)(pointer        data,
                               int            result,
                               unsigned long *pReadmask);
...
extern Bool           ClientSleep(ClientPtr client,
                                  Bool (*function)(ClientPtr, pointer),
                                  pointer data);
extern Bool
QueueWorkProc(DifsWorkFunc function, ClientPtr client, pointer data);
extern Bool RegisterBlockAndWakeupHandlers(FontBlockHandlerProcPtr blockHandler,
...
extern void RemoveBlockAndWakeupHandlers(FontBlockHandlerProcPtr blockHandler,
                                         DifsWakeupFunc          wakeupHandler,
                                         pointer                 blockData);
