...
static int XRRCloseDisplay(Display *dpy, XExtCodes *codes);
...
static Bool
XRRWireToEvent(Display *dpy, XEvent *event, xEvent *wire)
{
        ...
        case RRScreenChangeNotify:
            {
                ...
                xRRScreenChangeNotifyEvent *awire =
                    (xRRScreenChangeNotifyEvent *)wire;
        ...
        case RRNotify:
            {
                switch (wire->u.u.detail)
                {
                    case RRNotify_OutputChange:
                        {
                            XRROutputChangeNotifyEvent *aevent =
                                (XRROutputChangeNotifyEvent *)event;
                            xRROutputChangeNotifyEvent *awire =
                                (xRROutputChangeNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                    ...
                    case RRNotify_CrtcChange:
                        {
                            XRRCrtcChangeNotifyEvent *aevent =
                                (XRRCrtcChangeNotifyEvent *)event;
                            xRRCrtcChangeNotifyEvent *awire =
                                (xRRCrtcChangeNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                                _XSetLastRequestRead(dpy,
                                                     (xGenericReply *)wire);
                    ...
                    case RRNotify_OutputProperty:
                        {
                            XRROutputPropertyNotifyEvent *aevent =
                                (XRROutputPropertyNotifyEvent *)event;
                            xRROutputPropertyNotifyEvent *awire =
                                (xRROutputPropertyNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                                _XSetLastRequestRead(dpy,
                                                     (xGenericReply *)wire);
                    ...
                    case RRNotify_ProviderChange:
                        {
                            XRRProviderChangeNotifyEvent *aevent =
                                (XRRProviderChangeNotifyEvent *)event;
                            xRRProviderChangeNotifyEvent *awire =
                                (xRRProviderChangeNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                                _XSetLastRequestRead(dpy,
                                                     (xGenericReply *)wire);
                    ...
                    case RRNotify_ProviderProperty:
                        {
                            XRRProviderPropertyNotifyEvent *aevent =
                                (XRRProviderPropertyNotifyEvent *)event;
                            xRRProviderPropertyNotifyEvent *awire =
                                (xRRProviderPropertyNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                                _XSetLastRequestRead(dpy,
                                                     (xGenericReply *)wire);
                    ...
                    case RRNotify_ResourceChange:
                        {
                            XRRResourceChangeNotifyEvent *aevent =
                                (XRRResourceChangeNotifyEvent *)event;
                            xRRResourceChangeNotifyEvent *awire =
                                (xRRResourceChangeNotifyEvent *)wire;
                            aevent->type = awire->type & 0x7F;
                            aevent->serial =
                                _XSetLastRequestRead(dpy,
                                                     (xGenericReply *)wire);
...
static Status
XRREventToWire(Display *dpy, XEvent *event, xEvent *wire)
{
    XExtDisplayInfo *info = XRRFindDisplay(dpy);
        ...
        case RRNotify:
            {
                ...
                switch (aevent->subtype)
                {
                    case RRNotify_OutputChange:
                        {
                            xRROutputChangeNotifyEvent *sawire =
                                (xRROutputChangeNotifyEvent *)wire;
                            XRROutputChangeNotifyEvent *saevent =
                                (XRROutputChangeNotifyEvent *)event;
                    ...
                    case RRNotify_CrtcChange:
                        {
                            xRRCrtcChangeNotifyEvent *sawire =
                                (xRRCrtcChangeNotifyEvent *)wire;
                            XRRCrtcChangeNotifyEvent *saevent =
                                (XRRCrtcChangeNotifyEvent *)event;
                            sawire->window   = saevent->window;
                            sawire->crtc     = saevent->crtc;
                            sawire->mode     = saevent->mode;
                    ...
                    case RRNotify_OutputProperty:
                        {
                            xRROutputPropertyNotifyEvent *sawire =
                                (xRROutputPropertyNotifyEvent *)wire;
                            XRROutputPropertyNotifyEvent *saevent =
                                (XRROutputPropertyNotifyEvent *)event;
                            sawire->window    = saevent->window;
                            sawire->output    = saevent->output;
                    ...
                    case RRNotify_ProviderChange:
                        {
                            xRRProviderChangeNotifyEvent *sawire =
                                (xRRProviderChangeNotifyEvent *)wire;
                            XRRProviderChangeNotifyEvent *saevent =
                                (XRRProviderChangeNotifyEvent *)event;
                            sawire->window   = saevent->window;
                    ...
                    case RRNotify_ProviderProperty:
                        {
                            xRRProviderPropertyNotifyEvent *sawire =
                                (xRRProviderPropertyNotifyEvent *)wire;
                            XRRProviderPropertyNotifyEvent *saevent =
                                (XRRProviderPropertyNotifyEvent *)event;
                            sawire->window    = saevent->window;
                            sawire->provider  = saevent->provider;
                            sawire->atom      = saevent->property;
                    ...
                    case RRNotify_ResourceChange:
                        {
                            xRRResourceChangeNotifyEvent *sawire =
                                (xRRResourceChangeNotifyEvent *)wire;
                            XRRResourceChangeNotifyEvent *saevent =
                                (XRRResourceChangeNotifyEvent *)event;
                            sawire->window    = saevent->window;
                            sawire->timestamp = saevent->timestamp;
                            return True;
...
XRRFindDisplay(Display *dpy)
{
    ...
    if (!dpyinfo)
    {
        ...
        dpyinfo    = XextAddDisplay(&XRRExtensionInfo,
                                 dpy,
                                 XRRExtensionName,
                                 &rr_extension_hooks,
                                 RRNumberEvents,
        ...
        xrri       = Xmalloc(sizeof(XRandRInfo) + sizeof(char *) * numscreens);
...
int
XRRRootToScreen(Display *dpy, Window root)
{
...
Bool
XRRQueryExtension(Display *dpy, int *event_base_return, int *error_base_return)
{
    XExtDisplayInfo *info = XRRFindDisplay(dpy);
...
Status
XRRQueryVersion(Display *dpy, int *major_versionp, int *minor_versionp)
{
    XExtDisplayInfo     *info = XRRFindDisplay(dpy);
    ...
    if (xrri->major_version == -1)
    {
        ...
        xrri->has_rates =
            _XRRHasRates(xrri->major_version, xrri->minor_version);
        UnlockDisplay(dpy);
        SyncHandle();
    }
...
_X_HIDDEN Bool
_XRRVersionHandler(Display *dpy, xReply *rep, char *buf, int len, XPointer data)
{
    ...
    repl = (xRRQueryVersionReply *)_XGetAsyncReply(
        dpy,
        (char *)&replbuf,
        rep,
        buf,
