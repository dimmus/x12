...
void
XFixesIntersectRegion(Display      *dpy,
                      XserverRegion dst,
                      XserverRegion src1,
                      XserverRegion src2)
{
...
void
XFixesSubtractRegion(Display      *dpy,
                     XserverRegion dst,
                     XserverRegion src1,
                     XserverRegion src2)
{
...
void
XFixesInvertRegion(Display      *dpy,
                   XserverRegion dst,
                   XRectangle   *rect,
                   XserverRegion src)
{
...
void
XFixesSetGCClipRegion(Display      *dpy,
                      GC            gc,
                      int           clip_x_origin,
                      int           clip_y_origin,
                      XserverRegion region)
...
void
XFixesSetWindowShapeRegion(Display      *dpy,
                           Window        win,
                           int           shape_kind,
                           int           x_off,
                           int           y_off,
...
void
XFixesSetPictureClipRegion(Display      *dpy,
                           XID           picture,
                           int           clip_x_origin,
                           int           clip_y_origin,
                           XserverRegion region)
...
void
XFixesExpandRegion(Display      *dpy,
                   XserverRegion dst,
                   XserverRegion src,
                   unsigned      left,
                   unsigned      right,
