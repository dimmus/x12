 ...
 */
void
_XColor_to_XcmsRGB(XcmsCCC      ccc,
                   XColor      *pXColors,
                   XcmsColor   *pColors,
 ...
 */
void
_XcmsResolveColor(XcmsCCC ccc, XcmsColor *pXcmsColor)
/*
 *	DESCRIPTION
 ...
 */
void
_XcmsUnresolveColor(XcmsCCC ccc, XcmsColor *pColor)
/*
 *	DESCRIPTION
 ...
 */
void
_XUnresolveColor(XcmsCCC ccc, XColor *pXColor)
/*
 *	DESCRIPTION
 *		Masks out insignificant bits.
 *
