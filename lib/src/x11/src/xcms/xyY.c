 ...
 */
     ...
     */
static XcmsConversionProc Fl_CIExyY_to_CIEXYZ[] = { XcmsCIExyYToCIEXYZ, NULL };

    /*
     * NULL terminated list of functions applied to get from CIEXYZ to CIExyY
     */
static XcmsConversionProc Fl_CIEXYZ_to_CIExyY[] = { XcmsCIEXYZToCIExyY, NULL };
 ...
 */
     ...
     * CIE xyY Color Space
     */
XcmsColorSpace XcmsCIExyYColorSpace = { _XcmsCIExyY_prefix, /* prefix */
                                        XcmsCIExyYFormat,  /* id */
 ...
 */
static int
CIExyY_ParseString(register char *spec, XcmsColor *pColor)
/*
 *	DESCRIPTION
 ...
 */
static Status
XcmsCIExyY_ValidSpec(XcmsColor *pColor)
/*
 *	DESCRIPTION
 ...
 */
Status
XcmsCIExyYToCIEXYZ(XcmsCCC      ccc,
 ...
 */
{
    ...
    /* Make sure original format is CIExyY and valid */
        ...
        if ((div = (-2 * pColor->spec.CIExyY.x) + (12 * pColor->spec.CIExyY.y) +
                   3) == 0.0)
        {
...
/* ARGSUSED */
Status
XcmsCIEXYZToCIExyY(XcmsCCC      ccc,
                   XcmsColor   *pxyY_WhitePt,
                   XcmsColor   *pColors_in_out,
                   unsigned int nColors)
/*
 ...
 */
{
    ...
    for (i = 0; i < nColors; i++, pColor++)
    {
        ...
        if ((div = pColor->spec.CIEXYZ.X + pColor->spec.CIEXYZ.Y +
                   pColor->spec.CIEXYZ.Z) == 0.0)
        {
            div = EPS;
        }
