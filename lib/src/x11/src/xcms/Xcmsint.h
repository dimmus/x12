...
typedef struct _XcmsIntensityMap
{
    ...
    void (*pFreeScreenData)(
        XPointer pScreenDataTemp); /* Function that frees a Screen		*/
                /*   structure.				*/
...
extern void
_XcmsRGB_to_XColor(XcmsColor *pColors, XColor *pXColors, unsigned int nColors);
extern Status _XcmsResolveColorString(XcmsCCC         ccc,
...
#define XCMS_CIEUSTAROFHUE(h, c)                                          \
    ((XCMS_COS((h)) == 0.0)                                               \
         ? (XcmsFloat)0.0                                                 \
         : (XcmsFloat)((XcmsFloat)(c) /                                   \
                       (XcmsFloat)XCMS_SQRT((XCMS_TAN(h) * XCMS_TAN(h)) + \
                                            (XcmsFloat)1.0)))
#define XCMS_CIEVSTAROFHUE(h, c)                                      \
    ((XCMS_COS((h)) == 0.0)                                           \
         ...
         : (XcmsFloat)((XcmsFloat)(c) /                               \
                       (XcmsFloat)XCMS_SQRT(                          \
                           ((XcmsFloat)1.0 /                          \
                            (XcmsFloat)(XCMS_TAN(h) * XCMS_TAN(h))) + \
                           (XcmsFloat)1.0)))
