 ...
 */
static XcmsCmapRec *
CmapRecForColormap(Display *dpy, Colormap cmap)
/*
 *	DESCRIPTION
 ...
 */
void
_XcmsDeleteCmapRec(Display *dpy, Colormap cmap)
/*
 *	DESCRIPTION
 ...
 */
{
    ...
    {
        if (cmap == DefaultColormap(dpy, scr)) return;
    }
 ...
 */
static void
_XcmsFreeClientCmaps(Display *dpy)
/*
 *	DESCRIPTION
 ...
 */
XcmsCCC
XcmsCCCOfColormap(Display *dpy, Colormap cmap)
/*
 *	DESCRIPTION
...
XcmsCCC
XcmsSetCCCOfColormap(Display *dpy, Colormap cmap, XcmsCCC ccc)
{
