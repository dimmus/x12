            ...
            int            n) /* n == 0 is acceptable */
{
    ...
    { /* note: code falls through cases! */
        case 6:
            r[5] = (unsigned char)(0x80 | (wc & 0x3f));
            wc   = wc >> 6;
            wc |= 0x4000000;
        case 5:
            r[4] = (unsigned char)(0x80 | (wc & 0x3f));
            wc   = wc >> 6;
            wc |= 0x200000;
        case 4:
            r[3] = (unsigned char)(0x80 | (wc & 0x3f));
            wc   = wc >> 6;
            wc |= 0x10000;
        case 3:
            r[2] = (unsigned char)(0x80 | (wc & 0x3f));
            wc   = wc >> 6;
            wc |= 0x800;
        case 2:
            r[1] = (unsigned char)(0x80 | (wc & 0x3f));
            wc   = wc >> 6;
            wc |= 0xc0;
        case 1:
