...
create_conv(XLCd lcd, XlcConvMethods methods)
{
    ...
    if (conv == (XlcConv)NULL) return (XlcConv)NULL;
...
typedef struct _Utf8ConvRec
{
    const char *name;
    XrmQuark    xrm_name;
    int (*cstowc)(XlcConv, ucs4_t *, const unsigned char *, int);
...
static Utf8ConvRec all_charsets[] = {
    ...
    { "ISO10646-1",       NULLQUARK, utf8_mbtowc,             utf8_wctomb        },

    { "ISO8859-1",        NULLQUARK, iso8859_1_mbtowc,        iso8859_1_wctomb   },
    { "ISO8859-2",        NULLQUARK, iso8859_2_mbtowc,        iso8859_2_wctomb   },
    { "ISO8859-3",        NULLQUARK, iso8859_3_mbtowc,        iso8859_3_wctomb   },
    { "ISO8859-4",        NULLQUARK, iso8859_4_mbtowc,        iso8859_4_wctomb   },
    { "ISO8859-5",        NULLQUARK, iso8859_5_mbtowc,        iso8859_5_wctomb   },
    { "ISO8859-6",        NULLQUARK, iso8859_6_mbtowc,        iso8859_6_wctomb   },
    { "ISO8859-7",        NULLQUARK, iso8859_7_mbtowc,        iso8859_7_wctomb   },
    { "ISO8859-8",        NULLQUARK, iso8859_8_mbtowc,        iso8859_8_wctomb   },
    { "ISO8859-9",        NULLQUARK, iso8859_9_mbtowc,        iso8859_9_wctomb   },
    { "ISO8859-10",       NULLQUARK, iso8859_10_mbtowc,       iso8859_10_wctomb  },
    { "ISO8859-11",       NULLQUARK, iso8859_11_mbtowc,       iso8859_11_wctomb  },
    { "ISO8859-13",       NULLQUARK, iso8859_13_mbtowc,       iso8859_13_wctomb  },
    { "ISO8859-14",       NULLQUARK, iso8859_14_mbtowc,       iso8859_14_wctomb  },
    { "ISO8859-15",       NULLQUARK, iso8859_15_mbtowc,       iso8859_15_wctomb  },
    { "ISO8859-16",       NULLQUARK, iso8859_16_mbtowc,       iso8859_16_wctomb  },
    { "JISX0201.1976-0",  NULLQUARK, jisx0201_mbtowc,         jisx0201_wctomb    },
    { "TIS620-0",         NULLQUARK, tis620_mbtowc,           tis620_wctomb      },
    { "GB2312.1980-0",    NULLQUARK, gb2312_mbtowc,           gb2312_wctomb      },
    { "JISX0208.1983-0",  NULLQUARK, jisx0208_mbtowc,         jisx0208_wctomb    },
    { "JISX0208.1990-0",  NULLQUARK, jisx0208_mbtowc,         jisx0208_wctomb    },
    { "JISX0212.1990-0",  NULLQUARK, jisx0212_mbtowc,         jisx0212_wctomb    },
    { "KSC5601.1987-0",   NULLQUARK, ksc5601_mbtowc,          ksc5601_wctomb     },
    { "KOI8-R",           NULLQUARK, koi8_r_mbtowc,           koi8_r_wctomb      },
    { "KOI8-U",           NULLQUARK, koi8_u_mbtowc,           koi8_u_wctomb      },
    { "KOI8-C",           NULLQUARK, koi8_c_mbtowc,           koi8_c_wctomb      },
    { "TATAR-CYR",        NULLQUARK, tatar_cyr_mbtowc,        tatar_cyr_wctomb   },
    { "ARMSCII-8",        NULLQUARK, armscii_8_mbtowc,        armscii_8_wctomb   },
    { "IBM-CP1133",       NULLQUARK, cp1133_mbtowc,           cp1133_wctomb      },
    { "MULELAO-1",        NULLQUARK, mulelao_mbtowc,          mulelao_wctomb     },
    { "VISCII1.1-1",      NULLQUARK, viscii_mbtowc,           viscii_wctomb      },
    { "TCVN-5712",        NULLQUARK, tcvn_mbtowc,             tcvn_wctomb        },
    { "GEORGIAN-ACADEMY",
     NULLQUARK,                      georgian_academy_mbtowc,
     georgian_academy_wctomb                                                     },
    { "GEORGIAN-PS",      NULLQUARK, georgian_ps_mbtowc,      georgian_ps_wctomb },
    { "ISO8859-9E",       NULLQUARK, iso8859_9e_mbtowc,       iso8859_9e_wctomb  },
    { "MICROSOFT-CP1251", NULLQUARK, cp1251_mbtowc,           cp1251_wctomb      },
    { "MICROSOFT-CP1255", NULLQUARK, cp1255_mbtowc,           cp1255_wctomb      },
    { "MICROSOFT-CP1256", NULLQUARK, cp1256_mbtowc,           cp1256_wctomb      },
    { "BIG5-0",           NULLQUARK, big5_mbtowc,             big5_wctomb        },
    { "BIG5-E0",          NULLQUARK, big5_0_mbtowc,           big5_0_wctomb      },
    { "BIG5-E1",          NULLQUARK, big5_1_mbtowc,           big5_1_wctomb      },
    { "GBK-0",            NULLQUARK, gbk_mbtowc,              gbk_wctomb         },
    { "BIG5HKSCS-0",      NULLQUARK, big5hkscs_mbtowc,        big5hkscs_wctomb   },
    ...
    { "ISO10646-1",       NULLQUARK, ucs2be_mbtowc,           ucs2be_wctomb      }
};
...
#define lazy_init_all_charsets()                                        \
    do                                                                  \
    {                                                                   \
        if (all_charsets[0].xrm_name == NULLQUARK) init_all_charsets(); \
    }                                                                   \
    while (0)
         ...
         int       num_args)
{
    ...
    for (convptr = all_charsets, i = all_charsets_count - 1; i > 0;
         convptr++, i--)
        if (!strcmp(convptr->name, name)) break;
    if (i == 0) return -1;
    ...
    while (src < srcend)
    {
        ...
        if (consumed == RET_ILSEQ) return -1;
        if (consumed == RET_TOOFEW(0)) break;

        count = utf8_wctomb(NULL, dst, wc, dstend - dst);
        if (count == RET_TOOSMALL) break;
        if (count == RET_ILSEQ)
        {
...
static XlcConvMethodsRec methods_cstoutf8 = { close_converter, cstoutf8, NULL };

static XlcConv
open_cstoutf8(XLCd        from_lcd,
...
static XlcConv
create_tocs_conv(XLCd lcd, XlcConvMethods methods)
{
    XlcConv   conv;
    ...
    conv = Xmalloc(sizeof(XlcConvRec) + (charset_num + 1) * sizeof(Utf8Conv));
    if (conv == (XlcConv)NULL) return (XlcConv)NULL;
    ...
    for (i = 0; i < codeset_num; i++)
    {
        ...
        /* If it wasn't already encountered... */
            for (k = charset_num - 1; k >= 0; k--)
                if (!strcmp(preferred[k]->name, name)) break;
            if (k < 0)
            {
...
static void
close_tocs_converter(XlcConv conv)
{
 ...
 */
static int
charset_wctocs(Utf8Conv      *preferred,
               Utf8Conv      *charsetp,
               XlcSide       *sidep,
               XlcConv        conv,
               unsigned char *r,
               ...
               int            n)
{
    ...
    for (; *preferred != (Utf8Conv)NULL; preferred++)
    {
        ...
        if (count == RET_TOOSMALL) return RET_TOOSMALL;
        if (count != RET_ILSEQ)
        {
            *charsetp = convptr;
    ...
    for (convptr = all_charsets + 1, i = all_charsets_count - 1; i > 0;
         convptr++, i--)
    {
        count = convptr->wctocs(conv, r, wc, n);
        if (count == RET_TOOSMALL) return RET_TOOSMALL;
         ...
         int       num_args)
{
    ...
    *to_left   = dstend - dst;
    ...
    if (num_args >= 1) *((XlcCharSet *)args[0]) = last_charset;

    return unconv_num;
}

static XlcConvMethodsRec methods_utf8tocs = { close_tocs_converter,
                                              utf8tocs,
                                              NULL };

static XlcConv
open_utf8tocs(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConvMethodsRec methods_utf8tocs1 = { close_tocs_converter,
                                               utf8tocs1,
                                               NULL };

static XlcConv
open_utf8tocs1(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
static XlcConvMethodsRec methods_utf8tostr = { close_converter,
                                               utf8tostr,
                                               NULL };

static XlcConv
open_utf8tostr(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
static XlcConvMethodsRec methods_strtoutf8 = { close_converter,
                                               strtoutf8,
                                               NULL };

static XlcConv
open_strtoutf8(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
XPointer
_Utf8GetConvByName(const char *name)
{
    XrmQuark xrm_name;
    Utf8Conv convptr;
    int      i;

    if (name == NULL) return (XPointer)NULL;
    ...
    for (convptr = all_charsets, i = all_charsets_count - 1; i > 0;
         convptr++, i--)
        if (convptr->xrm_name == xrm_name) return (XPointer)convptr->wctocs;
...
static XlcConv
create_ucstocs_conv(XLCd lcd, XlcConvMethods methods)
{
...
static int
charset_wctocs_exactly(Utf8Conv      *preferred,
                       Utf8Conv      *charsetp,
                       XlcSide       *sidep,
                       XlcConv        conv,
                       unsigned char *r,
         ...
         int       num_args)
{
    ...
    count = charset_wctocs_exactly(preferred_charsets,
                                   &chosen_charset,
                                   &chosen_side,
                                   conv,
                                   dst,
    ...
    *to_left -= count;
    ...
    if (num_args >= 1) *((XlcCharSet *)args[0]) = charset;

    return unconv_num;
}

static XlcConvMethodsRec methods_ucstocs1 = { close_tocs_converter,
                                              ucstocs1,
                                              NULL };

static XlcConv
open_ucstocs1(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConvMethodsRec methods_ucstoutf8 = { close_converter,
                                               ucstoutf8,
                                               NULL };

static XlcConv
open_ucstoutf8(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
void
_XlcAddUtf8Converters(XLCd lcd)
{
...
static XlcConvMethodsRec methods_utf8towcs = { close_converter,
                                               utf8towcs,
                                               NULL };

static XlcConv
open_utf8towcs(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
static XlcConvMethodsRec methods_wcstoutf8 = { close_converter,
                                               wcstoutf8,
                                               NULL };

static XlcConv
open_wcstoutf8(XLCd        from_lcd,
               const char *from_type,
               XLCd        to_lcd,
               const char *to_type)
{
...
static XlcConvMethodsRec methods_strtowcs = { close_converter,
                                              our_strtowcs,
                                              NULL };

static XlcConv
open_strtowcs(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConvMethodsRec methods_wcstostr = { close_converter,
                                              our_wcstostr,
                                              NULL };

static XlcConv
open_wcstostr(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConvMethodsRec methods_cstowcs = { close_converter, cstowcs, NULL };

static XlcConv
open_cstowcs(XLCd        from_lcd,
             const char *from_type,
             XLCd        to_lcd,
             const char *to_type)
{
...
static XlcConvMethodsRec methods_wcstocs = { close_tocs_converter,
                                             wcstocs,
                                             NULL };

static XlcConv
open_wcstocs(XLCd        from_lcd,
             const char *from_type,
             XLCd        to_lcd,
             const char *to_type)
{
...
static XlcConvMethodsRec methods_wcstocs1 = { close_tocs_converter,
                                              wcstocs1,
                                              NULL };

static XlcConv
open_wcstocs1(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConvMethodsRec methods_identity = { close_converter, identity, NULL };

static XlcConv
open_identity(XLCd        from_lcd,
              const char *from_type,
              XLCd        to_lcd,
              const char *to_type)
{
...
static XlcConv
create_tofontcs_conv(XLCd lcd, XlcConvMethods methods)
{
    XlcConv   conv;
    int       i, num, k, count;
    char    **value, buf[32];
    ...
    for (i = 0, num = 0;; i++)
    {
        ...
        while (count-- > 0)
        {
            ...
            if (charset == (XlcCharSet)NULL) continue;
...
static XlcConvMethodsRec iconv_cstombs_methods = { close_converter,
                                                   iconv_cstombs,
                                                   NULL };

static XlcConv
open_iconv_cstombs(XLCd        from_lcd,
                   const char *from_type,
                   XLCd        to_lcd,
                   const char *to_type)
{
...
static XlcConvMethodsRec iconv_mbstocs_methods = { close_tocs_converter,
                                                   iconv_mbstocs,
                                                   NULL };

static XlcConv
open_iconv_mbstocs(XLCd        from_lcd,
                   const char *from_type,
                   XLCd        to_lcd,
                   const char *to_type)
{
...
static XlcConvMethodsRec iconv_mbtocs_methods = { close_tocs_converter,
                                                  iconv_mbtocs,
                                                  NULL };

static XlcConv
open_iconv_mbtocs(XLCd        from_lcd,
                  const char *from_type,
                  XLCd        to_lcd,
                  const char *to_type)
{
...
static XlcConvMethodsRec iconv_mbstostr_methods = { close_converter,
                                                    iconv_mbstostr,
                                                    NULL };

static XlcConv
open_iconv_mbstostr(XLCd        from_lcd,
                    const char *from_type,
                    XLCd        to_lcd,
                    const char *to_type)
{
...
static XlcConvMethodsRec iconv_strtombs_methods = { close_converter,
                                                    iconv_strtombs,
                                                    NULL };

static XlcConv
open_iconv_strtombs(XLCd        from_lcd,
                    const char *from_type,
                    XLCd        to_lcd,
                    const char *to_type)
{
...
static XlcConvMethodsRec iconv_mbstowcs_methods = { close_converter,
                                                    iconv_mbstowcs,
                                                    NULL };

static XlcConv
open_iconv_mbstowcs(XLCd        from_lcd,
                    const char *from_type,
                    XLCd        to_lcd,
                    const char *to_type)
{
...
static XlcConvMethodsRec iconv_wcstombs_methods = { close_converter,
                                                    iconv_wcstombs,
                                                    NULL };

static XlcConv
open_iconv_wcstombs(XLCd        from_lcd,
                    const char *from_type,
                    XLCd        to_lcd,
                    const char *to_type)
{
...
static XlcConv
open_iconv_mbstofcs(XLCd        from_lcd,
                    const char *from_type,
                    XLCd        to_lcd,
                    const char *to_type)
{
...
void
_XlcAddUtf8LocaleConverters(XLCd lcd)
{
...
void
_XlcAddGB18030LocaleConverters(XLCd lcd)
{
    /* Register elementary converters. */
    _XlcSetConverter(lcd,
                     XlcNMultiByte,
                     lcd,
                     XlcNWideChar,
                     open_iconv_mbstowcs);
