...
static int
DrawStringWithFontSet(Display *dpy,
                      Drawable d,
                      XOC      oc,
                      FontSet  fs,
                      GC       gc,
...
int
_XomGenericDrawString(Display    *dpy,
                      Drawable    d,
                      XOC         oc,
                      GC          gc,
                      int         x,
...
/* For VW/UDC */
        next = DrawStringWithFontSet(dpy,
                                     d,
                                     oc,
                                     fs,
                                     gc,
...
int
_XmbGenericDrawString(Display      *dpy,
                      Drawable      d,
                      XOC           oc,
                      GC            gc,
                      int           x,
                      ...
                      int           length)
{
    return _XomGenericDrawString(dpy,
                                 d,
                                 oc,
                                 gc,
                                 x,
...
int
_XwcGenericDrawString(Display         *dpy,
                      Drawable         d,
                      XOC              oc,
                      GC               gc,
                      int              x,
...
int
_Xutf8GenericDrawString(Display      *dpy,
                        Drawable      d,
                        XOC           oc,
                        GC            gc,
                        int           x,
