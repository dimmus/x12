...
{
    return (xcb_dpms_get_version_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}
...
{
    return (
        xcb_dpms_capable_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_dpms_get_timeouts_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_dpms_get_timeouts_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
xcb_void_cookie_t
xcb_dpms_select_input_checked(xcb_connection_t *c, uint32_t event_mask)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_dpms_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_dpms_select_input(xcb_connection_t *c, uint32_t event_mask)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_dpms_id,
                                                    .opcode =
