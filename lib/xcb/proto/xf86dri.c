...
{
    return (xcb_xf86dri_query_version_reply_t *)
...
xcb_xf86dri_query_direct_rendering_capable_reply(
    ...
    xcb_generic_error_t                               **e)
{
    return (xcb_xf86dri_query_direct_rendering_capable_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xf86dri_open_connection_sizeof(const void *_buffer)
{
    ...
    const xcb_xf86dri_open_connection_reply_t *_aux =
        (xcb_xf86dri_open_connection_reply_t *)_buffer;
...
xcb_xf86dri_open_connection_bus_id_length(
    const xcb_xf86dri_open_connection_reply_t *R)
{
    return R->bus_id_len;
}
...
xcb_xf86dri_open_connection_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xf86dri_open_connection_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_xf86dri_get_client_driver_name_reply_t *_aux =
        (xcb_xf86dri_get_client_driver_name_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xf86dri_get_client_driver_name_client_driver_name(
    const xcb_xf86dri_get_client_driver_name_reply_t *R)
{
    return (char *)(R + 1);
}
...
xcb_xf86dri_get_client_driver_name_reply(
    ...
    xcb_generic_error_t                       **e)
{
    return (xcb_xf86dri_get_client_driver_name_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xf86dri_create_context_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_xf86dri_create_context_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xf86dri_create_drawable_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xf86dri_create_drawable_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_xf86dri_get_drawable_info_reply_t *_aux =
        (xcb_xf86dri_get_drawable_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* back_clip_rects */
    xcb_block_len +=
        _aux->num_back_clip_rects * sizeof(xcb_xf86dri_drm_clip_rect_t);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(xcb_xf86dri_drm_clip_rect_t);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_xf86dri_get_drawable_info_clip_rects(
    const xcb_xf86dri_get_drawable_info_reply_t *R)
{
...
xcb_xf86dri_get_drawable_info_back_clip_rects(
    const xcb_xf86dri_get_drawable_info_reply_t *R)
{
    xcb_generic_iterator_t prev = xcb_xf86dri_drm_clip_rect_end(
        xcb_xf86dri_get_drawable_info_clip_rects_iterator(R));
    return (
        xcb_xf86dri_drm_clip_rect_t *)((char *)prev.data +
    ...
    const xcb_xf86dri_get_drawable_info_reply_t *R)
{
    ...
    xcb_generic_iterator_t               prev = xcb_xf86dri_drm_clip_rect_end(
        xcb_xf86dri_get_drawable_info_clip_rects_iterator(R));
    i.data  = (xcb_xf86dri_drm_clip_rect_t *)((char *)prev.data +
                                             XCB_TYPE_PAD(
                                                 xcb_xf86dri_drm_clip_rect_t,
                                                 prev.index));
...
xcb_xf86dri_get_drawable_info_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_xf86dri_get_drawable_info_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_xf86dri_get_device_info_reply_t *_aux =
        (xcb_xf86dri_get_device_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xf86dri_get_device_info_device_private(
    const xcb_xf86dri_get_device_info_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
...
xcb_xf86dri_get_device_info_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xf86dri_get_device_info_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xf86dri_auth_connection_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xf86dri_auth_connection_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
