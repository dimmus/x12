...
xcb_sync_systemcounter_next(xcb_sync_systemcounter_iterator_t *i)
{
    ...
    child.data = (xcb_sync_systemcounter_t *)(((char *)R) +
                                              xcb_sync_systemcounter_sizeof(R));
...
{
    return (
        xcb_sync_initialize_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_sync_list_system_counters_reply_t *_aux =
        (xcb_sync_list_system_counters_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_sync_list_system_counters_counters_length(
    const xcb_sync_list_system_counters_reply_t *R)
{
...
xcb_sync_list_system_counters_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_sync_list_system_counters_reply_t *)
...
xcb_sync_query_counter_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_sync_query_counter_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}

int
xcb_sync_await_sizeof(const void *_buffer, uint32_t wait_list_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_sync_await_request_t)) /
            sizeof(xcb_sync_waitcondition_t));
}
...
xcb_sync_await_wait_list_iterator(const xcb_sync_await_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_sync_await_request_t)) /
             sizeof(xcb_sync_waitcondition_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_sync_create_alarm_request_t *_aux =
        (xcb_sync_create_alarm_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* value_list */
    xcb_block_len +=
        xcb_sync_create_alarm_value_list_sizeof(xcb_tmp, _aux->value_mask);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
    ...
    const xcb_sync_create_alarm_value_list_t *value_list)
{
    ...
    /* xcb_sync_create_alarm_value_list_t value_list */
    xcb_parts[4].iov_len =
        xcb_sync_create_alarm_value_list_serialize(&xcb_aux0,
                                                   value_mask,
                                                   value_list);
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_sync_change_alarm_request_t *_aux =
        (xcb_sync_change_alarm_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* value_list */
    xcb_block_len +=
        xcb_sync_change_alarm_value_list_sizeof(xcb_tmp, _aux->value_mask);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
    ...
    const xcb_sync_change_alarm_value_list_t *value_list)
{
    ...
    /* xcb_sync_change_alarm_value_list_t value_list */
    xcb_parts[4].iov_len =
        xcb_sync_change_alarm_value_list_serialize(&xcb_aux0,
                                                   value_mask,
                                                   value_list);
    xcb_parts[4].iov_base = xcb_aux0;
...
xcb_sync_query_alarm_reply(xcb_connection_t             *c,
                           ...
                           xcb_generic_error_t         **e)
{
    return (xcb_sync_query_alarm_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}
...
xcb_sync_get_priority_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_sync_get_priority_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
xcb_void_cookie_t
xcb_sync_trigger_fence_checked(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_sync_trigger_fence(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_sync_reset_fence_checked(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_sync_reset_fence(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_sync_destroy_fence_checked(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_sync_destroy_fence(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_sync_query_fence(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_sync_query_fence_cookie_t
xcb_sync_query_fence_unchecked(xcb_connection_t *c, xcb_sync_fence_t fence)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_sync_id,
                                                    .opcode =
...
xcb_sync_query_fence_reply(xcb_connection_t             *c,
                           ...
                           xcb_generic_error_t         **e)
{
    return (xcb_sync_query_fence_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}

int
xcb_sync_await_fence_sizeof(const void *_buffer, uint32_t fence_list_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_sync_await_fence_request_t)) /
            sizeof(xcb_sync_fence_t));
}
...
{
    xcb_generic_iterator_t i;
    i.data = ((xcb_sync_fence_t *)(R + 1)) +
             ((((R->length * 4) - sizeof(xcb_sync_await_fence_request_t)) /
               sizeof(xcb_sync_fence_t)));
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
