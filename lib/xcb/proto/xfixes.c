...
{
    return (xcb_xfixes_query_version_reply_t *)
...
xcb_xfixes_get_cursor_image_sizeof(const void *_buffer)
{
    ...
    const xcb_xfixes_get_cursor_image_reply_t *_aux =
        (xcb_xfixes_get_cursor_image_reply_t *)_buffer;
...
xcb_xfixes_get_cursor_image_cursor_image(
    const xcb_xfixes_get_cursor_image_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
...
xcb_xfixes_get_cursor_image_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xfixes_get_cursor_image_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
int
xcb_xfixes_create_region_sizeof(const void *_buffer, uint32_t rectangles_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_xfixes_create_region_rectangles_length(
    const xcb_xfixes_create_region_request_t *R)
{
    return (((R->length * 4) - sizeof(xcb_xfixes_create_region_request_t)) /
    ...
    const xcb_xfixes_create_region_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_xfixes_create_region_request_t)) /
             sizeof(xcb_rectangle_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
int
xcb_xfixes_set_region_sizeof(const void *_buffer, uint32_t rectangles_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_xfixes_set_region_rectangles_length(
    const xcb_xfixes_set_region_request_t *R)
{
    return (((R->length * 4) - sizeof(xcb_xfixes_set_region_request_t)) /
            sizeof(xcb_rectangle_t));
}
    ...
    const xcb_xfixes_set_region_request_t *R)
{
    xcb_rectangle_iterator_t i;
    i.data  = (xcb_rectangle_t *)(R + 1);
    i.rem   = (((R->length * 4) - sizeof(xcb_xfixes_set_region_request_t)) /
             sizeof(xcb_rectangle_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_fetch_region_reply_t *_aux =
        (xcb_xfixes_fetch_region_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_fetch_region_rectangles_length(
    const xcb_xfixes_fetch_region_reply_t *R)
{
    return (R->length / 2);
}
...
xcb_xfixes_fetch_region_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xfixes_fetch_region_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_set_cursor_name_request_t *_aux =
        (xcb_xfixes_set_cursor_name_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_set_cursor_name_name_length(
    const xcb_xfixes_set_cursor_name_request_t *R)
{
    return R->nbytes;
}
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_get_cursor_name_reply_t *_aux =
        (xcb_xfixes_get_cursor_name_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_get_cursor_name_name_length(
    const xcb_xfixes_get_cursor_name_reply_t *R)
{
    return R->nbytes;
}
...
xcb_xfixes_get_cursor_name_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_xfixes_get_cursor_name_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_get_cursor_image_and_name_reply_t *_aux =
        (xcb_xfixes_get_cursor_image_and_name_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_get_cursor_image_and_name_cursor_image(
    const xcb_xfixes_get_cursor_image_and_name_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
    ...
    const xcb_xfixes_get_cursor_image_and_name_reply_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_xfixes_get_cursor_image_and_name_cursor_image_end(R);
...
xcb_xfixes_get_cursor_image_and_name_reply(
    ...
    xcb_generic_error_t                         **e)
{
    return (xcb_xfixes_get_cursor_image_and_name_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_change_cursor_by_name_request_t *_aux =
        (xcb_xfixes_change_cursor_by_name_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_change_cursor_by_name_name(
    const xcb_xfixes_change_cursor_by_name_request_t *R)
{
    return (char *)(R + 1);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_xfixes_create_pointer_barrier_request_t *_aux =
        (xcb_xfixes_create_pointer_barrier_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xfixes_create_pointer_barrier_devices(
    const xcb_xfixes_create_pointer_barrier_request_t *R)
{
    return (uint16_t *)(R + 1);
}
...
xcb_xfixes_get_client_disconnect_mode_reply(
    ...
    xcb_generic_error_t                          **e)
{
    return (xcb_xfixes_get_client_disconnect_mode_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
