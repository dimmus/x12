...
{
    return (xcb_shm_query_version_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
{
    return (
        xcb_shm_get_image_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_shm_create_segment_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_shm_create_segment_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
                                 ...
                                 xcb_shm_create_segment_reply_t *reply)
{
    return xcb_get_reply_fds(c,
                             reply,
                             sizeof(xcb_shm_create_segment_reply_t) +
                                 4 * reply->length);
}
