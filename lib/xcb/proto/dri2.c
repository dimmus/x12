...
{
    return (xcb_dri2_query_version_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_dri2_connect_sizeof(const void *_buffer)
{
    ...
    /* alignment_pad */
    xcb_block_len +=
        (((_aux->driver_name_length + 3) & (~3)) - _aux->driver_name_length) *
        sizeof(char);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
...
xcb_dri2_connect_alignment_pad_end(const xcb_dri2_connect_reply_t *R)
{
    ...
    i.data = ((char *)((char *)prev.data + XCB_TYPE_PAD(char, prev.index))) +
             ((((R->driver_name_length + 3) & (~3)) - R->driver_name_length));
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    return (
        xcb_dri2_connect_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_dri2_authenticate_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_dri2_authenticate_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
int
xcb_dri2_get_buffers_sizeof(const void *_buffer, uint32_t attachments_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_dri2_get_buffers_reply(xcb_connection_t             *c,
                           ...
                           xcb_generic_error_t         **e)
{
    return (xcb_dri2_get_buffers_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}
...
xcb_dri2_copy_region_reply(xcb_connection_t             *c,
                           ...
                           xcb_generic_error_t         **e)
{
    return (xcb_dri2_copy_region_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}
...
xcb_dri2_get_buffers_with_format_buffers(
    const xcb_dri2_get_buffers_with_format_reply_t *R)
{
    return (xcb_dri2_dri2_buffer_t *)(R + 1);
}
...
xcb_dri2_swap_buffers_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_dri2_swap_buffers_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}

xcb_dri2_get_msc_cookie_t
xcb_dri2_get_msc(xcb_connection_t *c, xcb_drawable_t drawable)
{
    static const xcb_protocol_request_t xcb_req = { .count  = 2,
                                                    .ext    = &xcb_dri2_id,
...
xcb_dri2_get_msc_cookie_t
xcb_dri2_get_msc_unchecked(xcb_connection_t *c, xcb_drawable_t drawable)
{
    static const xcb_protocol_request_t xcb_req = { .count  = 2,
                                                    .ext    = &xcb_dri2_id,
                                                    .opcode = XCB_DRI2_GET_MSC,
...
{
    return (
        xcb_dri2_get_msc_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    return (
        xcb_dri2_wait_msc_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    return (
        xcb_dri2_wait_sbc_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    return (
        xcb_dri2_get_param_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
