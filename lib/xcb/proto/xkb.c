...
xcb_xkb_counted_string_16_sizeof(const void *_buffer)
{
    ...
    const xcb_xkb_counted_string_16_t *_aux =
        (xcb_xkb_counted_string_16_t *)_buffer;
    ...
    /* alignment_pad */
    xcb_block_len +=
        (((_aux->length + 5) & (~3)) - (_aux->length + 2)) * sizeof(char);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_xkb_counted_string_16_alignment_pad_length(
    const xcb_xkb_counted_string_16_t *R)
{
...
xcb_xkb_counted_string_16_next(xcb_xkb_counted_string_16_iterator_t *i)
{
    ...
    child.data =
        (xcb_xkb_counted_string_16_t *)(((char *)R) +
                                        xcb_xkb_counted_string_16_sizeof(R));
...
xcb_xkb_key_type_sizeof(const void *_buffer)
{
    ...
    /* preserve */
    xcb_block_len +=
        (_aux->hasPreserve * _aux->nMapEntries) * sizeof(xcb_xkb_mod_def_t);
    xcb_tmp += xcb_block_len;
...
xcb_xkb_key_type_preserve(const xcb_xkb_key_type_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_xkb_kt_map_entry_end(xcb_xkb_key_type_map_iterator(R));
    return (xcb_xkb_mod_def_t *)((char *)prev.data +
                                 XCB_TYPE_PAD(xcb_xkb_mod_def_t, prev.index) +
                                 0);
}
...
xcb_xkb_key_type_preserve_iterator(const xcb_xkb_key_type_t *R)
{
    ...
    xcb_generic_iterator_t     prev =
        xcb_xkb_kt_map_entry_end(xcb_xkb_key_type_map_iterator(R));
    i.data  = (xcb_xkb_mod_def_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_mod_def_t, prev.index));
...
xcb_xkb_key_type_next(xcb_xkb_key_type_iterator_t *i)
{
    ...
    xcb_generic_iterator_t child;
    child.data =
        (xcb_xkb_key_type_t *)(((char *)R) + xcb_xkb_key_type_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
...
xcb_xkb_key_sym_map_next(xcb_xkb_key_sym_map_iterator_t *i)
{
    ...
    xcb_generic_iterator_t child;
    child.data =
        (xcb_xkb_key_sym_map_t *)(((char *)R) + xcb_xkb_key_sym_map_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
...
xcb_xkb_permament_lock_behavior_next(
    xcb_xkb_permament_lock_behavior_iterator_t *i)
{
    --i->rem;
    ++i->data;
...
xcb_xkb_permament_radio_group_behavior_next(
    xcb_xkb_permament_radio_group_behavior_iterator_t *i)
{
    --i->rem;
    ++i->data;
...
xcb_xkb_permament_overlay_behavior_next(
    xcb_xkb_permament_overlay_behavior_iterator_t *i)
{
    --i->rem;
    ++i->data;
...
xcb_xkb_set_key_type_sizeof(const void *_buffer)
{
    ...
    xcb_block_len = 0;
    /* preserve_entries */
    xcb_block_len += (_aux->preserve * _aux->nMapEntries) *
                     sizeof(xcb_xkb_kt_set_map_entry_t);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(xcb_xkb_kt_set_map_entry_t);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
{
    xcb_generic_iterator_t prev =
        xcb_xkb_kt_set_map_entry_end(xcb_xkb_set_key_type_entries_iterator(R));
    return (
        xcb_xkb_kt_set_map_entry_t *)((char *)prev.data +
                                      XCB_TYPE_PAD(xcb_xkb_kt_set_map_entry_t,
                                                   prev.index) +
                                      0);
}
...
xcb_xkb_set_key_type_next(xcb_xkb_set_key_type_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_xkb_set_key_type_t *)(((char *)R) +
                                            xcb_xkb_set_key_type_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
xcb_xkb_overlay_row_next(xcb_xkb_overlay_row_iterator_t *i)
{
    ...
    xcb_generic_iterator_t child;
    child.data =
        (xcb_xkb_overlay_row_t *)(((char *)R) + xcb_xkb_overlay_row_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
...
{
    char                            *xcb_tmp = (char *)_buffer;
    const xcb_xkb_device_led_info_t *_aux =
        (xcb_xkb_device_led_info_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* maps */
    xcb_block_len +=
        xcb_popcount(_aux->mapsPresent) * sizeof(xcb_xkb_indicator_map_t);
    xcb_tmp += xcb_block_len;
...
xcb_xkb_device_led_info_maps(const xcb_xkb_device_led_info_t *R)
{
    ...
    return (xcb_xkb_indicator_map_t *)((char *)prev.data +
                                       XCB_TYPE_PAD(xcb_xkb_indicator_map_t,
                                                    prev.index) +
                                       0);
}
...
xcb_xkb_device_led_info_maps_iterator(const xcb_xkb_device_led_info_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_xkb_device_led_info_names_end(R);
    i.data  = (xcb_xkb_indicator_map_t *)((char *)prev.data +
                                         XCB_TYPE_PAD(xcb_xkb_indicator_map_t,
                                                      prev.index));
...
xcb_xkb_device_led_info_next(xcb_xkb_device_led_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t     child;
    child.data =
        (xcb_xkb_device_led_info_t *)(((char *)R) +
                                      xcb_xkb_device_led_info_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
...
{
    return (xcb_xkb_use_extension_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
    ...
    const xcb_xkb_select_events_details_t *_aux)
{
    ...
    if ((affectWhich & ((~clear) & (~selectAll))) &
        ...
        XCB_XKB_EVENT_TYPE_INDICATOR_STATE_NOTIFY)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicatorStateDetails;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint32_t);
    ...
    if ((affectWhich & ((~clear) & (~selectAll))) &
        XCB_XKB_EVENT_TYPE_ACCESS_X_NOTIFY)
    {
...
{
    xcb_xkb_select_events_details_t _aux;
    return xcb_xkb_select_events_details_unpack(_buffer,
                                                affectWhich,
                                                clear,
                                                selectAll,
                                                &_aux);
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xkb_select_events_request_t *_aux =
        (xcb_xkb_select_events_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* details */
    xcb_block_len += xcb_xkb_select_events_details_sizeof(xcb_tmp,
                                                          _aux->affectWhich,
                                                          _aux->clear,
                                                          _aux->selectAll);
    xcb_tmp += xcb_block_len;
                              ...
                              const void           *details)
{
    ...
    xcb_parts[4].iov_len  = xcb_xkb_select_events_details_sizeof(details,
                                                                affectWhich,
                                                                clear,
                                                                selectAll);
    ...
    const xcb_xkb_select_events_details_t *details)
{
    ...
    xcb_parts[3].iov_len  = -xcb_parts[2].iov_len & 3;
    /* xcb_xkb_select_events_details_t details */
    xcb_parts[4].iov_len  = xcb_xkb_select_events_details_serialize(&xcb_aux0,
                                                                   affectWhich,
                                                                   clear,
                                                                   selectAll,
                                                                   details);
...
{
    return (
        xcb_xkb_get_state_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xkb_get_controls_reply(xcb_connection_t             *c,
                           ...
                           xcb_generic_error_t         **e)
{
    return (xcb_xkb_get_controls_reply_t *)xcb_wait_for_reply(c,
                                                              cookie.sequence,
                                                              e);
}
                              ...
                              const xcb_xkb_get_map_map_t *_aux)
{
    ...
    if (present & XCB_XKB_MAP_PART_KEY_ACTIONS)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            totalActions * sizeof(xcb_xkb_action_t);
        xcb_parts_idx++;
    ...
    if (present & XCB_XKB_MAP_PART_KEY_BEHAVIORS)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            totalKeyBehaviors * sizeof(xcb_xkb_set_behavior_t);
        xcb_parts_idx++;
    ...
    if (present & XCB_XKB_MAP_PART_VIRTUAL_MODS)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_popcount(virtualMods) * sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        xcb_align_to = 4;
        /* insert padding */
    ...
    if (present & XCB_XKB_MAP_PART_EXPLICIT_COMPONENTS)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            totalKeyExplicit * sizeof(xcb_xkb_set_explicit_t);
        xcb_parts_idx++;
    ...
    if (present & XCB_XKB_MAP_PART_MODIFIER_MAP)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            totalModMapKeys * sizeof(xcb_xkb_key_mod_map_t);
        xcb_parts_idx++;
...
{
    xcb_xkb_get_map_map_t _aux;
    return xcb_xkb_get_map_map_unpack(_buffer,
                                      nTypes,
                                      nKeySyms,
                                      nKeyActions,
                                      totalActions,
...
xcb_xkb_get_map_sizeof(const void *_buffer)
{
    ...
    xcb_block_len = 0;
    /* map */
    xcb_block_len += xcb_xkb_get_map_map_sizeof(xcb_tmp,
                                                _aux->nTypes,
                                                _aux->nKeySyms,
                                                _aux->nKeyActions,
                                                _aux->totalActions,
                                                _aux->totalKeyBehaviors,
                                                _aux->virtualMods,
                                                _aux->totalKeyExplicit,
                                                _aux->totalModMapKeys,
                                                _aux->totalVModMapKeys,
                                                _aux->present);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
...
{
    xcb_xkb_set_map_values_t _aux;
    return xcb_xkb_set_map_values_unpack(_buffer,
                                         nTypes,
                                         nKeySyms,
                                         nKeyActions,
                                         totalActions,
...
{
    char                            *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_map_request_t *_aux =
        (xcb_xkb_set_map_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* values */
    xcb_block_len += xcb_xkb_set_map_values_sizeof(xcb_tmp,
                                                   _aux->nTypes,
                                                   _aux->nKeySyms,
                                                   _aux->nKeyActions,
                                                   _aux->totalActions,
                        ...
                        const void           *values)
{
    ...
    xcb_parts[4].iov_len  = xcb_xkb_set_map_values_sizeof(values,
                                                         nTypes,
                                                         nKeySyms,
                                                         nKeyActions,
                                                         totalActions,
                            ...
                            const xcb_xkb_set_map_values_t *values)
{
    ...
    xcb_parts[3].iov_len  = -xcb_parts[2].iov_len & 3;
    /* xcb_xkb_set_map_values_t values */
    xcb_parts[4].iov_len  = xcb_xkb_set_map_values_serialize(&xcb_aux0,
                                                            nTypes,
                                                            nKeySyms,
                                                            nKeyActions,
                                                            totalActions,
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_xkb_get_compat_map_reply_t *_aux =
        (xcb_xkb_get_compat_map_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    xcb_generic_iterator_t prev =
        xcb_xkb_sym_interpret_end(xcb_xkb_get_compat_map_si_rtrn_iterator(R));
    return (xcb_xkb_mod_def_t *)((char *)prev.data +
                                 XCB_TYPE_PAD(xcb_xkb_mod_def_t, prev.index) +
                                 0);
}
...
xcb_xkb_get_compat_map_group_rtrn_length(
    const xcb_xkb_get_compat_map_reply_t *R)
{
...
xcb_xkb_get_compat_map_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_xkb_get_compat_map_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_compat_map_request_t *_aux =
        (xcb_xkb_set_compat_map_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    static const xcb_protocol_request_t xcb_req = { .count = 6,
                                                    .ext   = &xcb_xkb_id,
                                                    .opcode =
...
{
    xcb_generic_iterator_t prev =
        xcb_xkb_sym_interpret_end(xcb_xkb_set_compat_map_si_iterator(R));
    return (xcb_xkb_mod_def_t *)((char *)prev.data +
                                 XCB_TYPE_PAD(xcb_xkb_mod_def_t, prev.index) +
                                 0);
}
...
xcb_xkb_set_compat_map_group_maps_length(
    const xcb_xkb_set_compat_map_request_t *R)
{
...
xcb_xkb_get_indicator_state_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xkb_get_indicator_state_reply_t *)
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_xkb_get_indicator_map_reply_t *_aux =
        (xcb_xkb_get_indicator_map_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* maps */
    xcb_block_len +=
        xcb_popcount(_aux->which) * sizeof(xcb_xkb_indicator_map_t);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(xcb_xkb_indicator_map_t);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_xkb_get_indicator_map_maps_length(
    const xcb_xkb_get_indicator_map_reply_t *R)
{
...
xcb_xkb_get_indicator_map_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_xkb_get_indicator_map_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_indicator_map_request_t *_aux =
        (xcb_xkb_set_indicator_map_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
                                  ...
                                  const xcb_xkb_indicator_map_t *maps)
{
    ...
    xcb_parts[4].iov_len =
        xcb_popcount(which) * sizeof(xcb_xkb_indicator_map_t);
    xcb_parts[5].iov_base = 0;
    xcb_parts[5].iov_len  = -xcb_parts[4].iov_len & 3;
...
xcb_xkb_set_indicator_map_maps_length(
    const xcb_xkb_set_indicator_map_request_t *R)
{
    return xcb_popcount(R->which);
}
...
xcb_xkb_get_named_indicator_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xkb_get_named_indicator_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xkb_get_names_value_list_type_names_length(
    const xcb_xkb_get_names_reply_t      *R,
    ...
    const xcb_xkb_get_names_value_list_t *_aux)
{
    ...
    if (which & XCB_XKB_NAME_DETAIL_INDICATOR_NAMES)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_popcount(indicators) * sizeof(xcb_atom_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_atom_t);
    }
    if (which & XCB_XKB_NAME_DETAIL_VIRTUAL_MOD_NAMES)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_popcount(virtualMods) * sizeof(xcb_atom_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_atom_t);
    }
    if (which & XCB_XKB_NAME_DETAIL_GROUP_NAMES)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_popcount(groupNames) * sizeof(xcb_atom_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_atom_t);
    }
    ...
    if (which & XCB_XKB_NAME_DETAIL_KEY_ALIASES)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            nKeyAliases * sizeof(xcb_xkb_key_alias_t);
        xcb_parts_idx++;
...
{
    xcb_xkb_get_names_value_list_t _aux;
    return xcb_xkb_get_names_value_list_unpack(_buffer,
                                               nTypes,
                                               indicators,
                                               virtualMods,
                                               groupNames,
...
{
    char                            *xcb_tmp = (char *)_buffer;
    const xcb_xkb_get_names_reply_t *_aux =
        (xcb_xkb_get_names_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* valueList */
    xcb_block_len += xcb_xkb_get_names_value_list_sizeof(xcb_tmp,
                                                         _aux->nTypes,
                                                         _aux->indicators,
                                                         _aux->virtualMods,
                                                         _aux->groupNames,
...
{
    return (
        xcb_xkb_get_names_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xkb_set_names_values_n_levels_per_type_length(
    const xcb_xkb_set_names_request_t *R,
    const xcb_xkb_set_names_values_t  *S)
{
    return R->nTypes;
}
...
{
    xcb_xkb_set_names_values_t _aux;
    return xcb_xkb_set_names_values_unpack(_buffer,
                                           nTypes,
                                           indicators,
                                           virtualMods,
                                           groupNames,
...
{
    char                              *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_names_request_t *_aux =
        (xcb_xkb_set_names_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* values */
    xcb_block_len += xcb_xkb_set_names_values_sizeof(xcb_tmp,
                                                     _aux->nTypes,
                                                     _aux->indicators,
                                                     _aux->virtualMods,
                                                     _aux->groupNames,
                          ...
                          const void           *values)
{
    ...
    xcb_parts[4].iov_base = (char *)values;
    xcb_parts[4].iov_len  = xcb_xkb_set_names_values_sizeof(values,
                                                           nTypes,
                                                           indicators,
                                                           virtualMods,
                                                           groupNames,
                              ...
                              const xcb_xkb_set_names_values_t *values)
{
    ...
    xcb_parts[3].iov_len  = -xcb_parts[2].iov_len & 3;
    /* xcb_xkb_set_names_values_t values */
    xcb_parts[4].iov_len  = xcb_xkb_set_names_values_serialize(&xcb_aux0,
                                                              nTypes,
                                                              indicators,
                                                              virtualMods,
                                                              groupNames,
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xkb_list_components_reply_t *_aux =
        (xcb_xkb_list_components_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xkb_list_components_keymaps_iterator(
    const xcb_xkb_list_components_reply_t *R)
{
    ...
    const xcb_xkb_list_components_reply_t *R)
{
    xcb_xkb_listing_iterator_t i;
    xcb_generic_iterator_t     prev =
        xcb_xkb_listing_end(xcb_xkb_list_components_keymaps_iterator(R));
    i.data  = (xcb_xkb_listing_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_listing_t, prev.index));
    i.rem   = R->nKeycodes;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
xcb_xkb_list_components_types_iterator(const xcb_xkb_list_components_reply_t *R)
{
    xcb_xkb_listing_iterator_t i;
    xcb_generic_iterator_t     prev =
        xcb_xkb_listing_end(xcb_xkb_list_components_keycodes_iterator(R));
    i.data  = (xcb_xkb_listing_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_listing_t, prev.index));
    i.rem   = R->nTypes;
    i.index = (char *)i.data - (char *)R;
    ...
    const xcb_xkb_list_components_reply_t *R)
{
    xcb_xkb_listing_iterator_t i;
    xcb_generic_iterator_t     prev =
        xcb_xkb_listing_end(xcb_xkb_list_components_types_iterator(R));
    i.data  = (xcb_xkb_listing_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_listing_t, prev.index));
    i.rem   = R->nCompatMaps;
    i.index = (char *)i.data - (char *)R;
    ...
    const xcb_xkb_list_components_reply_t *R)
{
    xcb_xkb_listing_iterator_t i;
    xcb_generic_iterator_t     prev =
        xcb_xkb_listing_end(xcb_xkb_list_components_compat_maps_iterator(R));
    i.data  = (xcb_xkb_listing_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_listing_t, prev.index));
    i.rem   = R->nSymbols;
    i.index = (char *)i.data - (char *)R;
    ...
    const xcb_xkb_list_components_reply_t *R)
{
    xcb_xkb_listing_iterator_t i;
    xcb_generic_iterator_t     prev =
        xcb_xkb_listing_end(xcb_xkb_list_components_symbols_iterator(R));
    i.data  = (xcb_xkb_listing_t *)((char *)prev.data +
                                   XCB_TYPE_PAD(xcb_xkb_listing_t, prev.index));
    i.rem   = R->nGeometries;
    i.index = (char *)i.data - (char *)R;
...
xcb_xkb_list_components_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xkb_list_components_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    xcb_xkb_get_kbd_by_name_replies_types_map_t _aux;
    return xcb_xkb_get_kbd_by_name_replies_types_map_unpack(_buffer,
                                                            nTypes,
                                                            nKeySyms,
                                                            nKeyActions,
                                                            totalActions,
...
{
    xcb_generic_iterator_t i;
    i.data = S->key_names.valueList.indicatorNames +
             xcb_popcount(S->key_names.indicators);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)S;
    return i;
}
...
{
    xcb_generic_iterator_t i;
    i.data = S->key_names.valueList.virtualModNames +
             xcb_popcount(S->key_names.virtualMods);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)S;
    return i;
}
    ...
    const xcb_xkb_get_kbd_by_name_replies_t *S)
{
    xcb_generic_iterator_t i;
    i.data =
        S->key_names.valueList.groups + xcb_popcount(S->key_names.groupNames);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)S;
    return i;
}
...
{
    xcb_xkb_get_kbd_by_name_replies_key_names_value_list_t _aux;
    return xcb_xkb_get_kbd_by_name_replies_key_names_value_list_unpack(
        _buffer,
        nTypes,
        indicators,
        virtualMods,
    ...
    const xcb_xkb_get_kbd_by_name_replies_t *_aux)
{
        ...
        (reported & XCB_XKB_GBN_DETAIL_SERVER_SYMBOLS))
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.getmap_sequence;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.firstKeyBehavior;
        xcb_block_len += sizeof(xcb_keycode_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_keycode_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.totalKeyBehaviors;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.firstKeyExplicit;
        xcb_block_len += sizeof(xcb_keycode_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_keycode_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.totalKeyExplicit;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.totalModMapKeys;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.firstVModMapKey;
        xcb_block_len += sizeof(xcb_keycode_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_keycode_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->types.totalVModMapKeys;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_block_len += xcb_xkb_get_kbd_by_name_replies_types_map_serialize(
            ...
            _aux->types.nTypes,
            _aux->types.nKeySyms,
            _aux->types.nKeyActions,
            _aux->types.totalActions,
            _aux->types.totalKeyBehaviors,
            _aux->types.virtualMods,
            _aux->types.totalKeyExplicit,
            _aux->types.totalModMapKeys,
            _aux->types.totalVModMapKeys,
            _aux->types.present,
            &_aux->types.map);
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_xkb_get_kbd_by_name_replies_types_map_serialize(
    ...
    if (reported & XCB_XKB_GBN_DETAIL_COMPAT_MAP)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.compatmap_type;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.compatDeviceID;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.compatmap_sequence;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.compatmap_length;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint32_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.groupsRtrn;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->compat_map.firstSIRtrn;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint16_t);
        ...
        xcb_block_len +=
            _aux->compat_map.nSIRtrn * sizeof(xcb_xkb_sym_interpret_t);
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->compat_map.nSIRtrn * sizeof(xcb_xkb_sym_interpret_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_xkb_sym_interpret_t);
        ...
        xcb_block_len += xcb_popcount(_aux->compat_map.groupsRtrn) *
                         sizeof(xcb_xkb_mod_def_t);
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_popcount(_aux->compat_map.groupsRtrn) *
            sizeof(xcb_xkb_mod_def_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_xkb_mod_def_t);
    }
    if (reported & XCB_XKB_GBN_DETAIL_INDICATOR_MAPS)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.indicatormap_type;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.indicatorDeviceID;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.indicatormap_sequence;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.indicatormap_length;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint32_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.realIndicators;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint32_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->indicator_maps.nIndicators;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_block_len +=
            _aux->indicator_maps.nIndicators * sizeof(xcb_xkb_indicator_map_t);
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->indicator_maps.nIndicators * sizeof(xcb_xkb_indicator_map_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_xkb_indicator_map_t);
        ...
        (reported & XCB_XKB_GBN_DETAIL_OTHER_NAMES))
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyname_type;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyDeviceID;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyname_sequence;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyname_length;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint32_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyMinKeyCode;
        xcb_block_len += sizeof(xcb_keycode_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_keycode_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.keyMaxKeyCode;
        xcb_block_len += sizeof(xcb_keycode_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_keycode_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_keycode_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.virtualMods;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.nRadioGroups;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->key_names.nKeyAliases;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_block_len +=
            xcb_xkb_get_kbd_by_name_replies_key_names_value_list_serialize(
                &xcb_parts[xcb_parts_idx].iov_base,
                _aux->key_names.nTypes,
                _aux->key_names.indicators,
                _aux->key_names.virtualMods,
                _aux->key_names.groupNames,
                _aux->key_names.nKeys,
                _aux->key_names.nKeyAliases,
                _aux->key_names.nRadioGroups,
                _aux->key_names.which,
                &_aux->key_names.valueList);
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_xkb_get_kbd_by_name_replies_key_names_value_list_serialize(
                &xcb_parts[xcb_parts_idx].iov_base,
                _aux->key_names.nTypes,
    ...
    if (reported & XCB_XKB_GBN_DETAIL_GEOMETRY)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.geometry_type;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.geometryDeviceID;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.geometry_sequence;
        xcb_block_len += sizeof(uint16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint16_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint16_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.geometry_length;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint32_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.geometryFound;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.baseColorNdx;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->geometry.labelColorNdx;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_block_len +=
            xcb_xkb_counted_string_16_sizeof(_aux->geometry.labelFont);
        xcb_parts[xcb_parts_idx].iov_len =
            xcb_xkb_counted_string_16_sizeof(_aux->geometry.labelFont);
        xcb_parts_idx++;
                                       ...
                                       xcb_xkb_get_kbd_by_name_replies_t *_aux)
{
        ...
        (reported & XCB_XKB_GBN_DETAIL_SERVER_SYMBOLS))
    {
        ...
        xcb_padding_offset = 0;
        /* map */
        xcb_block_len += xcb_xkb_get_kbd_by_name_replies_types_map_unpack(
            xcb_tmp,
            _aux->types.nTypes,
            _aux->types.nKeySyms,
            _aux->types.nKeyActions,
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xkb_get_kbd_by_name_reply_t *_aux =
        (xcb_xkb_get_kbd_by_name_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* replies */
    xcb_block_len +=
        xcb_xkb_get_kbd_by_name_replies_sizeof(xcb_tmp, _aux->reported);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_xkb_get_kbd_by_name_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xkb_get_kbd_by_name_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xkb_get_device_info_reply_t *_aux =
        (xcb_xkb_get_device_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xkb_get_device_info_btn_actions(const xcb_xkb_get_device_info_reply_t *R)
{
    ...
    return (xcb_xkb_action_t *)((char *)prev.data + ((-prev.index) & (4 - 1)) +
                                0);
}

int
xcb_xkb_get_device_info_btn_actions_length(
    const xcb_xkb_get_device_info_reply_t *R)
{
    return R->nBtnsRtrn;
}
    ...
    const xcb_xkb_get_device_info_reply_t *R)
{
    ...
    xcb_generic_iterator_t    prev = xcb_xkb_get_device_info_name_end(R);
    i.data =
        (xcb_xkb_action_t *)((char *)prev.data + ((-prev.index) & (4 - 1)));
    i.rem   = R->nBtnsRtrn;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
xcb_xkb_get_device_info_leds_iterator(const xcb_xkb_get_device_info_reply_t *R)
{
    ...
    xcb_generic_iterator_t             prev =
        xcb_xkb_action_end(xcb_xkb_get_device_info_btn_actions_iterator(R));
    i.data =
        (xcb_xkb_device_led_info_t *)((char *)prev.data +
                                      XCB_TYPE_PAD(xcb_xkb_device_led_info_t,
                                                   prev.index));
...
xcb_xkb_get_device_info_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xkb_get_device_info_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_device_info_request_t *_aux =
        (xcb_xkb_set_device_info_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xkb_set_device_info_btn_actions_length(
    const xcb_xkb_set_device_info_request_t *R)
{
    return R->nBtns;
}
    ...
    const xcb_xkb_set_device_info_request_t *R)
{
    xcb_xkb_device_led_info_iterator_t i;
    xcb_generic_iterator_t             prev =
        xcb_xkb_action_end(xcb_xkb_set_device_info_btn_actions_iterator(R));
    i.data =
        (xcb_xkb_device_led_info_t *)((char *)prev.data +
                                      XCB_TYPE_PAD(xcb_xkb_device_led_info_t,
                                                   prev.index));
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_xkb_set_debugging_flags_request_t *_aux =
        (xcb_xkb_set_debugging_flags_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xkb_set_debugging_flags_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xkb_set_debugging_flags_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
