...
{
    return (xcb_xc_misc_get_version_reply_t *)
...
xcb_xc_misc_get_xid_range_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_xc_misc_get_xid_range_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xc_misc_get_xid_list_sizeof(const void *_buffer)
{
    ...
    const xcb_xc_misc_get_xid_list_reply_t *_aux =
        (xcb_xc_misc_get_xid_list_reply_t *)_buffer;
...
xcb_xc_misc_get_xid_list_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_xc_misc_get_xid_list_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
