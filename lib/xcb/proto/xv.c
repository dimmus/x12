...
xcb_xv_adaptor_info_formats(const xcb_xv_adaptor_info_t *R)
{
    ...
    return (xcb_xv_format_t *)((char *)prev.data + ((-prev.index) & (4 - 1)) +
                               0);
}
...
xcb_xv_adaptor_info_next(xcb_xv_adaptor_info_iterator_t *i)
{
    ...
    child.data =
        (xcb_xv_adaptor_info_t *)(((char *)R) + xcb_xv_adaptor_info_sizeof(R));
...
xcb_xv_encoding_info_next(xcb_xv_encoding_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_xv_encoding_info_t *)(((char *)R) +
                                            xcb_xv_encoding_info_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
xcb_xv_attribute_info_next(xcb_xv_attribute_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t   child;
    child.data = (xcb_xv_attribute_info_t *)(((char *)R) +
                                             xcb_xv_attribute_info_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
{
    return (xcb_xv_query_extension_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    char                                *xcb_tmp = (char *)_buffer;
    const xcb_xv_query_adaptors_reply_t *_aux =
        (xcb_xv_query_adaptors_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xv_query_adaptors_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_xv_query_adaptors_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_xv_query_encodings_reply_t *_aux =
        (xcb_xv_query_encodings_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xv_query_encodings_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_xv_query_encodings_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    return (
        xcb_xv_grab_port_reply_t *)xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xv_query_best_size_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_xv_query_best_size_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_xv_get_port_attribute_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_xv_get_port_attribute_reply_t *)
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_xv_query_port_attributes_reply_t *_aux =
        (xcb_xv_query_port_attributes_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xv_query_port_attributes_attributes_length(
    const xcb_xv_query_port_attributes_reply_t *R)
{
...
xcb_xv_query_port_attributes_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_xv_query_port_attributes_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_xv_list_image_formats_reply_t *_aux =
        (xcb_xv_list_image_formats_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xv_list_image_formats_format_length(
    const xcb_xv_list_image_formats_reply_t *R)
{
    return R->num_formats;
}
...
xcb_xv_list_image_formats_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_xv_list_image_formats_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_xv_query_image_attributes_reply_t *_aux =
        (xcb_xv_query_image_attributes_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xv_query_image_attributes_pitches(
    const xcb_xv_query_image_attributes_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
...
int
xcb_xv_put_image_sizeof(const void *_buffer, uint32_t data_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_xv_put_image_request_t)) /
            sizeof(uint8_t));
}
...
xcb_xv_put_image_data_end(const xcb_xv_put_image_request_t *R)
{
    xcb_generic_iterator_t i;
    i.data = ((uint8_t *)(R + 1)) +
             ((((R->length * 4) - sizeof(xcb_xv_put_image_request_t)) /
               sizeof(uint8_t)));
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
