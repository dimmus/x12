...
xcb_dbe_visual_infos_next(xcb_dbe_visual_infos_iterator_t *i)
{
    ...
    child.data = (xcb_dbe_visual_infos_t *)(((char *)R) +
                                            xcb_dbe_visual_infos_sizeof(R));
...
{
    return (xcb_dbe_query_version_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_dbe_swap_buffers_request_t *_aux =
        (xcb_dbe_swap_buffers_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_dbe_get_visual_info_request_t *_aux =
        (xcb_dbe_get_visual_info_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
int
xcb_dbe_get_visual_info_supported_visuals_length(
    const xcb_dbe_get_visual_info_reply_t *R)
{
    return R->n_supported_visuals;
}

xcb_dbe_visual_infos_iterator_t
xcb_dbe_get_visual_info_supported_visuals_iterator(
    const xcb_dbe_get_visual_info_reply_t *R)
{
...
xcb_dbe_get_visual_info_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_dbe_get_visual_info_reply_t *)
...
xcb_dbe_get_back_buffer_attributes_reply(
    ...
    xcb_generic_error_t                       **e)
{
    return (xcb_dbe_get_back_buffer_attributes_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
