...
{
    return (xcb_dri3_query_version_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
                        ...
                        xcb_dri3_open_reply_t *reply)
{
    return xcb_get_reply_fds(c,
                             reply,
                             sizeof(xcb_dri3_open_reply_t) + 4 * reply->length);
}
                                    ...
                                    int32_t           pixmap_fd)
{
    ...
    xcb_ret.sequence = xcb_send_request_with_fds(c,
                                                 XCB_REQUEST_CHECKED,
                                                 xcb_parts + 2,
                                                 &xcb_req,
                                                 1,
                            ...
                            int32_t           pixmap_fd)
{
    ...
    fds[fd_index++] = pixmap_fd;
    xcb_ret.sequence =
        xcb_send_request_with_fds(c, 0, xcb_parts + 2, &xcb_req, 1, fds);
    return xcb_ret;
}
...
xcb_dri3_buffer_from_pixmap_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_dri3_buffer_from_pixmap_reply_t *)
...
xcb_dri3_fd_from_fence_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_dri3_fd_from_fence_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_dri3_get_supported_modifiers_sizeof(const void *_buffer)
{
    ...
    const xcb_dri3_get_supported_modifiers_reply_t *_aux =
        (xcb_dri3_get_supported_modifiers_reply_t *)_buffer;
...
xcb_dri3_get_supported_modifiers_window_modifiers(
    const xcb_dri3_get_supported_modifiers_reply_t *R)
{
    return (uint64_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_dri3_get_supported_modifiers_window_modifiers_end(
    const xcb_dri3_get_supported_modifiers_reply_t *R)
{
    ...
    const xcb_dri3_get_supported_modifiers_reply_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_dri3_get_supported_modifiers_window_modifiers_end(R);
    return (uint64_t *)((char *)prev.data + XCB_TYPE_PAD(uint64_t, prev.index) +
                        0);
}
    ...
    const xcb_dri3_get_supported_modifiers_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev =
        xcb_dri3_get_supported_modifiers_window_modifiers_end(R);
    i.data =
        ((uint64_t *)((char *)prev.data + XCB_TYPE_PAD(uint64_t, prev.index))) +
        (R->num_screen_modifiers);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
xcb_dri3_get_supported_modifiers_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_dri3_get_supported_modifiers_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
int
xcb_dri3_buffers_from_pixmap_sizeof(const void *_buffer, int32_t buffers)
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_dri3_buffers_from_pixmap_reply_t *_aux =
        (xcb_dri3_buffers_from_pixmap_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_dri3_buffers_from_pixmap(xcb_connection_t *c, xcb_pixmap_t pixmap)
{
    static const xcb_protocol_request_t xcb_req = {
        .count  = 2,
        .ext    = &xcb_dri3_id,
...
xcb_dri3_buffers_from_pixmap_cookie_t
xcb_dri3_buffers_from_pixmap_unchecked(xcb_connection_t *c, xcb_pixmap_t pixmap)
{
    static const xcb_protocol_request_t xcb_req = {
        .count  = 2,
        .ext    = &xcb_dri3_id,
...
xcb_dri3_buffers_from_pixmap_strides(
    const xcb_dri3_buffers_from_pixmap_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_dri3_buffers_from_pixmap_strides_end(
    const xcb_dri3_buffers_from_pixmap_reply_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_generic_iterator_t
xcb_dri3_buffers_from_pixmap_offsets_end(
    const xcb_dri3_buffers_from_pixmap_reply_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_dri3_buffers_from_pixmap_strides_end(R);
    ...
    const xcb_dri3_buffers_from_pixmap_reply_t *R)
{
    ...
    return (int32_t *)((char *)prev.data + XCB_TYPE_PAD(int32_t, prev.index) +
                       0);
}
...
xcb_generic_iterator_t
xcb_dri3_buffers_from_pixmap_buffers_end(
    const xcb_dri3_buffers_from_pixmap_reply_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_dri3_buffers_from_pixmap_offsets_end(R);
    i.data =
        ((int32_t *)((char *)prev.data + XCB_TYPE_PAD(int32_t, prev.index))) +
        (R->nfd);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_dri3_buffers_from_pixmap_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_dri3_buffers_from_pixmap_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
    ...
    xcb_dri3_buffers_from_pixmap_reply_t *reply)
{
    return xcb_get_reply_fds(c,
                             reply,
                             sizeof(xcb_dri3_buffers_from_pixmap_reply_t) +
                                 4 * reply->length);
}
...
xcb_void_cookie_t
xcb_dri3_free_syncobj_checked(xcb_connection_t *c, xcb_dri3_syncobj_t syncobj)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_dri3_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_dri3_free_syncobj(xcb_connection_t *c, xcb_dri3_syncobj_t syncobj)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_dri3_id,
                                                    .opcode =
