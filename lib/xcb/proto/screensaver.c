...
{
    return (xcb_screensaver_query_version_reply_t *)
...
xcb_screensaver_query_info_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_screensaver_query_info_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
int
xcb_screensaver_set_attributes_value_list_serialize(
    void                                             **_buffer,
    uint32_t                                           value_mask,
...
int
xcb_screensaver_set_attributes_value_list_unpack(
    const void                                  *_buffer,
    uint32_t                                     value_mask,
...
{
    xcb_screensaver_set_attributes_value_list_t _aux;
    return xcb_screensaver_set_attributes_value_list_unpack(_buffer,
                                                            value_mask,
                                                            &_aux);
}
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_screensaver_set_attributes_request_t *_aux =
        (xcb_screensaver_set_attributes_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* value_list */
    xcb_block_len +=
        xcb_screensaver_set_attributes_value_list_sizeof(xcb_tmp,
                                                         _aux->value_mask);
    xcb_tmp += xcb_block_len;
                                       ...
                                       const void       *value_list)
{
    ...
    xcb_parts[4].iov_len =
        xcb_screensaver_set_attributes_value_list_sizeof(value_list,
                                                         value_mask);
    ...
    const xcb_screensaver_set_attributes_value_list_t *value_list)
{
    ...
    /* xcb_screensaver_set_attributes_value_list_t value_list */
    xcb_parts[4].iov_len =
        xcb_screensaver_set_attributes_value_list_serialize(&xcb_aux0,
                                                            value_mask,
                                                            value_list);
...
xcb_screensaver_set_attributes_value_list(
    const xcb_screensaver_set_attributes_request_t *R)
{
    return (void *)(R + 1);
}
...
xcb_void_cookie_t
xcb_screensaver_suspend_checked(xcb_connection_t *c, uint32_t suspend)
{
...
xcb_void_cookie_t
xcb_screensaver_suspend(xcb_connection_t *c, uint32_t suspend)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext = &xcb_screensaver_id,
                                                    .opcode =
