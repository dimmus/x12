...
{
    return (xcb_xinerama_query_version_reply_t *)
...
xcb_xinerama_get_state_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_xinerama_get_state_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_xinerama_get_screen_count_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_xinerama_get_screen_count_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xinerama_get_screen_size_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_xinerama_get_screen_size_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_xinerama_is_active_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_xinerama_is_active_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_xinerama_query_screens_sizeof(const void *_buffer)
{
    ...
    const xcb_xinerama_query_screens_reply_t *_aux =
        (xcb_xinerama_query_screens_reply_t *)_buffer;
...
xcb_xinerama_query_screens_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_xinerama_query_screens_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
