...
xcb_record_client_info_next(xcb_record_client_info_iterator_t *i)
{
    ...
    child.data = (xcb_record_client_info_t *)(((char *)R) +
                                              xcb_record_client_info_sizeof(R));
...
{
    return (xcb_record_query_version_reply_t *)
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_record_create_context_request_t *_aux =
        (xcb_record_create_context_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_record_create_context_client_specs(
    const xcb_record_create_context_request_t *R)
{
...
xcb_record_create_context_ranges(const xcb_record_create_context_request_t *R)
{
    ...
    return (xcb_record_range_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_record_range_t, prev.index) +
                                  0);
}
    ...
    const xcb_record_create_context_request_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_record_create_context_client_specs_end(R);
    i.data =
        (xcb_record_range_t *)((char *)prev.data +
                               XCB_TYPE_PAD(xcb_record_range_t, prev.index));
    i.rem   = R->num_ranges;
    i.index = (char *)i.data - (char *)R;
    return i;
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_record_register_clients_request_t *_aux =
        (xcb_record_register_clients_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_record_client_spec_t *
xcb_record_register_clients_client_specs(
    const xcb_record_register_clients_request_t *R)
{
    return (xcb_record_client_spec_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_record_register_clients_client_specs_end(
    const xcb_record_register_clients_request_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((xcb_record_client_spec_t *)(R + 1)) + (R->num_client_specs);
...
xcb_record_range_t *
xcb_record_register_clients_ranges(
    const xcb_record_register_clients_request_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_record_register_clients_client_specs_end(R);
    return (xcb_record_range_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_record_range_t, prev.index) +
                                  0);
}
...
xcb_record_range_iterator_t
xcb_record_register_clients_ranges_iterator(
    const xcb_record_register_clients_request_t *R)
{
    xcb_record_range_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_record_unregister_clients_request_t *_aux =
        (xcb_record_unregister_clients_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_record_client_spec_t *
xcb_record_unregister_clients_client_specs(
    const xcb_record_unregister_clients_request_t *R)
{
    return (xcb_record_client_spec_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_record_unregister_clients_client_specs_end(
    const xcb_record_unregister_clients_request_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((xcb_record_client_spec_t *)(R + 1)) + (R->num_client_specs);
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_record_get_context_reply_t *_aux =
        (xcb_record_get_context_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_record_get_context_intercepted_clients_length(
    const xcb_record_get_context_reply_t *R)
{
...
xcb_record_get_context_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_record_get_context_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_record_enable_context_reply_t *_aux =
        (xcb_record_enable_context_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_record_enable_context_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_record_enable_context_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
