...
xcb_render_pictdepth_next(xcb_render_pictdepth_iterator_t *i)
{
    ...
    child.data = (xcb_render_pictdepth_t *)(((char *)R) +
                                            xcb_render_pictdepth_sizeof(R));
...
xcb_render_pictscreen_next(xcb_render_pictscreen_iterator_t *i)
{
    ...
    xcb_generic_iterator_t   child;
    child.data = (xcb_render_pictscreen_t *)(((char *)R) +
                                             xcb_render_pictscreen_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
{
    return (xcb_render_query_version_reply_t *)
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_render_query_pict_formats_reply_t *_aux =
        (xcb_render_query_pict_formats_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    const xcb_render_query_pict_formats_reply_t *R)
{
    ...
    xcb_generic_iterator_t           prev = xcb_render_pictforminfo_end(
        xcb_render_query_pict_formats_formats_iterator(R));
    i.data  = (xcb_render_pictscreen_t *)((char *)prev.data +
                                         XCB_TYPE_PAD(xcb_render_pictscreen_t,
                                                      prev.index));
    i.rem   = R->num_screens;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_render_query_pict_formats_subpixels(
    const xcb_render_query_pict_formats_reply_t *R)
{
    xcb_generic_iterator_t prev = xcb_render_pictscreen_end(
...
xcb_render_query_pict_formats_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_render_query_pict_formats_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_render_query_pict_index_values_reply_t *_aux =
        (xcb_render_query_pict_index_values_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_query_pict_index_values_values(
    const xcb_render_query_pict_index_values_reply_t *R)
{
...
xcb_render_query_pict_index_values_reply(
    ...
    xcb_generic_error_t                       **e)
{
    return (xcb_render_query_pict_index_values_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    xcb_render_create_picture_value_list_t _aux;
    return xcb_render_create_picture_value_list_unpack(_buffer,
                                                       value_mask,
                                                       &_aux);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_render_create_picture_request_t *_aux =
        (xcb_render_create_picture_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* value_list */
    xcb_block_len +=
        xcb_render_create_picture_value_list_sizeof(xcb_tmp, _aux->value_mask);
    xcb_tmp += xcb_block_len;
    ...
    const xcb_render_create_picture_value_list_t *value_list)
{
    ...
    /* xcb_render_create_picture_value_list_t value_list */
    xcb_parts[4].iov_len =
        xcb_render_create_picture_value_list_serialize(&xcb_aux0,
                                                       value_mask,
                                                       value_list);
...
xcb_render_create_picture_value_list(
    const xcb_render_create_picture_request_t *R)
{
    return (void *)(R + 1);
}
...
{
    xcb_render_change_picture_value_list_t _aux;
    return xcb_render_change_picture_value_list_unpack(_buffer,
                                                       value_mask,
                                                       &_aux);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_render_change_picture_request_t *_aux =
        (xcb_render_change_picture_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* value_list */
    xcb_block_len +=
        xcb_render_change_picture_value_list_sizeof(xcb_tmp, _aux->value_mask);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
    ...
    const xcb_render_change_picture_value_list_t *value_list)
{
    ...
    /* xcb_render_change_picture_value_list_t value_list */
    xcb_parts[4].iov_len =
        xcb_render_change_picture_value_list_serialize(&xcb_aux0,
                                                       value_mask,
                                                       value_list);
    xcb_parts[4].iov_base = xcb_aux0;
...
xcb_render_change_picture_value_list(
    const xcb_render_change_picture_request_t *R)
{
    return (void *)(R + 1);
}
...
xcb_render_set_picture_clip_rectangles_rectangles(
    const xcb_render_set_picture_clip_rectangles_request_t *R)
{
...
int
xcb_render_trapezoids_sizeof(const void *_buffer, uint32_t traps_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_trapezoids_request_t)) /
...
xcb_render_trapezoids_traps_iterator(const xcb_render_trapezoids_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_render_trapezoids_request_t)) /
             sizeof(xcb_render_trapezoid_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
int
xcb_render_triangles_sizeof(const void *_buffer, uint32_t triangles_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_triangles_request_t)) /
            sizeof(xcb_render_triangle_t));
}
...
xcb_render_triangles_triangles_iterator(const xcb_render_triangles_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_render_triangles_request_t)) /
             sizeof(xcb_render_triangle_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
int
xcb_render_tri_strip_sizeof(const void *_buffer, uint32_t points_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_tri_strip_request_t)) /
            sizeof(xcb_render_pointfix_t));
}
...
xcb_render_tri_strip_points_iterator(const xcb_render_tri_strip_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_render_tri_strip_request_t)) /
             sizeof(xcb_render_pointfix_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
int
xcb_render_tri_fan_sizeof(const void *_buffer, uint32_t points_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_tri_fan_request_t)) /
            sizeof(xcb_render_pointfix_t));
}
...
xcb_render_tri_fan_points_iterator(const xcb_render_tri_fan_request_t *R)
{
    xcb_render_pointfix_iterator_t i;
    i.data  = (xcb_render_pointfix_t *)(R + 1);
    i.rem   = (((R->length * 4) - sizeof(xcb_render_tri_fan_request_t)) /
             sizeof(xcb_render_pointfix_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
int
xcb_render_add_glyphs_sizeof(const void *_buffer, uint32_t data_len)
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_render_add_glyphs_request_t *_aux =
        (xcb_render_add_glyphs_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_add_glyphs_checked(xcb_connection_t             *c,
                              ...
                              const uint8_t                *data)
{
    static const xcb_protocol_request_t xcb_req = { .count = 8,
                                                    .ext   = &xcb_render_id,
                                                    .opcode =
...
xcb_render_add_glyphs_glyphs(const xcb_render_add_glyphs_request_t *R)
{
    ...
    return (xcb_render_glyphinfo_t *)((char *)prev.data +
                                      XCB_TYPE_PAD(xcb_render_glyphinfo_t,
                                                   prev.index) +
                                      0);
}
...
xcb_render_add_glyphs_glyphs_iterator(const xcb_render_add_glyphs_request_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_render_add_glyphs_glyphids_end(R);
    i.data                      = (xcb_render_glyphinfo_t *)((char *)prev.data +
                                        XCB_TYPE_PAD(xcb_render_glyphinfo_t,
                                                     prev.index));
    i.rem                       = R->glyphs_len;
    i.index                     = (char *)i.data - (char *)R;
...
xcb_render_add_glyphs_data(const xcb_render_add_glyphs_request_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_render_glyphinfo_end(xcb_render_add_glyphs_glyphs_iterator(R));
...
xcb_render_add_glyphs_data_length(const xcb_render_add_glyphs_request_t *R)
{
    return ((((char *)R) + R->length * 4) -
            (char *)(xcb_render_add_glyphs_data(R))) /
           sizeof(uint8_t);
}
...
int
xcb_render_free_glyphs_sizeof(const void *_buffer, uint32_t glyphs_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_free_glyphs_request_t)) /
            sizeof(xcb_render_glyph_t));
}
...
{
    xcb_generic_iterator_t i;
    i.data = ((xcb_render_glyph_t *)(R + 1)) +
             ((((R->length * 4) - sizeof(xcb_render_free_glyphs_request_t)) /
               sizeof(xcb_render_glyph_t)));
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_render_composite_glyphs_8_glyphcmds(
    const xcb_render_composite_glyphs_8_request_t *R)
{
    return (uint8_t *)(R + 1);
}
...
{
    return (
        ((R->length * 4) - sizeof(xcb_render_composite_glyphs_8_request_t)) /
        sizeof(uint8_t));
}
...
xcb_render_composite_glyphs_16_glyphcmds(
    const xcb_render_composite_glyphs_16_request_t *R)
{
    return (uint8_t *)(R + 1);
}
...
{
    return (
        ((R->length * 4) - sizeof(xcb_render_composite_glyphs_16_request_t)) /
        sizeof(uint8_t));
}
...
xcb_render_composite_glyphs_32_glyphcmds(
    const xcb_render_composite_glyphs_32_request_t *R)
{
    return (uint8_t *)(R + 1);
}
...
{
    return (
        ((R->length * 4) - sizeof(xcb_render_composite_glyphs_32_request_t)) /
        sizeof(uint8_t));
}
...
int
xcb_render_fill_rectangles_sizeof(const void *_buffer, uint32_t rects_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_render_fill_rectangles_rects_length(
    const xcb_render_fill_rectangles_request_t *R)
{
    return (((R->length * 4) - sizeof(xcb_render_fill_rectangles_request_t)) /
            sizeof(xcb_rectangle_t));
}
    ...
    const xcb_render_fill_rectangles_request_t *R)
{
    xcb_rectangle_iterator_t i;
    i.data = (xcb_rectangle_t *)(R + 1);
    i.rem  = (((R->length * 4) - sizeof(xcb_render_fill_rectangles_request_t)) /
             sizeof(xcb_rectangle_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_render_query_filters_reply_t *_aux =
        (xcb_render_query_filters_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_query_filters_aliases_length(
    const xcb_render_query_filters_reply_t *R)
{
...
xcb_render_query_filters_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_render_query_filters_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}

int
xcb_render_set_picture_filter_sizeof(const void *_buffer, uint32_t values_len)
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_render_set_picture_filter_request_t *_aux =
        (xcb_render_set_picture_filter_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_set_picture_filter_filter(
    const xcb_render_set_picture_filter_request_t *R)
{
    return (char *)(R + 1);
}
...
{
    return ((((char *)R) + R->length * 4) -
            (char *)(xcb_render_set_picture_filter_values(R))) /
...
int
xcb_render_create_anim_cursor_sizeof(const void *_buffer, uint32_t cursors_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_render_create_anim_cursor_cursors(
    const xcb_render_create_anim_cursor_request_t *R)
{
...
{
    return (
        ((R->length * 4) - sizeof(xcb_render_create_anim_cursor_request_t)) /
        sizeof(xcb_render_animcursorelt_t));
}
...
int
xcb_render_add_traps_sizeof(const void *_buffer, uint32_t traps_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
{
    return (((R->length * 4) - sizeof(xcb_render_add_traps_request_t)) /
            sizeof(xcb_render_trap_t));
}
...
xcb_render_add_traps_traps_iterator(const xcb_render_add_traps_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_render_add_traps_request_t)) /
             sizeof(xcb_render_trap_t));
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_render_create_linear_gradient_request_t *_aux =
        (xcb_render_create_linear_gradient_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_create_linear_gradient_stops(
    const xcb_render_create_linear_gradient_request_t *R)
{
...
{
    xcb_generic_iterator_t prev =
        xcb_render_create_linear_gradient_stops_end(R);
    return (xcb_render_color_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_render_color_t, prev.index) +
                                  0);
}
    ...
    const xcb_render_create_linear_gradient_request_t *R)
{
    ...
    xcb_generic_iterator_t      prev =
        xcb_render_create_linear_gradient_stops_end(R);
    i.data =
        (xcb_render_color_t *)((char *)prev.data +
                               XCB_TYPE_PAD(xcb_render_color_t, prev.index));
    i.rem   = R->num_stops;
    i.index = (char *)i.data - (char *)R;
    return i;
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_render_create_radial_gradient_request_t *_aux =
        (xcb_render_create_radial_gradient_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_create_radial_gradient_stops(
    const xcb_render_create_radial_gradient_request_t *R)
{
    return (xcb_render_fixed_t *)(R + 1);
}
...
{
    xcb_generic_iterator_t prev =
        xcb_render_create_radial_gradient_stops_end(R);
    return (xcb_render_color_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_render_color_t, prev.index) +
                                  0);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_render_create_conical_gradient_request_t *_aux =
        (xcb_render_create_conical_gradient_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_render_create_conical_gradient_stops(
    const xcb_render_create_conical_gradient_request_t *R)
{
    return (xcb_render_fixed_t *)(R + 1);
}
...
{
    xcb_generic_iterator_t prev =
        xcb_render_create_conical_gradient_stops_end(R);
    return (xcb_render_color_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_render_color_t, prev.index) +
                                  0);
}
