...
xcb_input_get_extension_version_sizeof(const void *_buffer)
{
    ...
    const xcb_input_get_extension_version_request_t *_aux =
        (xcb_input_get_extension_version_request_t *)_buffer;
...
{
    return (xcb_input_get_extension_version_reply_t *)
...
{
    char                            *xcb_tmp = (char *)_buffer;
    const xcb_input_valuator_info_t *_aux =
        (xcb_input_valuator_info_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_valuator_info_next(xcb_input_valuator_info_iterator_t *i)
{
    ...
    child.data =
        (xcb_input_valuator_info_t *)(((char *)R) +
...
int
xcb_input_input_info_info_valuator_axes_length(
...
xcb_input_axis_info_iterator_t
xcb_input_input_info_info_valuator_axes_iterator(
    const xcb_input_input_info_t      *R,
    const xcb_input_input_info_info_t *S)
{
    xcb_input_axis_info_iterator_t i;
                                    ...
                                    const xcb_input_input_info_info_t *_aux)
{
    ...
    if (class_id == XCB_INPUT_INPUT_CLASS_VALUATOR)
    {
        ...
        xcb_block_len +=
            _aux->valuator.axes_len * sizeof(xcb_input_axis_info_t);
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->valuator.axes_len * sizeof(xcb_input_axis_info_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_input_axis_info_t);
    }
    ...
    for (i = 0; i < xcb_parts_idx; i++)
    {
        ...
        if (0 != xcb_parts[i].iov_len) xcb_tmp += xcb_parts[i].iov_len;
    }
...
int
xcb_input_input_info_info_sizeof(const void *_buffer, uint8_t class_id)
{
    xcb_input_input_info_info_t _aux;
...
xcb_input_input_info_next(xcb_input_input_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_input_input_info_t *)(((char *)R) +
                                            xcb_input_input_info_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
xcb_input_device_name_next(xcb_input_device_name_iterator_t *i)
{
    ...
    xcb_generic_iterator_t   child;
    child.data = (xcb_input_device_name_t *)(((char *)R) +
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_input_list_input_devices_reply_t *_aux =
        (xcb_input_list_input_devices_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_list_input_devices_infos_iterator(
    const xcb_input_list_input_devices_reply_t *R)
{
    xcb_input_input_info_iterator_t i;
    xcb_generic_iterator_t          prev = xcb_input_device_info_end(
        xcb_input_list_input_devices_devices_iterator(R));
    ...
    i.data  = (xcb_input_input_info_t *)((char *)prev.data +
                                        XCB_TYPE_PAD(xcb_input_input_info_t,
                                                     prev.index));
    ...
    const xcb_input_list_input_devices_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_input_input_info_end(
        xcb_input_list_input_devices_infos_iterator(R));
    i.data =
        (xcb_str_t *)((char *)prev.data + XCB_TYPE_PAD(xcb_str_t, prev.index));
    i.rem   = R->devices_len;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
xcb_input_list_input_devices_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_input_list_input_devices_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                *xcb_tmp = (char *)_buffer;
    const xcb_input_open_device_reply_t *_aux =
        (xcb_input_open_device_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_open_device(xcb_connection_t *c, uint8_t device_id)
{
...
xcb_input_open_device_class_info_iterator(
...
xcb_input_open_device_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_input_open_device_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}

xcb_void_cookie_t
xcb_input_close_device_checked(xcb_connection_t *c, uint8_t device_id)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_input_id,
                                                    .opcode =
...
xcb_void_cookie_t
xcb_input_close_device(xcb_connection_t *c, uint8_t device_id)
{
    static const xcb_protocol_request_t xcb_req = { .count = 2,
                                                    .ext   = &xcb_input_id,
                                                    .opcode =
...
xcb_input_set_device_mode_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_input_set_device_mode_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_input_select_extension_event_request_t *_aux =
        (xcb_input_select_extension_event_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_select_extension_event_classes(
...
xcb_generic_iterator_t
xcb_input_select_extension_event_classes_end(
    const xcb_input_select_extension_event_request_t *R)
{
    xcb_generic_iterator_t i;
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_get_selected_extension_events_reply_t *_aux =
        (xcb_input_get_selected_extension_events_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_event_class_t *
xcb_input_get_selected_extension_events_this_classes(
    ...
    const xcb_input_get_selected_extension_events_reply_t *R)
{
    ...
    return (xcb_input_event_class_t *)((char *)prev.data +
    ...
    const xcb_input_get_selected_extension_events_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev =
        xcb_input_get_selected_extension_events_this_classes_end(R);
    i.data = ((xcb_input_event_class_t *)((char *)prev.data +
                                          XCB_TYPE_PAD(xcb_input_event_class_t,
                                                       prev.index))) +
             (R->num_all_classes);
    i.rem   = 0;
...
xcb_input_get_selected_extension_events_reply(
    ...
    xcb_generic_error_t                            **e)
{
    return (xcb_input_get_selected_extension_events_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_change_device_dont_propagate_list_request_t *_aux =
        (xcb_input_change_device_dont_propagate_list_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_dont_propagate_list_reply_t *_aux =
        (xcb_input_get_device_dont_propagate_list_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_event_class_t *
xcb_input_get_device_dont_propagate_list_classes(
...
xcb_generic_iterator_t
xcb_input_get_device_dont_propagate_list_classes_end(
    const xcb_input_get_device_dont_propagate_list_reply_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((xcb_input_event_class_t *)(R + 1)) + (R->num_classes);
...
xcb_input_get_device_dont_propagate_list_reply(
    ...
    xcb_generic_error_t                             **e)
{
    return (xcb_input_get_device_dont_propagate_list_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}

int
xcb_input_device_time_coord_sizeof(const void *_buffer, uint8_t num_axes)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_generic_iterator_t
xcb_input_device_time_coord_axisvalues_end(
    const xcb_input_device_time_coord_t *R,
    uint8_t                              num_axes)
{
    xcb_generic_iterator_t i;
...
xcb_input_device_time_coord_next(xcb_input_device_time_coord_iterator_t *i)
{
    ...
    xcb_generic_iterator_t         child;
    child.data =
        (xcb_input_device_time_coord_t *)(((char *)R) +
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_motion_events_reply_t *_aux =
        (xcb_input_get_device_motion_events_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    {
        xcb_tmp_len =
            xcb_input_device_time_coord_sizeof(xcb_tmp, _aux->num_axes);
        xcb_block_len += xcb_tmp_len;
        xcb_tmp += xcb_tmp_len;
    }
...
xcb_input_get_device_motion_events_reply(
    ...
    xcb_generic_error_t                       **e)
{
    return (xcb_input_get_device_motion_events_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_change_keyboard_device_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_input_change_keyboard_device_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_change_pointer_device_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_input_change_pointer_device_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_input_grab_device_request_t *_aux =
        (xcb_input_grab_device_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_grab_device(xcb_connection_t              *c,
                      ...
                      const xcb_input_event_class_t *classes)
{
    static const xcb_protocol_request_t xcb_req = { .count = 4,
                                                    .ext   = &xcb_input_id,
                                                    .opcode =
...
xcb_input_grab_device_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_input_grab_device_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_input_grab_device_key_request_t *_aux =
        (xcb_input_grab_device_key_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_input_grab_device_button_request_t *_aux =
        (xcb_input_grab_device_button_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_event_class_t *
xcb_input_grab_device_button_classes(
...
xcb_generic_iterator_t
xcb_input_grab_device_button_classes_end(
    const xcb_input_grab_device_button_request_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((xcb_input_event_class_t *)(R + 1)) + (R->num_classes);
...
xcb_input_get_device_focus_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_input_get_device_focus_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_input_string_feedback_state_t *_aux =
        (xcb_input_string_feedback_state_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_generic_iterator_t
xcb_input_string_feedback_state_keysyms_end(
    const xcb_input_string_feedback_state_t *R)
{
    xcb_generic_iterator_t i;
    ...
    xcb_input_string_feedback_state_iterator_t *i)
{
    ...
    child.data =
        (xcb_input_string_feedback_state_t
             *)(((char *)R) + xcb_input_string_feedback_state_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
    ...
    const xcb_input_feedback_state_data_t *_aux)
{
    ...
    if (class_id == XCB_INPUT_FEEDBACK_CLASS_KEYBOARD)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->keyboard.global_auto_repeat;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
...
int
xcb_input_feedback_state_data_sizeof(const void *_buffer, uint8_t class_id)
{
    xcb_input_feedback_state_data_t _aux;
...
{
    char                             *xcb_tmp = (char *)_buffer;
    const xcb_input_feedback_state_t *_aux =
        (xcb_input_feedback_state_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* data */
    xcb_block_len +=
        xcb_input_feedback_state_data_sizeof(xcb_tmp, _aux->class_id);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_input_feedback_state_next(xcb_input_feedback_state_iterator_t *i)
{
    ...
    xcb_generic_iterator_t      child;
    child.data =
        (xcb_input_feedback_state_t *)(((char *)R) +
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_input_get_feedback_control_reply_t *_aux =
        (xcb_input_get_feedback_control_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_get_feedback_control_cookie_t
xcb_input_get_feedback_control_unchecked(xcb_connection_t *c, uint8_t device_id)
{
    static const xcb_protocol_request_t xcb_req = {
        .count  = 2,
        .ext    = &xcb_input_id,
...
xcb_input_get_feedback_control_reply(
    ...
    xcb_generic_error_t                   **e)
{
    return (xcb_input_get_feedback_control_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_input_string_feedback_ctl_t *_aux =
        (xcb_input_string_feedback_ctl_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_string_feedback_ctl_next(xcb_input_string_feedback_ctl_iterator_t *i)
{
    ...
    xcb_generic_iterator_t           child;
    child.data = (xcb_input_string_feedback_ctl_t
                      *)(((char *)R) + xcb_input_string_feedback_ctl_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
int
xcb_input_feedback_ctl_data_string_keysyms_length(
...
xcb_generic_iterator_t
xcb_input_feedback_ctl_data_string_keysyms_end(
    const xcb_input_feedback_ctl_t      *R,
    const xcb_input_feedback_ctl_data_t *S)
{
    xcb_generic_iterator_t i;
                                      ...
                                      const xcb_input_feedback_ctl_data_t *_aux)
{
    ...
    if (class_id == XCB_INPUT_FEEDBACK_CLASS_KEYBOARD)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->keyboard.auto_repeat_mode;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->keyboard.key_click_percent;
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->keyboard.bell_percent;
        xcb_block_len += sizeof(int8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(int8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(int8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->keyboard.bell_duration;
        xcb_block_len += sizeof(int16_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(int16_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(int16_t);
    ...
    if (class_id == XCB_INPUT_FEEDBACK_CLASS_INTEGER)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->integer.int_to_display;
        xcb_block_len += sizeof(int32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(int32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(int32_t);
...
int
xcb_input_feedback_ctl_data_sizeof(const void *_buffer, uint8_t class_id)
{
    xcb_input_feedback_ctl_data_t _aux;
...
xcb_input_feedback_ctl_sizeof(const void *_buffer)
{
    ...
    /* data */
    xcb_block_len +=
        xcb_input_feedback_ctl_data_sizeof(xcb_tmp, _aux->class_id);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_input_feedback_ctl_next(xcb_input_feedback_ctl_iterator_t *i)
{
    ...
    xcb_generic_iterator_t    child;
    child.data = (xcb_input_feedback_ctl_t *)(((char *)R) +
                                          ...
                                          xcb_input_feedback_ctl_t *feedback)
{
    ...
    xcb_parts[4].iov_len  = xcb_input_feedback_ctl_sizeof(feedback);
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_key_mapping_reply_t *_aux =
        (xcb_input_get_device_key_mapping_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_keysym_t *
xcb_input_get_device_key_mapping_keysyms(
...
xcb_generic_iterator_t
xcb_input_get_device_key_mapping_keysyms_end(
    const xcb_input_get_device_key_mapping_reply_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_input_get_device_key_mapping_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_input_get_device_key_mapping_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_change_device_key_mapping_request_t *_aux =
        (xcb_input_change_device_key_mapping_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* keysyms */
    xcb_block_len += (_aux->keycode_count * _aux->keysyms_per_keycode) *
                     sizeof(xcb_keysym_t);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(xcb_keysym_t);
    /* insert padding */
                                            ...
                                            const xcb_keysym_t *keysyms)
{
    ...
    xcb_parts[4].iov_len =
        (keycode_count * keysyms_per_keycode) * sizeof(xcb_keysym_t);
    xcb_parts[5].iov_base = 0;
    xcb_parts[5].iov_len  = -xcb_parts[4].iov_len & 3;
...
xcb_keysym_t *
xcb_input_change_device_key_mapping_keysyms(
...
xcb_generic_iterator_t
xcb_input_change_device_key_mapping_keysyms_end(
    const xcb_input_change_device_key_mapping_request_t *R)
{
    xcb_generic_iterator_t i;
    i.data = ((xcb_keysym_t *)(R + 1)) +
             ((R->keycode_count * R->keysyms_per_keycode));
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_modifier_mapping_reply_t *_aux =
        (xcb_input_get_device_modifier_mapping_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_generic_iterator_t
xcb_input_get_device_modifier_mapping_keymaps_end(
    const xcb_input_get_device_modifier_mapping_reply_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_input_get_device_modifier_mapping_reply(
    ...
    xcb_generic_error_t                          **e)
{
    return (xcb_input_get_device_modifier_mapping_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_set_device_modifier_mapping_request_t *_aux =
        (xcb_input_set_device_modifier_mapping_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_set_device_modifier_mapping_reply(
    ...
    xcb_generic_error_t                          **e)
{
    return (xcb_input_set_device_modifier_mapping_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_button_mapping_reply_t *_aux =
        (xcb_input_get_device_button_mapping_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_get_device_button_mapping_reply(
    ...
    xcb_generic_error_t                        **e)
{
    return (xcb_input_get_device_button_mapping_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_set_device_button_mapping_sizeof(const void *_buffer)
{
    ...
    const xcb_input_set_device_button_mapping_request_t *_aux =
        (xcb_input_set_device_button_mapping_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_set_device_button_mapping_reply(
    ...
    xcb_generic_error_t                        **e)
{
    return (xcb_input_set_device_button_mapping_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                             *xcb_tmp = (char *)_buffer;
    const xcb_input_valuator_state_t *_aux =
        (xcb_input_valuator_state_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_valuator_state_next(xcb_input_valuator_state_iterator_t *i)
{
    ...
    xcb_generic_iterator_t      child;
    child.data =
        (xcb_input_valuator_state_t *)(((char *)R) +
...
int
xcb_input_input_state_data_valuator_valuators_length(
...
xcb_generic_iterator_t
xcb_input_input_state_data_valuator_valuators_end(
    const xcb_input_input_state_t      *R,
    const xcb_input_input_state_data_t *S)
{
    xcb_generic_iterator_t i;
                                     ...
                                     const xcb_input_input_state_data_t *_aux)
{
    ...
    if (class_id == XCB_INPUT_INPUT_CLASS_VALUATOR)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->valuator.num_valuators;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->valuator.num_valuators * sizeof(int32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(int32_t);
    }
    /* insert padding */
...
int
xcb_input_input_state_data_sizeof(const void *_buffer, uint8_t class_id)
{
    xcb_input_input_state_data_t _aux;
...
xcb_input_input_state_next(xcb_input_input_state_iterator_t *i)
{
    ...
    xcb_generic_iterator_t   child;
    child.data = (xcb_input_input_state_t *)(((char *)R) +
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_input_query_device_state_reply_t *_aux =
        (xcb_input_query_device_state_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_query_device_state_classes_iterator(
    const xcb_input_query_device_state_reply_t *R)
{
...
xcb_input_query_device_state_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_input_query_device_state_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_input_set_device_valuators_request_t *_aux =
        (xcb_input_set_device_valuators_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_set_device_valuators_reply(
    ...
    xcb_generic_error_t                   **e)
{
    return (xcb_input_set_device_valuators_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_input_device_resolution_state_t *_aux =
        (xcb_input_device_resolution_state_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_generic_iterator_t
xcb_input_device_resolution_state_resolution_min_end(
    const xcb_input_device_resolution_state_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev =
        xcb_input_device_resolution_state_resolution_values_end(R);
    i.data =
        ((uint32_t *)((char *)prev.data + XCB_TYPE_PAD(uint32_t, prev.index))) +
        (R->num_valuators);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
    ...
    xcb_input_device_resolution_state_iterator_t *i)
{
    ...
    child.data =
        (xcb_input_device_resolution_state_t
             *)(((char *)R) + xcb_input_device_resolution_state_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
                                      ...
                                      const xcb_input_device_state_data_t *_aux)
{
    ...
    if (control_id == XCB_INPUT_DEVICE_CONTROL_RESOLUTION)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->resolution.num_valuators;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint32_t);
        ...
        /* resolution_values */
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)_aux->resolution.resolution_values;
        ...
        /* resolution_min */
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)_aux->resolution.resolution_min;
        xcb_block_len += _aux->resolution.num_valuators * sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->resolution.num_valuators * sizeof(uint32_t);
        xcb_parts_idx++;
        ...
        /* resolution_max */
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)_aux->resolution.resolution_max;
        xcb_block_len += _aux->resolution.num_valuators * sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->resolution.num_valuators * sizeof(uint32_t);
        xcb_parts_idx++;
    ...
    if (control_id == XCB_INPUT_DEVICE_CONTROL_ABS_CALIB)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->abs_calib.button_threshold;
        xcb_block_len += sizeof(uint32_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint32_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint32_t);
...
int
xcb_input_device_state_data_sizeof(const void *_buffer, uint16_t control_id)
{
    xcb_input_device_state_data_t _aux;
...
xcb_input_device_state_sizeof(const void *_buffer)
{
    ...
    /* data */
    xcb_block_len +=
        xcb_input_device_state_data_sizeof(xcb_tmp, _aux->control_id);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_input_device_state_next(xcb_input_device_state_iterator_t *i)
{
    ...
    xcb_generic_iterator_t    child;
    child.data = (xcb_input_device_state_t *)(((char *)R) +
...
xcb_input_get_device_control_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_input_get_device_control_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_input_device_resolution_ctl_t *_aux =
        (xcb_input_device_resolution_ctl_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_input_device_resolution_ctl_iterator_t *i)
{
    ...
    child.data =
        (xcb_input_device_resolution_ctl_t
             *)(((char *)R) + xcb_input_device_resolution_ctl_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
                                    ...
                                    const xcb_input_device_ctl_data_t *_aux)
{
    ...
    if (control_id == XCB_INPUT_DEVICE_CONTROL_RESOLUTION)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->resolution.first_valuator;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(uint8_t);
...
int
xcb_input_device_ctl_data_sizeof(const void *_buffer, uint16_t control_id)
{
    xcb_input_device_ctl_data_t _aux;
...
xcb_input_device_ctl_sizeof(const void *_buffer)
{
    ...
    /* data */
    xcb_block_len +=
        xcb_input_device_ctl_data_sizeof(xcb_tmp, _aux->control_id);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_input_device_ctl_next(xcb_input_device_ctl_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_input_device_ctl_t *)(((char *)R) +
                                ...
                                xcb_input_device_ctl_t *control)
{
    ...
    xcb_parts[4].iov_len  = xcb_input_device_ctl_sizeof(control);
...
xcb_input_change_device_control_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_input_change_device_control_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_input_list_device_properties_reply_t *_aux =
        (xcb_input_list_device_properties_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_list_device_properties_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_input_list_device_properties_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_generic_iterator_t
xcb_input_change_device_property_items_data_8_end(
    const xcb_input_change_device_property_request_t *R,
    const xcb_input_change_device_property_items_t   *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_change_device_property_items_data_16_length(
    const xcb_input_change_device_property_request_t *R,
    const xcb_input_change_device_property_items_t   *S)
{
    return R->num_items;
...
xcb_generic_iterator_t
xcb_input_change_device_property_items_data_16_end(
    const xcb_input_change_device_property_request_t *R,
    const xcb_input_change_device_property_items_t   *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_change_device_property_items_data_32_length(
    const xcb_input_change_device_property_request_t *R,
    const xcb_input_change_device_property_items_t   *S)
{
    return R->num_items;
...
int
xcb_input_change_device_property_items_serialize(
    void                                          **_buffer,
    uint32_t                                        num_items,
    uint8_t                                         format,
...
{
    xcb_input_change_device_property_items_t _aux;
    return xcb_input_change_device_property_items_unpack(_buffer,
                                                         num_items,
                                                         format,
                                                         &_aux);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_input_change_device_property_request_t *_aux =
        (xcb_input_change_device_property_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* items */
    xcb_block_len +=
        xcb_input_change_device_property_items_sizeof(xcb_tmp,
                                                      _aux->num_items,
                                                      _aux->format);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    ...
    const xcb_input_change_device_property_items_t *items)
{
    ...
    /* xcb_input_change_device_property_items_t items */
    xcb_parts[4].iov_len =
        xcb_input_change_device_property_items_serialize(&xcb_aux0,
                                                         num_items,
                                                         format,
                                                         items);
...
xcb_generic_iterator_t
xcb_input_get_device_property_items_data_8_end(
    const xcb_input_get_device_property_reply_t *R,
    const xcb_input_get_device_property_items_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_get_device_property_items_data_16_length(
    const xcb_input_get_device_property_reply_t *R,
    const xcb_input_get_device_property_items_t *S)
{
    return R->num_items;
...
xcb_generic_iterator_t
xcb_input_get_device_property_items_data_16_end(
    const xcb_input_get_device_property_reply_t *R,
    const xcb_input_get_device_property_items_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_get_device_property_items_serialize(
    void                                       **_buffer,
    uint32_t                                     num_items,
    uint8_t                                      format,
...
int
xcb_input_get_device_property_items_unpack(
    const void                            *_buffer,
    uint32_t                               num_items,
    uint8_t                                format,
...
{
    xcb_input_get_device_property_items_t _aux;
    return xcb_input_get_device_property_items_unpack(_buffer,
                                                      num_items,
                                                      format,
                                                      &_aux);
}
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_input_get_device_property_reply_t *_aux =
        (xcb_input_get_device_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* items */
    xcb_block_len += xcb_input_get_device_property_items_sizeof(xcb_tmp,
                                                                _aux->num_items,
                                                                _aux->format);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
...
xcb_input_get_device_property_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_input_get_device_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_query_pointer_reply_t *_aux =
        (xcb_input_xi_query_pointer_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_add_master_next(xcb_input_add_master_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_input_add_master_t *)(((char *)R) +
...
xcb_generic_iterator_t
xcb_input_hierarchy_change_data_add_master_name_end(
    const xcb_input_hierarchy_change_t      *R,
    const xcb_input_hierarchy_change_data_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_hierarchy_change_data_serialize(
    void                                   **_buffer,
    uint16_t                                 type,
    const xcb_input_hierarchy_change_data_t *_aux)
{
    ...
    if (type == XCB_INPUT_HIERARCHY_CHANGE_TYPE_ADD_MASTER)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_len =
            _aux->add_master.name_len * sizeof(char);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(char);
        xcb_align_to = 4;
        /* insert padding */
    ...
    if (type == XCB_INPUT_HIERARCHY_CHANGE_TYPE_REMOVE_MASTER)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->remove_master.deviceid;
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->remove_master.return_mode;
        xcb_block_len += sizeof(uint8_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(uint8_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(uint8_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->remove_master.return_pointer;
        xcb_block_len += sizeof(xcb_input_device_id_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_input_device_id_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_input_device_id_t);
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->remove_master.return_keyboard;
        xcb_block_len += sizeof(xcb_input_device_id_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_input_device_id_t);
        xcb_parts_idx++;
        xcb_align_to = ALIGNOF(xcb_input_device_id_t);
    ...
    if (type == XCB_INPUT_HIERARCHY_CHANGE_TYPE_ATTACH_SLAVE)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->attach_slave.deviceid;
        xcb_block_len += sizeof(xcb_input_device_id_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_input_device_id_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_input_device_id_t);
    ...
    if (type == XCB_INPUT_HIERARCHY_CHANGE_TYPE_DETACH_SLAVE)
    {
        ...
        xcb_parts[xcb_parts_idx].iov_base =
            (char *)&_aux->detach_slave.deviceid;
        xcb_block_len += sizeof(xcb_input_device_id_t);
        xcb_parts[xcb_parts_idx].iov_len = sizeof(xcb_input_device_id_t);
        xcb_parts_idx++;
        xcb_align_to                      = ALIGNOF(xcb_input_device_id_t);
...
int
xcb_input_hierarchy_change_data_sizeof(const void *_buffer, uint16_t type)
{
    xcb_input_hierarchy_change_data_t _aux;
...
{
    char                               *xcb_tmp = (char *)_buffer;
    const xcb_input_hierarchy_change_t *_aux =
        (xcb_input_hierarchy_change_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    /* data */
    xcb_block_len +=
        xcb_input_hierarchy_change_data_sizeof(xcb_tmp, _aux->type);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    /* insert padding */
    xcb_pad      = -xcb_block_len & (xcb_align_to - 1);
...
xcb_input_hierarchy_change_next(xcb_input_hierarchy_change_iterator_t *i)
{
    ...
    xcb_generic_iterator_t        child;
    child.data =
        (xcb_input_hierarchy_change_t *)(((char *)R) +
...
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_change_hierarchy_request_t *_aux =
        (xcb_input_xi_change_hierarchy_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_get_client_pointer_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_input_xi_get_client_pointer_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_event_mask_next(xcb_input_event_mask_iterator_t *i)
{
    ...
    xcb_generic_iterator_t  child;
    child.data = (xcb_input_event_mask_t *)(((char *)R) +
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_select_events_request_t *_aux =
        (xcb_input_xi_select_events_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_select_events_masks_iterator(
    const xcb_input_xi_select_events_request_t *R)
{
...
xcb_input_xi_query_version_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_input_xi_query_version_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_button_class_labels(const xcb_input_button_class_t *R)
{
    ...
    return (xcb_atom_t *)((char *)prev.data +
                          XCB_TYPE_PAD(xcb_atom_t, prev.index) + 0);
}
...
xcb_input_button_class_labels_end(const xcb_input_button_class_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_input_button_class_state_end(R);
    i.data                      = ((xcb_atom_t *)((char *)prev.data +
                             XCB_TYPE_PAD(xcb_atom_t, prev.index))) +
             (R->num_buttons);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_input_button_class_next(xcb_input_button_class_iterator_t *i)
{
    ...
    xcb_generic_iterator_t    child;
    child.data = (xcb_input_button_class_t *)(((char *)R) +
...
xcb_input_key_class_next(xcb_input_key_class_iterator_t *i)
{
    ...
    xcb_generic_iterator_t child;
    child.data =
        (xcb_input_key_class_t *)(((char *)R) + xcb_input_key_class_sizeof(R));
    i->index = (char *)child.data - (char *)i->data;
    --i->rem;
...
int
xcb_input_device_class_data_button_state_length(
    const xcb_input_device_class_t      *R,
    const xcb_input_device_class_data_t *S)
{
...
xcb_generic_iterator_t
xcb_input_device_class_data_button_state_end(
    const xcb_input_device_class_t      *R,
    const xcb_input_device_class_data_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_device_class_data_button_labels_length(
    const xcb_input_device_class_t      *R,
    const xcb_input_device_class_data_t *S)
{
...
xcb_generic_iterator_t
xcb_input_device_class_data_button_labels_end(
    const xcb_input_device_class_t      *R,
    const xcb_input_device_class_data_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_device_class_data_sizeof(const void *_buffer, uint16_t type)
{
    xcb_input_device_class_data_t _aux;
...
xcb_input_device_class_next(xcb_input_device_class_iterator_t *i)
{
    ...
    xcb_generic_iterator_t    child;
    child.data = (xcb_input_device_class_t *)(((char *)R) +
...
{
    char                             *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_device_info_t *_aux =
        (xcb_input_xi_device_info_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_device_info_classes_iterator(const xcb_input_xi_device_info_t *R)
{
    ...
    i.data  = (xcb_input_device_class_t *)((char *)prev.data +
                                          ((-prev.index) & (4 - 1)));
    i.rem   = R->num_classes;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_input_xi_device_info_next(xcb_input_xi_device_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t      child;
    child.data =
        (xcb_input_xi_device_info_t *)(((char *)R) +
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_query_device_reply_t *_aux =
        (xcb_input_xi_query_device_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_query_device_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_input_xi_query_device_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_input_xi_get_focus_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_input_xi_get_focus_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_grab_device_request_t *_aux =
        (xcb_input_xi_grab_device_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_grab_device_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_input_xi_grab_device_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_passive_grab_device_request_t *_aux =
        (xcb_input_xi_passive_grab_device_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_passive_grab_device_modifiers(
...
xcb_input_xi_passive_grab_device_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_input_xi_passive_grab_device_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_passive_ungrab_device_request_t *_aux =
        (xcb_input_xi_passive_ungrab_device_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_list_properties_reply_t *_aux =
        (xcb_input_xi_list_properties_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_xi_list_properties_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_input_xi_list_properties_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_generic_iterator_t
xcb_input_xi_change_property_items_data_8_end(
    const xcb_input_xi_change_property_request_t *R,
    const xcb_input_xi_change_property_items_t   *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_xi_change_property_items_data_16_length(
    const xcb_input_xi_change_property_request_t *R,
    const xcb_input_xi_change_property_items_t   *S)
{
    return R->num_items;
...
int
xcb_input_xi_change_property_items_data_32_length(
    const xcb_input_xi_change_property_request_t *R,
    const xcb_input_xi_change_property_items_t   *S)
{
    return R->num_items;
...
xcb_generic_iterator_t
xcb_input_xi_change_property_items_data_32_end(
    const xcb_input_xi_change_property_request_t *R,
    const xcb_input_xi_change_property_items_t   *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_xi_change_property_items_serialize(
    void                                      **_buffer,
    uint32_t                                    num_items,
    uint8_t                                     format,
...
int
xcb_input_xi_change_property_items_unpack(
    const void                           *_buffer,
    uint32_t                              num_items,
    uint8_t                               format,
...
{
    xcb_input_xi_change_property_items_t _aux;
    return xcb_input_xi_change_property_items_unpack(_buffer,
                                                     num_items,
                                                     format,
                                                     &_aux);
}
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_change_property_request_t *_aux =
        (xcb_input_xi_change_property_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* items */
    xcb_block_len += xcb_input_xi_change_property_items_sizeof(xcb_tmp,
                                                               _aux->num_items,
                                                               _aux->format);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
    ...
    const xcb_input_xi_change_property_items_t *items)
{
    ...
    /* xcb_input_xi_change_property_items_t items */
    xcb_parts[4].iov_len =
        xcb_input_xi_change_property_items_serialize(&xcb_aux0,
                                                     num_items,
                                                     format,
                                                     items);
    xcb_parts[4].iov_base = xcb_aux0;
...
int
xcb_input_xi_get_property_items_data_8_length(
...
xcb_generic_iterator_t
xcb_input_xi_get_property_items_data_8_end(
    const xcb_input_xi_get_property_reply_t *R,
    const xcb_input_xi_get_property_items_t *S)
{
    xcb_generic_iterator_t i;
...
int
xcb_input_xi_get_property_items_data_16_length(
    const xcb_input_xi_get_property_reply_t *R,
    const xcb_input_xi_get_property_items_t *S)
{
    return R->num_items;
...
{
    xcb_input_xi_get_property_items_t _aux;
    return xcb_input_xi_get_property_items_unpack(_buffer,
                                                  num_items,
                                                  format,
                                                  &_aux);
}
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_get_property_reply_t *_aux =
        (xcb_input_xi_get_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    xcb_block_len = 0;
    /* items */
    xcb_block_len += xcb_input_xi_get_property_items_sizeof(xcb_tmp,
                                                            _aux->num_items,
                                                            _aux->format);
    xcb_tmp += xcb_block_len;
    xcb_align_to = ALIGNOF(char);
...
xcb_input_xi_get_property_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_input_xi_get_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_get_selected_events_reply_t *_aux =
        (xcb_input_xi_get_selected_events_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_event_mask_iterator_t
xcb_input_xi_get_selected_events_masks_iterator(
    const xcb_input_xi_get_selected_events_reply_t *R)
{
    xcb_input_event_mask_iterator_t i;
    i.data  = (xcb_input_event_mask_t *)(R + 1);
...
xcb_input_xi_get_selected_events_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_input_xi_get_selected_events_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_input_xi_barrier_release_pointer_request_t *_aux =
        (xcb_input_xi_barrier_release_pointer_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_input_device_changed_event_t *_aux =
        (xcb_input_device_changed_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                              *xcb_tmp = (char *)_buffer;
    const xcb_input_key_press_event_t *_aux =
        (xcb_input_key_press_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_key_press_axisvalues(const xcb_input_key_press_event_t *R)
{
    ...
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_key_press_axisvalues_iterator(const xcb_input_key_press_event_t *R)
{
    ...
    /* sumof end. Result is in xcb_pre_tmp_11 */
    i.data =
        (xcb_input_fp3232_t *)((char *)prev.data +
                               XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index));
    i.rem   = xcb_pre_tmp_11;
    i.index = (char *)i.data - (char *)R;
    return i;
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_input_button_press_event_t *_aux =
        (xcb_input_button_press_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_fp3232_iterator_t
xcb_input_button_press_axisvalues_iterator(
    const xcb_input_button_press_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t prev = xcb_input_button_press_valuator_mask_end(R);
...
{
    char                              *xcb_tmp = (char *)_buffer;
    const xcb_input_hierarchy_event_t *_aux =
        (xcb_input_hierarchy_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_input_raw_key_press_event_t *_aux =
        (xcb_input_raw_key_press_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_fp3232_iterator_t
xcb_input_raw_key_press_axisvalues_iterator(
    const xcb_input_raw_key_press_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t prev = xcb_input_raw_key_press_valuator_mask_end(R);
...
{
    xcb_generic_iterator_t prev =
        xcb_input_fp3232_end(xcb_input_raw_key_press_axisvalues_iterator(R));
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_fp3232_iterator_t
xcb_input_raw_key_press_axisvalues_raw_iterator(
    const xcb_input_raw_key_press_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_input_raw_button_press_event_t *_aux =
        (xcb_input_raw_button_press_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_generic_iterator_t
xcb_input_raw_button_press_valuator_mask_end(
    const xcb_input_raw_button_press_event_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((uint32_t *)(R + 1)) + (R->valuators_len);
...
{
    xcb_generic_iterator_t prev =
        xcb_input_raw_button_press_valuator_mask_end(R);
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_fp3232_iterator_t
xcb_input_raw_button_press_axisvalues_iterator(
    const xcb_input_raw_button_press_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    xcb_generic_iterator_t prev =
        xcb_input_fp3232_end(xcb_input_raw_button_press_axisvalues_iterator(R));
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_fp3232_iterator_t
xcb_input_raw_button_press_axisvalues_raw_iterator(
    const xcb_input_raw_button_press_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    char                                *xcb_tmp = (char *)_buffer;
    const xcb_input_touch_begin_event_t *_aux =
        (xcb_input_touch_begin_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_fp3232_iterator_t
xcb_input_touch_begin_axisvalues_iterator(
    const xcb_input_touch_begin_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t prev = xcb_input_touch_begin_valuator_mask_end(R);
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_input_raw_touch_begin_event_t *_aux =
        (xcb_input_raw_touch_begin_event_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_generic_iterator_t
xcb_input_raw_touch_begin_valuator_mask_end(
    const xcb_input_raw_touch_begin_event_t *R)
{
    xcb_generic_iterator_t i;
    i.data  = ((uint32_t *)(R + 1)) + (R->valuators_len);
...
{
    xcb_generic_iterator_t prev =
        xcb_input_raw_touch_begin_valuator_mask_end(R);
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_fp3232_iterator_t
xcb_input_raw_touch_begin_axisvalues_iterator(
    const xcb_input_raw_touch_begin_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    xcb_generic_iterator_t prev =
        xcb_input_fp3232_end(xcb_input_raw_touch_begin_axisvalues_iterator(R));
    return (xcb_input_fp3232_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_input_fp3232_t, prev.index) +
                                  0);
}
...
xcb_input_fp3232_iterator_t
xcb_input_raw_touch_begin_axisvalues_raw_iterator(
    const xcb_input_raw_touch_begin_event_t *R)
{
    xcb_input_fp3232_iterator_t i;
    xcb_generic_iterator_t      prev =
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_input_send_extension_event_request_t *_aux =
        (xcb_input_send_extension_event_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_input_send_extension_event_events(
...
xcb_input_event_class_t *
xcb_input_send_extension_event_classes(
    const xcb_input_send_extension_event_request_t *R)
{
    xcb_generic_iterator_t prev = xcb_input_event_for_send_end(
        xcb_input_send_extension_event_events_iterator(R));
    return (xcb_input_event_class_t *)((char *)prev.data +
                                       XCB_TYPE_PAD(xcb_input_event_class_t,
                                                    prev.index) +
                                       0);
...
xcb_generic_iterator_t
xcb_input_send_extension_event_classes_end(
    const xcb_input_send_extension_event_request_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_input_event_for_send_end(
