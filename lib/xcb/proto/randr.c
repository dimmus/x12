...
xcb_randr_refresh_rates_sizeof(const void *_buffer)
{
    ...
    const xcb_randr_refresh_rates_t *_aux =
        (xcb_randr_refresh_rates_t *)_buffer;
...
xcb_randr_refresh_rates_next(xcb_randr_refresh_rates_iterator_t *i)
{
    ...
    child.data =
        (xcb_randr_refresh_rates_t *)(((char *)R) +
...
{
    return (xcb_randr_query_version_reply_t *)
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_screen_info_reply_t *_aux =
        (xcb_randr_get_screen_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    const xcb_randr_get_screen_info_reply_t *R)
{
    ...
    i.data =
        (xcb_randr_refresh_rates_t *)((char *)prev.data +
...
xcb_randr_get_screen_size_range_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_randr_get_screen_size_range_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_screen_resources_reply_t *_aux =
        (xcb_randr_get_screen_resources_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    const xcb_randr_get_screen_resources_reply_t *R)
{
    ...
    return (xcb_randr_output_t *)((char *)prev.data +
                                  XCB_TYPE_PAD(xcb_randr_output_t, prev.index) +
                                  0);
}
    ...
    const xcb_randr_get_screen_resources_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_randr_get_screen_resources_crtcs_end(R);
    i.data =
        ((xcb_randr_output_t *)((char *)prev.data +
                                XCB_TYPE_PAD(xcb_randr_output_t, prev.index))) +
        (R->num_outputs);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    ...
    const xcb_randr_get_screen_resources_reply_t *R)
{
    ...
    return (xcb_randr_mode_info_t *)((char *)prev.data +
    ...
    const xcb_randr_get_screen_resources_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_randr_get_screen_resources_outputs_end(R);
    i.data                      = (xcb_randr_mode_info_t *)((char *)prev.data +
                                       XCB_TYPE_PAD(xcb_randr_mode_info_t,
                                                    prev.index));
    i.rem                       = R->num_modes;
    i.index                     = (char *)i.data - (char *)R;
...
xcb_randr_get_screen_resources_names(
    const xcb_randr_get_screen_resources_reply_t *R)
{
    xcb_generic_iterator_t prev = xcb_randr_mode_info_end(
        xcb_randr_get_screen_resources_modes_iterator(R));
    return (uint8_t *)((char *)prev.data + XCB_TYPE_PAD(uint8_t, prev.index) +
                       0);
}
    ...
    const xcb_randr_get_screen_resources_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_randr_mode_info_end(
        xcb_randr_get_screen_resources_modes_iterator(R));
    i.data =
        ((uint8_t *)((char *)prev.data + XCB_TYPE_PAD(uint8_t, prev.index))) +
        (R->names_len);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
{
    char                                    *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_output_info_reply_t *_aux =
        (xcb_randr_get_output_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_output_info_modes(const xcb_randr_get_output_info_reply_t *R)
{
    ...
    return (xcb_randr_mode_t *)((char *)prev.data +
                                XCB_TYPE_PAD(xcb_randr_mode_t, prev.index) + 0);
}
...
xcb_randr_get_output_info_modes_end(const xcb_randr_get_output_info_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_randr_get_output_info_crtcs_end(R);
    i.data =
        ((xcb_randr_mode_t *)((char *)prev.data +
                              XCB_TYPE_PAD(xcb_randr_mode_t, prev.index))) +
        (R->num_modes);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_randr_list_output_properties_reply_t *_aux =
        (xcb_randr_list_output_properties_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_list_output_properties_atoms(
    const xcb_randr_list_output_properties_reply_t *R)
{
...
xcb_randr_list_output_properties_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_randr_list_output_properties_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_randr_query_output_property_reply_t *_aux =
        (xcb_randr_query_output_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_query_output_property_valid_values(
    const xcb_randr_query_output_property_reply_t *R)
{
    return (int32_t *)(R + 1);
}
...
xcb_randr_query_output_property_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_randr_query_output_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_randr_configure_output_property_values(
    const xcb_randr_configure_output_property_request_t *R)
{
    return (int32_t *)(R + 1);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_randr_change_output_property_request_t *_aux =
        (xcb_randr_change_output_property_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_change_output_property_data(
    const xcb_randr_change_output_property_request_t *R)
{
    return (void *)(R + 1);
}
...
{
    char                                        *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_output_property_reply_t *_aux =
        (xcb_randr_get_output_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_output_property_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_randr_get_output_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}

int
xcb_randr_create_mode_sizeof(const void *_buffer, uint32_t name_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_randr_create_mode_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_randr_create_mode_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_crtc_info_reply_t *_aux =
        (xcb_randr_get_crtc_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
int
xcb_randr_set_crtc_config_sizeof(const void *_buffer, uint32_t outputs_len)
{
    char        *xcb_tmp        = (char *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
...
xcb_randr_set_crtc_config_reply(
    ...
    xcb_generic_error_t              **e)
{
    return (xcb_randr_set_crtc_config_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_randr_get_crtc_gamma_size_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_randr_get_crtc_gamma_size_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_crtc_gamma_reply_t *_aux =
        (xcb_randr_get_crtc_gamma_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_crtc_gamma_green(const xcb_randr_get_crtc_gamma_reply_t *R)
{
    ...
    return (uint16_t *)((char *)prev.data + XCB_TYPE_PAD(uint16_t, prev.index) +
                        0);
}
...
xcb_randr_get_crtc_gamma_green_end(const xcb_randr_get_crtc_gamma_reply_t *R)
{
    ...
    xcb_generic_iterator_t prev = xcb_randr_get_crtc_gamma_red_end(R);
    i.data =
        ((uint16_t *)((char *)prev.data + XCB_TYPE_PAD(uint16_t, prev.index))) +
        (R->size);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
...
xcb_randr_get_crtc_gamma_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_randr_get_crtc_gamma_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_randr_set_crtc_gamma_request_t *_aux =
        (xcb_randr_set_crtc_gamma_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_set_crtc_gamma_green_length(
    const xcb_randr_set_crtc_gamma_request_t *R)
{
    return R->size;
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_screen_resources_current_reply_t *_aux =
        (xcb_randr_get_screen_resources_current_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
{
    xcb_generic_iterator_t prev = xcb_randr_mode_info_end(
        xcb_randr_get_screen_resources_current_modes_iterator(R));
    return (uint8_t *)((char *)prev.data + XCB_TYPE_PAD(uint8_t, prev.index) +
                       0);
}
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_randr_set_crtc_transform_request_t *_aux =
        (xcb_randr_set_crtc_transform_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_set_crtc_transform_filter_name(
    const xcb_randr_set_crtc_transform_request_t *R)
{
    return (char *)(R + 1);
}
...
{
    xcb_generic_iterator_t prev =
        xcb_randr_set_crtc_transform_filter_name_end(R);
    return (xcb_render_fixed_t *)((char *)prev.data +
                                  ((-prev.index) & (4 - 1)) + 0);
}
...
xcb_randr_set_crtc_transform_filter_params_length(
    const xcb_randr_set_crtc_transform_request_t *R)
{
    return ((((char *)R) + R->length * 4) -
            (char *)(xcb_randr_set_crtc_transform_filter_params(R))) /
    ...
    const xcb_randr_set_crtc_transform_request_t *R)
{
    ...
    xcb_generic_iterator_t prev =
        xcb_randr_set_crtc_transform_filter_name_end(R);
    i.data = ((xcb_render_fixed_t *)((char *)prev.data +
                                     ((-prev.index) & (4 - 1)))) +
             (((((char *)R) + R->length * 4) -
               (char *)(xcb_randr_set_crtc_transform_filter_params(R))) /
              sizeof(xcb_render_fixed_t));
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_crtc_transform_reply_t *_aux =
        (xcb_randr_get_crtc_transform_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_crtc_transform_pending_filter_name(
    const xcb_randr_get_crtc_transform_reply_t *R)
{
    return (char *)(R + 1);
}
...
xcb_randr_get_crtc_transform_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_randr_get_crtc_transform_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_randr_get_panning_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_randr_get_panning_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
xcb_randr_set_panning_reply(xcb_connection_t              *c,
                            ...
                            xcb_generic_error_t          **e)
{
    return (xcb_randr_set_panning_reply_t *)xcb_wait_for_reply(c,
                                                               cookie.sequence,
                                                               e);
}
...
xcb_randr_get_output_primary_reply(
    ...
    xcb_generic_error_t                 **e)
{
    return (xcb_randr_get_output_primary_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_providers_reply_t *_aux =
        (xcb_randr_get_providers_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_providers_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_randr_get_providers_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                      *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_provider_info_reply_t *_aux =
        (xcb_randr_get_provider_info_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
    ...
    const xcb_randr_get_provider_info_reply_t *R)
{
    ...
    return (
        xcb_randr_provider_t *)((char *)prev.data +
                                XCB_TYPE_PAD(xcb_randr_provider_t, prev.index) +
                                0);
}
    ...
    const xcb_randr_get_provider_info_reply_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_randr_get_provider_info_outputs_end(R);
    i.data                      = ((xcb_randr_provider_t *)((char *)prev.data +
                                       XCB_TYPE_PAD(xcb_randr_provider_t,
                                                    prev.index))) +
             (R->num_associated_providers);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
    return i;
}
...
xcb_randr_get_provider_info_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_randr_get_provider_info_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                             *xcb_tmp = (char *)_buffer;
    const xcb_randr_list_provider_properties_reply_t *_aux =
        (xcb_randr_list_provider_properties_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_list_provider_properties_atoms(
    const xcb_randr_list_provider_properties_reply_t *R)
{
    return (xcb_atom_t *)(R + 1);
}
...
xcb_randr_list_provider_properties_reply(
    ...
    xcb_generic_error_t                       **e)
{
    return (xcb_randr_list_provider_properties_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                            *xcb_tmp = (char *)_buffer;
    const xcb_randr_query_provider_property_reply_t *_aux =
        (xcb_randr_query_provider_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_query_provider_property_valid_values(
    const xcb_randr_query_provider_property_reply_t *R)
{
    return (int32_t *)(R + 1);
}
...
xcb_randr_query_provider_property_reply(
    ...
    xcb_generic_error_t                      **e)
{
    return (xcb_randr_query_provider_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_randr_configure_provider_property_values(
    const xcb_randr_configure_provider_property_request_t *R)
{
    return (int32_t *)(R + 1);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_randr_change_provider_property_request_t *_aux =
        (xcb_randr_change_provider_property_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_change_provider_property_data(
    const xcb_randr_change_provider_property_request_t *R)
{
    return (void *)(R + 1);
}
...
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_provider_property_reply_t *_aux =
        (xcb_randr_get_provider_property_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_provider_property_data(
    const xcb_randr_get_provider_property_reply_t *R)
{
    return (void *)(R + 1);
}
...
xcb_randr_get_provider_property_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_randr_get_provider_property_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_randr_monitor_info_next(xcb_randr_monitor_info_iterator_t *i)
{
    ...
    xcb_generic_iterator_t    child;
    child.data = (xcb_randr_monitor_info_t *)(((char *)R) +
                                              xcb_randr_monitor_info_sizeof(R));
    i->index   = (char *)child.data - (char *)i->data;
    --i->rem;
...
{
    char                                 *xcb_tmp = (char *)_buffer;
    const xcb_randr_get_monitors_reply_t *_aux =
        (xcb_randr_get_monitors_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_randr_get_monitors_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_randr_get_monitors_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
                              ...
                              xcb_randr_monitor_info_t *monitorinfo)
{
    ...
    xcb_parts[4].iov_len  = xcb_randr_monitor_info_sizeof(monitorinfo);
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_randr_create_lease_request_t *_aux =
        (xcb_randr_create_lease_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
                       ...
                       const xcb_randr_output_t *outputs)
{
    ...
    xcb_ret.sequence =
        xcb_send_request(c,
                         XCB_REQUEST_CHECKED | XCB_REQUEST_REPLY_FDS,
                         xcb_parts + 2,
                         &xcb_req);
    return xcb_ret;
}
                                 ...
                                 const xcb_randr_output_t *outputs)
{
    ...
    xcb_ret.sequence =
        xcb_send_request(c, XCB_REQUEST_REPLY_FDS, xcb_parts + 2, &xcb_req);
    return xcb_ret;
}
...
xcb_randr_create_lease_reply(xcb_connection_t               *c,
                             ...
                             xcb_generic_error_t           **e)
{
    return (xcb_randr_create_lease_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
{
    return xcb_get_reply_fds(c,
                             reply,
                             sizeof(xcb_randr_create_lease_reply_t) +
                                 4 * reply->length);
}
