                              ...
                              const xcb_x_print_string8_t *description)
{
    ...
    xcb_parts[xcb_parts_idx].iov_len =
        _aux->nameLen * sizeof(xcb_x_print_string8_t);
    xcb_parts_idx++;
    ...
    xcb_parts[xcb_parts_idx].iov_len =
        _aux->descLen * sizeof(xcb_x_print_string8_t);
    xcb_parts_idx++;
    xcb_align_to = ALIGNOF(xcb_x_print_string8_t);
    xcb_align_to = 4;
    /* insert padding */
                                ...
                                xcb_x_print_printer_t **_aux)
{
    ...
    if (NULL == _aux) return xcb_buffer_len;
...
xcb_x_print_printer_description(const xcb_x_print_printer_t *R)
{
    ...
    return (xcb_x_print_string8_t *)((char *)prev.data +
                                     ((-prev.index) & (4 - 1)) + 4);
}
...
xcb_x_print_printer_description_end(const xcb_x_print_printer_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev = xcb_x_print_printer_name_end(R);
    i.data                      = ((xcb_x_print_string8_t *)((char *)prev.data +
                                        ((-prev.index) & (4 - 1)))) +
             (R->descLen);
    i.rem   = 0;
    i.index = (char *)i.data - (char *)R;
...
xcb_x_print_printer_next(xcb_x_print_printer_iterator_t *i)
{
    ...
    child.data =
        (xcb_x_print_printer_t *)(((char *)R) + xcb_x_print_printer_sizeof(R));
...
{
    return (xcb_x_print_print_query_version_reply_t *)
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_get_printer_list_request_t *_aux =
        (xcb_x_print_print_get_printer_list_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_get_printer_list_printers_length(
    const xcb_x_print_print_get_printer_list_reply_t *R)
{
    return R->listCount;
}
...
xcb_x_print_print_get_printer_list_reply(
    ...
    xcb_generic_error_t                       **e)
{
    xcb_x_print_print_get_printer_list_reply_t *reply =
        (xcb_x_print_print_get_printer_list_reply_t *)
            xcb_wait_for_reply(c, cookie.sequence, e);
    int                            i;
    xcb_x_print_printer_iterator_t printers_iter =
    ...
    for (i = 0; i < printers_len; i++)
    {
        ...
        xcb_x_print_printer_unserialize((const void *)printers_data,
                                        &printers_data);
...
{
    char                                       *xcb_tmp = (char *)_buffer;
    const xcb_x_print_create_context_request_t *_aux =
        (xcb_x_print_create_context_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_string8_t *
xcb_x_print_create_context_printer_name(
    const xcb_x_print_create_context_request_t *R)
{
    return (xcb_x_print_string8_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_x_print_create_context_printer_name_end(
    const xcb_x_print_create_context_request_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_x_print_create_context_locale(const xcb_x_print_create_context_request_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_x_print_create_context_printer_name_end(R);
    return (xcb_x_print_string8_t *)((char *)prev.data +
                                     ((-prev.index) & (4 - 1)) + 0);
}
...
xcb_generic_iterator_t
xcb_x_print_create_context_locale_end(
    const xcb_x_print_create_context_request_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev =
...
xcb_x_print_print_get_context_reply(
    ...
    xcb_generic_error_t                  **e)
{
    return (xcb_x_print_print_get_context_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_x_print_print_get_screen_of_context_reply(
    ...
    xcb_generic_error_t                            **e)
{
    return (xcb_x_print_print_get_screen_of_context_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_put_document_data_request_t *_aux =
        (xcb_x_print_print_put_document_data_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_put_document_data_data(
    const xcb_x_print_print_put_document_data_request_t *R)
{
    return (uint8_t *)(R + 1);
}
...
xcb_generic_iterator_t
xcb_x_print_print_put_document_data_data_end(
    const xcb_x_print_print_put_document_data_request_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_x_print_string8_t *
xcb_x_print_print_put_document_data_doc_format(
    const xcb_x_print_print_put_document_data_request_t *R)
{
    xcb_generic_iterator_t prev =
        xcb_x_print_print_put_document_data_data_end(R);
    return (xcb_x_print_string8_t *)((char *)prev.data +
                                     ((-prev.index) & (4 - 1)) + 0);
}
...
xcb_x_print_string8_t *
xcb_x_print_print_put_document_data_options(
    const xcb_x_print_print_put_document_data_request_t *R)
{
    xcb_generic_iterator_t prev =
...
xcb_generic_iterator_t
xcb_x_print_print_put_document_data_options_end(
    const xcb_x_print_print_put_document_data_request_t *R)
{
    xcb_generic_iterator_t i;
    xcb_generic_iterator_t prev =
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_get_document_data_reply_t *_aux =
        (xcb_x_print_print_get_document_data_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_get_document_data_data(
    const xcb_x_print_print_get_document_data_reply_t *R)
{
    return (uint8_t *)(R + 1);
}
...
xcb_x_print_print_get_document_data_reply(
    ...
    xcb_generic_error_t                        **e)
{
    return (xcb_x_print_print_get_document_data_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_x_print_print_input_selected_reply(
    ...
    xcb_generic_error_t                     **e)
{
    return (xcb_x_print_print_input_selected_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                           *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_get_attributes_reply_t *_aux =
        (xcb_x_print_print_get_attributes_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_get_attributes_attributes(
    const xcb_x_print_print_get_attributes_reply_t *R)
{
    return (xcb_x_print_string8_t *)(R + 1);
}
...
{
    char *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_get_one_attributes_request_t *_aux =
        (xcb_x_print_print_get_one_attributes_request_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_get_one_attributes_value(
    const xcb_x_print_print_get_one_attributes_reply_t *R)
{
    return (xcb_x_print_string8_t *)(R + 1);
}
...
xcb_x_print_print_get_one_attributes_reply(
    ...
    xcb_generic_error_t                         **e)
{
    return (xcb_x_print_print_get_one_attributes_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_x_print_string8_t *
xcb_x_print_print_set_attributes_attributes(
    const xcb_x_print_print_set_attributes_request_t *R)
{
    return (xcb_x_print_string8_t *)(R + 1);
}
...
{
    return (
        ((R->length * 4) - sizeof(xcb_x_print_print_set_attributes_request_t)) /
        sizeof(xcb_x_print_string8_t));
}

xcb_generic_iterator_t
xcb_x_print_print_set_attributes_attributes_end(
    const xcb_x_print_print_set_attributes_request_t *R)
{
    xcb_generic_iterator_t i;
...
xcb_x_print_print_get_page_dimensions_reply(
    ...
    xcb_generic_error_t                          **e)
{
    return (xcb_x_print_print_get_page_dimensions_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                          *xcb_tmp = (char *)_buffer;
    const xcb_x_print_print_query_screens_reply_t *_aux =
        (xcb_x_print_print_query_screens_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_x_print_print_query_screens_roots(
    const xcb_x_print_print_query_screens_reply_t *R)
{
...
xcb_x_print_print_query_screens_reply(
    ...
    xcb_generic_error_t                    **e)
{
    return (xcb_x_print_print_query_screens_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_x_print_print_set_image_resolution_reply(
    ...
    xcb_generic_error_t                           **e)
{
    return (xcb_x_print_print_set_image_resolution_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_x_print_print_get_image_resolution_reply(
    ...
    xcb_generic_error_t                           **e)
{
    return (xcb_x_print_print_get_image_resolution_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
