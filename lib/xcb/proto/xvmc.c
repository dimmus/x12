...
{
    return (xcb_xvmc_query_version_reply_t *)xcb_wait_for_reply(c,
                                                                cookie.sequence,
                                                                e);
}
...
xcb_xvmc_list_surface_types_sizeof(const void *_buffer)
{
    ...
    const xcb_xvmc_list_surface_types_reply_t *_aux =
        (xcb_xvmc_list_surface_types_reply_t *)_buffer;
...
xcb_xvmc_list_surface_types_surfaces(
    const xcb_xvmc_list_surface_types_reply_t *R)
{
...
xcb_xvmc_list_surface_types_reply(
    ...
    xcb_generic_error_t                **e)
{
    return (xcb_xvmc_list_surface_types_reply_t *)
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xvmc_create_context_reply_t *_aux =
        (xcb_xvmc_create_context_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xvmc_create_context_priv_data_length(
    const xcb_xvmc_create_context_reply_t *R)
{
    return R->length;
}
...
xcb_xvmc_create_context_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xvmc_create_context_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                  *xcb_tmp = (char *)_buffer;
    const xcb_xvmc_create_surface_reply_t *_aux =
        (xcb_xvmc_create_surface_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xvmc_create_surface_priv_data_length(
    const xcb_xvmc_create_surface_reply_t *R)
{
    return R->length;
}
...
xcb_xvmc_create_surface_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_xvmc_create_surface_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                     *xcb_tmp = (char *)_buffer;
    const xcb_xvmc_create_subpicture_reply_t *_aux =
        (xcb_xvmc_create_subpicture_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xvmc_create_subpicture_priv_data(
    const xcb_xvmc_create_subpicture_reply_t *R)
{
    return (uint32_t *)(R + 1);
}
...
xcb_xvmc_create_subpicture_reply(
    ...
    xcb_generic_error_t               **e)
{
    return (xcb_xvmc_create_subpicture_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                         *xcb_tmp = (char *)_buffer;
    const xcb_xvmc_list_subpicture_types_reply_t *_aux =
        (xcb_xvmc_list_subpicture_types_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_xvmc_list_subpicture_types_types(
    const xcb_xvmc_list_subpicture_types_reply_t *R)
{
...
xcb_xvmc_list_subpicture_types_reply(
    ...
    xcb_generic_error_t                   **e)
{
    return (xcb_xvmc_list_subpicture_types_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
