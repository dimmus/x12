...
{
    return (xcb_shape_query_version_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}

int
xcb_shape_rectangles_sizeof(const void *_buffer, uint32_t rectangles_len)
{
...
{
    return (((R->length * 4) - sizeof(xcb_shape_rectangles_request_t)) /
    ...
    const xcb_shape_rectangles_request_t *R)
{
    ...
    i.rem   = (((R->length * 4) - sizeof(xcb_shape_rectangles_request_t)) /
             sizeof(xcb_rectangle_t));
...
xcb_shape_query_extents_reply(xcb_connection_t                *c,
                              ...
                              xcb_generic_error_t            **e)
{
    return (xcb_shape_query_extents_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
xcb_shape_input_selected_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_shape_input_selected_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
...
{
    char                                   *xcb_tmp = (char *)_buffer;
    const xcb_shape_get_rectangles_reply_t *_aux =
        (xcb_shape_get_rectangles_reply_t *)_buffer;
    unsigned int xcb_buffer_len = 0;
    unsigned int xcb_block_len  = 0;
    unsigned int xcb_pad        = 0;
    unsigned int xcb_align_to   = 0;
...
xcb_shape_get_rectangles_reply(xcb_connection_t                 *c,
                               ...
                               xcb_generic_error_t             **e)
{
    return (xcb_shape_get_rectangles_reply_t *)
        xcb_wait_for_reply(c, cookie.sequence, e);
}
