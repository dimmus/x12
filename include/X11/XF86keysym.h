...
/* Use: XF86XK_RotationLockToggle       _EVDEVK(0x231)     v4.16   KEY_ROTATE_LOCK_TOGGLE */
#define XF86XK_RefreshRateToggle \
    _EVDEVK(0x232) /* v6.9    KEY_REFRESH_RATE_TOGGLE */
...
#define XF86XK_CameraAccessEnable \
    _EVDEVK(0x24b) /* v6.2    KEY_CAMERA_ACCESS_ENABLE */
#define XF86XK_CameraAccessDisable \
    _EVDEVK(0x24c) /* v6.2    KEY_CAMERA_ACCESS_DISABLE */
#define XF86XK_CameraAccessToggle \
    _EVDEVK(0x24d) /* v6.2    KEY_CAMERA_ACCESS_TOGGLE */
...
#define XF86XK_AutopilotEngageToggle \
    _EVDEVK(0x27d) /* v5.18   KEY_AUTOPILOT_ENGAGE_TOGGLE */
...
#define XF86XK_SingleRangeRadar \
    _EVDEVK(0x282) /* v5.18   KEY_SINGLE_RANGE_RADAR */
...
#define XF86XK_TraditionalSonar \
    _EVDEVK(0x285) /* v5.18   KEY_TRADITIONAL_SONAR */
