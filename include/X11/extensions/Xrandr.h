...
Status XRRGetScreenSizeRange(Display *dpy,
                             Window   window,
                             int     *minWidth,
                             int     *minHeight,
                             int     *maxWidth,
...
void XRRSetScreenSize(Display *dpy,
                      Window   window,
                      int      width,
                      int      height,
                      int      mmWidth,
...
void XRRConfigureOutputProperty(Display *dpy,
                                RROutput output,
                                Atom     property,
                                Bool     pending,
                                Bool     range,
...
void XRRChangeOutputProperty(Display               *dpy,
                             RROutput               output,
                             Atom                   property,
                             Atom                   type,
                             int                    format,
...
int XRRGetOutputProperty(Display        *dpy,
                         RROutput        output,
                         Atom            property,
                         long            offset,
                         long            length,
...
XRRModeInfo *XRRAllocModeInfo(_Xconst char *name, int nameLength);
...
void XRRSetCrtcTransform(Display      *dpy,
                         RRCrtc        crtc,
 ...
 */
Status XRRGetCrtcTransform(Display                     *dpy,
                           RRCrtc                       crtc,
...
XRRProviderInfo *XRRGetProviderInfo(Display            *dpy,
                                    XRRScreenResources *resources,
                                    RRProvider          provider);
...
void XRRConfigureProviderProperty(Display   *dpy,
                                  RRProvider provider,
                                  Atom       property,
                                  Bool       pending,
                                  Bool       range,
...
void XRRChangeProviderProperty(Display               *dpy,
                               RRProvider             provider,
                               Atom                   property,
                               Atom                   type,
                               int                    format,
...
int XRRGetProviderProperty(Display        *dpy,
                           RRProvider      provider,
                           Atom            property,
                           long            offset,
                           long            length,
