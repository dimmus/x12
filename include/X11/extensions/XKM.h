...
#define XkmSemanticsOptional \
    (XkmTypesMask | XkmVirtualModsMask | XkmIndicatorsMask)
...
#define XkmKeymapOptional \
    ((XkmSemanticsOptional | XkmLayoutOptional) & (~XkmKeymapRequired))
