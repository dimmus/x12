...
Status XResQueryVersion(Display *dpy,
                        int     *major_version_return,
                        int     *minor_version_return);

Status XResQueryClients(Display *dpy, int *num_clients, XResClient **clients);

Status XResQueryClientResources(Display   *dpy,
                                XID        xid,
                                int       *num_types,
                                XResType **types);
...
Status XResQueryClientIds(Display            *dpy,
                          long                num_specs,
...
Status XResQueryResourceBytes(Display                *dpy,
                              XID                     client,
                              long                    num_specs,
...
void XResResourceSizeValuesDestroy(long                   num_sizes,
