...
Status XvMCGetDRInfo(Display *dpy,
                     XvPortID port,
                     char   **name,
                     char   **busID,
                     int     *major,
...
Status XvMCPutSurface(Display       *display,
                      XvMCSurface   *surface,
                      Drawable       draw,
                      short          srcx,
                      short          srcy,
...
Status XvMCClearSubpicture(Display        *display,
                           XvMCSubpicture *subpicture,
                           short           x,
                           short           y,
                           unsigned short  width,
...
Status XvMCCompositeSubpicture(Display        *display,
                               XvMCSubpicture *subpicture,
                               XvImage        *image,
                               short           srcx,
                               short           srcy,
...
Status XvMCSetSubpicturePalette(Display        *display,
                                XvMCSubpicture *subpicture,
                                unsigned char  *palette);

Status XvMCBlendSubpicture(Display        *display,
...
Status XvMCSetAttribute(Display     *display,
                        XvMCContext *context,
                        Atom         attribute,
                        int          value);

Status XvMCGetAttribute(Display     *display,
                        XvMCContext *context,
                        Atom         attribute,
                        int         *value);
