...
#define XkbStateGroup(s) \
    ((s)->base_group + (s)->latched_group + XkbGroupLock(s))
...
#define XkbSARedirectVMods(a) \
    ((((unsigned int)(a)->vmods1) << 8) | ((unsigned int)(a)->vmods0))
#define XkbSARedirectSetVMods(a, m) \
    (((a)->vmods1 = (((m) >> 8) & 0xff)), ((a)->vmods0 = ((m) & 0xff)))
#define XkbSARedirectVModsMask(a) \
    ((((unsigned int)(a)->vmods_mask1) << 8) | ((unsigned int)(a)->vmods_mask0))
...
#define XkbCMKeyNumSyms(m, k) \
    (XkbCMKeyGroupsWidth(m, k) * XkbCMKeyNumGroups(m, k))
...
#define XkbIM_IsAuto(i)                         \
    ((((i)->flags & XkbIM_NoAutomatic) == 0) && \
     (((i)->which_groups && (i)->groups) ||     \
      ((i)->which_mods && (i)->mods.mask) || ((i)->ctrls)))
#define XkbIM_InUse(i) \
    (((i)->flags) || ((i)->which_groups) || ((i)->which_mods) || ((i)->ctrls))
...
#define XkbKeyNumActions(d, k) \
    (XkbKeyHasActions(d, k) ? XkbKeyNumSyms(d, k) : 1)
...
#define XkbXI_LegalDevBtn(d, b) \
    (XkbXI_DevHasBtnActs(d) && ((b) < (d)->num_btns))
