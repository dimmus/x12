...
#define XETrapSetCfgFlagCmd(tcv, e, x) BitSet((tcv)->v.flags.e, XETrapCmd, (x))
...
#define XETrapGetAvailFlagCmd(avail) (BitValue((avail)->valid, XETrapCmd))
...
#define XETrapGetAvailFlagEvent(avail) (BitValue((avail)->valid, XETrapEvent))
...
#define XETrapGetAvailFlagWinXY(avail)  (BitValue((avail)->valid, XETrapWinXY))
#define XETrapGetAvailFlagCursor(avail) (BitValue((avail)->valid, XETrapCursor))
#define XETrapGetAvailFlagXInput(avail) (BitValue((avail)->valid, XETrapXInput))
...
#define XETrapGetCfgFlagCmd(cfg, e) (BitValue((cfg)->flags.e, XETrapCmd))
...
#define XETrapGetCfgFlagEvent(cfg, e) (BitValue((cfg)->flags.e, XETrapEvent))
...
#define XETrapGetCfgFlagWinXY(cfg, e)  (BitValue((cfg)->flags.e, XETrapWinXY))
#define XETrapGetCfgFlagCursor(cfg, e) (BitValue((cfg)->flags.e, XETrapCursor))
#define XETrapGetCfgFlagXInput(cfg, e) (BitValue((cfg)->flags.e, XETrapXInput))
...
#define XETrapGetCfgFlagEvt(cfg, evt) (BitValue((cfg)->flags.event, (evt)))
...
/* Note: e is only pertinent for "valid" or "data" */
#define XETrapGetCurCFlags(cur, e, a) \
    (XETrapGetCfgFlags(&((cur)->config), e, a))
...
#define XETrapGetTCFlagCmd(tc, e) (XETrapGetCfgFlagCmd(&((tc)->values.v), e))
...
/* Request values are in "Xproto.h" of the flavor X_RequestType */
#define XETrapGetTCFlagReq(tc, r) (XETrapGetCfgFlagReq(&((tc)->values.v), r))
/* Event types are in "X.h" of the flavor EventType (e.g. KeyPress) */
#define XETrapGetTCFlagEvt(tc, e) (XETrapGetCfgFlagEvt(&((tc)->values.v), e))
...
#  ifdef vms
#    define _ClearExceptionHandling() LIB$REVERT()
#  else
