...
#define XCURSOR_LIB_VERSION                                    \
    ((XCURSOR_LIB_MAJOR * 10000) + (XCURSOR_LIB_MINOR * 100) + \
...
XcursorBool XcursorXcFileSave(XcursorFile           *file,
...
XcursorBool XcursorFileSave(FILE                  *file,
                            const XcursorComments *comments,
                            const XcursorImages   *images);
...
XcursorBool XcursorFilenameSave(const char            *file,
                                const XcursorComments *comments,
                                const XcursorImages   *images);
...
XcursorCursors *XcursorImagesLoadCursors(Display             *dpy,
                                         const XcursorImages *images);
...
void XcursorNoticeCreateBitmap(Display     *dpy,
                               Pixmap       pid,
                               unsigned int width,
                               unsigned int height);
...
XcursorBool XcursorSetResizable(Display *dpy, XcursorBool flag);

XcursorBool XcursorGetResizable(Display *dpy);
