...
int xcb_xkb_select_events_details_serialize(
    void                                 **_buffer,
    uint16_t                               affectWhich,
    uint16_t                               clear,
    uint16_t                               selectAll,
...
int xcb_xkb_select_events_details_unpack(const void *_buffer,
                                         uint16_t    affectWhich,
                                         uint16_t    clear,
                                         uint16_t    selectAll,
                                         xcb_xkb_select_events_details_t *_aux);

int xcb_xkb_select_events_details_sizeof(const void *_buffer,
                                         uint16_t    affectWhich,
                                         uint16_t    clear,
                                         uint16_t    selectAll);
...
int xcb_xkb_get_map_map_types_rtrn_length(const xcb_xkb_get_map_reply_t *R,
...
int xcb_xkb_get_map_map_syms_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                         const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_acts_rtrn_count_length(const xcb_xkb_get_map_reply_t *R,
                                               const xcb_xkb_get_map_map_t *S);
...
int xcb_xkb_get_map_map_acts_rtrn_acts_length(const xcb_xkb_get_map_reply_t *R,
                                              const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_behaviors_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                              const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_vmods_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                          const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_explicit_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                             const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_modmap_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                           const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_vmodmap_rtrn_length(const xcb_xkb_get_map_reply_t *R,
                                            const xcb_xkb_get_map_map_t   *S);
...
int xcb_xkb_get_map_map_serialize(void   **_buffer,
                                  uint8_t  nTypes,
                                  uint8_t  nKeySyms,
                                  uint8_t  nKeyActions,
                                  uint16_t totalActions,
...
int xcb_xkb_get_map_map_unpack(const void            *_buffer,
                               uint8_t                nTypes,
                               uint8_t                nKeySyms,
                               uint8_t                nKeyActions,
                               uint16_t               totalActions,
...
int xcb_xkb_get_map_map_sizeof(const void *_buffer,
                               uint8_t     nTypes,
                               uint8_t     nKeySyms,
                               uint8_t     nKeyActions,
                               uint16_t    totalActions,
...
int xcb_xkb_set_map_values_types_length(const xcb_xkb_set_map_request_t *R,
...
int xcb_xkb_set_map_values_syms_length(const xcb_xkb_set_map_request_t *R,
                                       const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_actions_length(const xcb_xkb_set_map_request_t *R,
                                          const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_behaviors_length(const xcb_xkb_set_map_request_t *R,
                                            const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_vmods_length(const xcb_xkb_set_map_request_t *R,
                                        const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_explicit_length(const xcb_xkb_set_map_request_t *R,
                                           const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_modmap_length(const xcb_xkb_set_map_request_t *R,
                                         const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_vmodmap_length(const xcb_xkb_set_map_request_t *R,
                                          const xcb_xkb_set_map_values_t  *S);
...
int xcb_xkb_set_map_values_serialize(void   **_buffer,
                                     uint8_t  nTypes,
                                     uint8_t  nKeySyms,
                                     uint8_t  nKeyActions,
                                     uint16_t totalActions,
...
int xcb_xkb_set_map_values_unpack(const void               *_buffer,
                                  uint8_t                   nTypes,
                                  uint8_t                   nKeySyms,
                                  uint8_t                   nKeyActions,
                                  uint16_t                  totalActions,
...
int xcb_xkb_set_map_values_sizeof(const void *_buffer,
                                  uint8_t     nTypes,
                                  uint8_t     nKeySyms,
                                  uint8_t     nKeyActions,
                                  uint16_t    totalActions,
...
int xcb_xkb_set_compat_map_group_maps_length(
    const xcb_xkb_set_compat_map_request_t *R);

xcb_xkb_mod_def_iterator_t xcb_xkb_set_compat_map_group_maps_iterator(
    const xcb_xkb_set_compat_map_request_t *R);
...
int xcb_xkb_set_indicator_map_maps_length(
    const xcb_xkb_set_indicator_map_request_t *R);

xcb_xkb_indicator_map_iterator_t xcb_xkb_set_indicator_map_maps_iterator(
    const xcb_xkb_set_indicator_map_request_t *R);
...
int xcb_xkb_get_names_value_list_serialize(
    void                                **_buffer,
    uint8_t                               nTypes,
    uint32_t                              indicators,
    uint16_t                              virtualMods,
...
int xcb_xkb_get_names_value_list_unpack(const void *_buffer,
                                        uint8_t     nTypes,
                                        uint32_t    indicators,
                                        uint16_t    virtualMods,
                                        uint8_t     groupNames,
...
int xcb_xkb_get_names_value_list_sizeof(const void *_buffer,
                                        uint8_t     nTypes,
                                        uint32_t    indicators,
                                        uint16_t    virtualMods,
                                        uint8_t     groupNames,
...
int xcb_xkb_set_names_values_groups_length(const xcb_xkb_set_names_request_t *R,
                                           const xcb_xkb_set_names_values_t *S);
...
int xcb_xkb_set_names_values_serialize(void   **_buffer,
                                       uint8_t  nTypes,
                                       uint32_t indicators,
                                       uint16_t virtualMods,
                                       uint8_t  groupNames,
...
int xcb_xkb_set_names_values_unpack(const void                 *_buffer,
                                    uint8_t                     nTypes,
                                    uint32_t                    indicators,
                                    uint16_t                    virtualMods,
                                    uint8_t                     groupNames,
...
int xcb_xkb_set_names_values_sizeof(const void *_buffer,
                                    uint8_t     nTypes,
                                    uint32_t    indicators,
                                    uint16_t    virtualMods,
                                    uint8_t     groupNames,
...
int xcb_xkb_get_kbd_by_name_replies_types_map_serialize(
    void                                             **_buffer,
    uint8_t                                            nTypes,
    uint8_t                                            nKeySyms,
    uint8_t                                            nKeyActions,
...
int xcb_xkb_get_kbd_by_name_replies_types_map_unpack(
    const void                                  *_buffer,
    uint8_t                                      nTypes,
    uint8_t                                      nKeySyms,
    uint8_t                                      nKeyActions,
...
int xcb_xkb_get_kbd_by_name_replies_types_map_sizeof(const void *_buffer,
                                                     uint8_t     nTypes,
                                                     uint8_t     nKeySyms,
                                                     uint8_t     nKeyActions,
                                                     uint16_t    totalActions,
...
int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_serialize(
    void                                                        **_buffer,
    uint8_t                                                       nTypes,
    uint32_t                                                      indicators,
    uint16_t                                                      virtualMods,
...
int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_unpack(
    const void                                             *_buffer,
    uint8_t                                                 nTypes,
    uint32_t                                                indicators,
    uint16_t                                                virtualMods,
...
int xcb_xkb_get_kbd_by_name_replies_key_names_value_list_sizeof(
    const void *_buffer,
    uint8_t     nTypes,
    uint32_t    indicators,
    uint16_t    virtualMods,
...
int xcb_xkb_get_kbd_by_name_replies_serialize(
    void                                   **_buffer,
    uint16_t                                 reported,
...
int xcb_xkb_get_kbd_by_name_replies_sizeof(const void *_buffer,
                                           uint16_t    reported);
...
int xcb_xkb_set_device_info_btn_actions_length(
    const xcb_xkb_set_device_info_request_t *R);

xcb_xkb_action_iterator_t xcb_xkb_set_device_info_btn_actions_iterator(
    const xcb_xkb_set_device_info_request_t *R);

int
xcb_xkb_set_device_info_leds_length(const xcb_xkb_set_device_info_request_t *R);

xcb_xkb_device_led_info_iterator_t xcb_xkb_set_device_info_leds_iterator(
    const xcb_xkb_set_device_info_request_t *R);
